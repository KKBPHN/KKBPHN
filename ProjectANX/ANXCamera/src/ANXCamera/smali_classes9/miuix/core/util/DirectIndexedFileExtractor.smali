...
.method static synthetic access$000(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lmiuix/core/util/DirectIndexedFileExtractor;->extractDirectIndexedFile(Landroid/content/Context;Ljava/lang/String;)V
...
.method private static ensureIdfPath(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lmiuix/core/util/FileUtils;->chmod(Ljava/lang/String;I)Z
...
.method private static extractDirectIndexedFile(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lmiuix/core/util/DirectIndexedFileExtractor;->getDirectIndexedFilePath(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "DirectIndexedFileExt"
    ...
    invoke-static {p0, p1, v0}, Lmiuix/core/util/DirectIndexedFileExtractor;->shouldOverwrite(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v4, p0}, Lmiuix/core/util/FileUtils;->copyToFile(Ljava/io/InputStream;Ljava/io/File;)Z
    ...
    invoke-static {v0, p0}, Lmiuix/core/util/FileUtils;->chmod(Ljava/lang/String;I)Z
...
.method public static replaceDirectIndexedFile(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p2}, Lmiuix/core/util/DirectIndexedFileExtractor;->getDirectIndexedFilePath(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "DirectIndexedFileExt"
    ...
    invoke-static {v4, v0}, Lmiuix/core/util/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;)Z
    ...
    invoke-static {p0, p1}, Lmiuix/core/util/FileUtils;->chmod(Ljava/lang/String;I)Z
...
.method public static tryExtractDirectIndexedFiles(Landroid/content/Context;)V
    ...
    new-instance v1, Lmiuix/core/util/DirectIndexedFileExtractor$1;

    invoke-direct {v1, v0, p0}, Lmiuix/core/util/DirectIndexedFileExtractor$1;-><init>([Ljava/lang/String;Landroid/content/Context;)V
    ...
    const-string v0, "DirectIndexedFileExt"
