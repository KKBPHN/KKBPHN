...
# static fields
.field private static sInstance:Lmiuix/core/util/ConnectivityManagerWrapper;


# instance fields
.field private mIsNetworkSupport:Lmiuix/reflect/Method;
...
.method public isNetworkSupported(Landroid/net/ConnectivityManager;I)Z
    ...
    :try_start_0
    iget-object p0, p0, Lmiuix/core/util/ConnectivityManagerWrapper;->mIsNetworkSupport:Lmiuix/reflect/Method;
    ...
    invoke-virtual {p0, v1, p1, v2}, Lmiuix/reflect/Method;->invokeBoolean(Ljava/lang/Class;Ljava/lang/Object;[Ljava/lang/Object;)Z
