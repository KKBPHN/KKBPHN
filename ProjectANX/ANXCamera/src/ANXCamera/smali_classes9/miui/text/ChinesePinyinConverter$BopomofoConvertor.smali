...
.method private static convert(Ljava/lang/String;ILjava/lang/StringBuilder;)I
    ...
    iget-object v2, v2, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->children:Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;

    :goto_1
    if-eqz v2, :cond_0

    iget-char v6, v2, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->ch:C

    if-eq v6, v5, :cond_0

    iget-object v2, v2, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->next:Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;
    ...
    iget-object v5, v2, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->output:Ljava/lang/String;

    if-eqz v5, :cond_2

    iget-boolean v5, v2, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->specials:Z
    ...
    iget-object p0, v3, Lmiui/text/ChinesePinyinConverter$BopomofoConvertor$Node;->output:Ljava/lang/String;
