...
# instance fields
.field private hasAddSplitActionBar:Z
...
.method constructor <init>(Landroid/app/Activity;)V
    ...
    iput-boolean v0, p0, Lcom/miui/internal/app/ActionBarDelegateImpl;->hasAddSplitActionBar:Z
...
# virtual methods
.method public addContentMask(Lcom/miui/internal/widget/ActionBarOverlayLayout;)V
    .locals 0

    instance-of p0, p1, Lcom/miui/internal/widget/ActionBarOverlayLayout;

    if-eqz p0, :cond_1

    sget p0, Lcom/miui/internal/R$id;->content_mask_vs:I
    ...
    :cond_0
    sget p0, Lcom/miui/internal/R$id;->content_mask:I
    ...
    :goto_0
    invoke-virtual {p1, p0}, Lcom/miui/internal/widget/ActionBarOverlayLayout;->setContentMask(Landroid/view/View;)V

    :cond_1
    return-void
.end method

.method public addSplitActionBar(ZZLcom/miui/internal/widget/ActionBarOverlayLayout;)V
    .locals 2

    iget-boolean v0, p0, Lcom/miui/internal/app/ActionBarDelegateImpl;->hasAddSplitActionBar:Z
    ...
    sget v0, Lcom/miui/internal/R$id;->split_action_bar_vs:I
    ...
    sget v1, Lcom/miui/internal/R$id;->action_context_bar_vs:I
    ...
    invoke-virtual {v1, p2}, Lcom/miui/internal/widget/ActionBarContextView;->setSplitWhenNarrow(Z)V

    invoke-virtual {p3, v0}, Lcom/miui/internal/widget/ActionBarOverlayLayout;->setSplitActionBarView(Lcom/miui/internal/widget/ActionBarContainer;)V

    invoke-virtual {p3, v1}, Lcom/miui/internal/widget/ActionBarOverlayLayout;->setActionBarContextView(Lcom/miui/internal/widget/ActionBarContextView;)V

    invoke-virtual {p0, p3}, Lcom/miui/internal/app/ActionBarDelegateImpl;->addContentMask(Lcom/miui/internal/widget/ActionBarOverlayLayout;)V
...
.method protected setMenu(Lcom/miui/internal/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {p0}, Lcom/miui/internal/app/ActionBarDelegateImpl;->getView()Landroid/view/View;

    move-result-object v1

    instance-of v2, v1, Lcom/miui/internal/widget/ActionBarOverlayLayout;
    ...
    invoke-virtual {p0, v2, v0, v1}, Lcom/miui/internal/app/ActionBarDelegateImpl;->addSplitActionBar(ZZLcom/miui/internal/widget/ActionBarOverlayLayout;)V
