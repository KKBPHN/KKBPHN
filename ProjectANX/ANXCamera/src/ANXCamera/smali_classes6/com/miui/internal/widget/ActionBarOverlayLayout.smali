...
.field private static final WINDOWING_MODE_FREEFORM_PC:I = 0x64
...
.field private mCurrentWindowMode:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mCurrentWindowMode:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mRootSubDecor:Z
    ...
    iput-object v1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mContentMaskInsets:Landroid/graphics/Rect;
    ...
    iput-object p3, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mFixedWidthMajor:Landroid/util/TypedValue;

    sget p3, Lcom/miui/internal/R$styleable;->Window_windowFixedWidthMajor:I

    iget-object v1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mFixedWidthMajor:Landroid/util/TypedValue;

    invoke-virtual {p2, p3, v1}, Landroid/content/res/TypedArray;->getValue(ILandroid/util/TypedValue;)Z
    ...
    iput-object p3, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mFixedWidthMinor:Landroid/util/TypedValue;
    ...
    iput-object p3, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mFixedHeightMajor:Landroid/util/TypedValue;
    ...
    iput-object p3, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mFixedHeightMinor:Landroid/util/TypedValue;
    ...
    :cond_3
    sget p3, Lmiui/R$styleable;->Window_contentAutoFitSystemWindow:I

    invoke-virtual {p2, p3, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p3

    iput-boolean p3, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mContentAutoFitSystemWindow:Z

    iget-boolean p3, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mContentAutoFitSystemWindow:Z

    if-eqz p3, :cond_4

    sget p3, Lmiui/R$styleable;->Window_contentHeaderBackground:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mContentHeaderBackground:Landroid/graphics/drawable/Drawable;

    :cond_4
    invoke-virtual {p2}, Landroid/content/res/TypedArray;->recycle()V

    sget-boolean p2, Lcom/miui/internal/util/DeviceHelper;->IS_PCMODE_ENABLED:Z

    if-eqz p2, :cond_5

    invoke-direct {p0, p1}, Lcom/miui/internal/widget/ActionBarOverlayLayout;->getWindowingMode(Landroid/content/Context;)I

    move-result p1

    iput p1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mCurrentWindowMode:I
...
.method private getWindowingMode(Landroid/content/Context;)I
    .locals 4
    ...
    invoke-static {v1, v2}, Lcom/miui/internal/util/ReflectUtils;->getField(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    invoke-static {v1, v2, v3}, Lcom/miui/internal/util/ReflectUtils;->getMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    const-string v2, "Failed to getWindowingMode: "
    ...
    invoke-static {v1, p1, p0}, Lmiui/util/Log;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mCurrentWindowMode:I
...
.method public setActionBarContextView(Lcom/miui/internal/widget/ActionBarContextView;)V
    ...
    iput-object p1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mActionBarContextView:Lcom/miui/internal/widget/ActionBarContextView;
...
.method public setContentMask(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mContentMask:Landroid/view/View;

    sget-boolean p1, Lcom/miui/internal/util/DeviceHelper;->IS_OLED:Z

    if-eqz p1, :cond_0

    iget-object p1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mContentMask:Landroid/view/View;
    ...
    sget v1, Lcom/miui/internal/R$drawable;->window_content_mask_oled:I
...
.method public setSplitActionBarView(Lcom/miui/internal/widget/ActionBarContainer;)V
    .locals 0

    iput-object p1, p0, Lcom/miui/internal/widget/ActionBarOverlayLayout;->mActionBarBottom:Lcom/miui/internal/widget/ActionBarContainer;
