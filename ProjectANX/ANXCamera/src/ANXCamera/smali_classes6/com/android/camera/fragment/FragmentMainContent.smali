...
.method static synthetic O000000o(Landroid/widget/TextView;)V
    .locals 2
...
.method static synthetic O000000o(Lcom/android/camera/aiwatermark/data/WatermarkItem;ZLandroid/view/View;)V
    .locals 0
...
.method private autoRelayoutUI(Ljava/lang/String;Landroid/widget/LinearLayout;Z)V
    .locals 9
    ...
    iget v6, p3, Landroid/view/ViewGroup$LayoutParams;->height:I
    ...
    iget v3, p3, Landroid/widget/FrameLayout$LayoutParams;->topMargin:I

    iget v4, p3, Landroid/widget/FrameLayout$LayoutParams;->leftMargin:I

    iget v5, p3, Landroid/widget/FrameLayout$LayoutParams;->width:I

    add-int/2addr v4, v5

    iget v5, p3, Landroid/widget/FrameLayout$LayoutParams;->topMargin:I
    ...
    invoke-virtual {p2, p3, v1, v2, v3}, Landroid/widget/LinearLayout;->layout(IIII)V
    ...
    invoke-virtual {v0, v1, v1, v2, p3}, Landroid/widget/FrameLayout;->layout(IIII)V
    ...
    invoke-virtual {p2, v1, v1, p3, p1}, Landroid/widget/LinearLayout;->layout(IIII)V
    ...
    invoke-virtual {v0, v2, v3, v4, v5}, Landroid/widget/FrameLayout;->layout(IIII)V
    ...
    invoke-virtual {p2, p3, v0, v2, v3}, Landroid/widget/LinearLayout;->layout(IIII)V
    ...
    iget v5, v6, Landroid/widget/LinearLayout$LayoutParams;->width:I
    ...
    invoke-virtual {p3, v0, v2, v4, v5}, Landroid/view/View;->layout(IIII)V
    ...
    invoke-virtual {v0, v2, v4, v5, v6}, Landroid/widget/LinearLayout;->layout(IIII)V
...
.method private doAccessible(Landroid/view/View;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/camera/fragment/O0000o0O;-><init>(Lcom/android/camera/fragment/FragmentMainContent;Landroid/view/View;)V
...
.method private needShowZoomView(I)Z
    ...
    invoke-virtual {v2, p1}, LO00000Oo/O00000oO/O000000o/O00000o;->O000O00o(I)Z
...
.method private reSizeTextView(Landroid/widget/TextView;)V
    ...
    invoke-direct {v0, p1}, Lcom/android/camera/fragment/O0000o00;-><init>(Landroid/widget/TextView;)V
...
.method private updateImageWatermarkItemRotation(Landroid/view/ViewStub;Landroid/widget/FrameLayout;ILcom/android/camera/data/data/runing/ComponentRunningAIWatermark;Lcom/android/camera/aiwatermark/data/WatermarkItem;)V
    ...
    invoke-direct {p0, p5, p3}, Lcom/android/camera/fragment/FragmentMainContent;->updateTextBitmap(Lcom/android/camera/aiwatermark/data/WatermarkItem;Landroid/view/View;)V
...
.method private updateTextBitmap(Lcom/android/camera/aiwatermark/data/WatermarkItem;Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/LocationManager;->getCurrentLocationDirectly()Landroid/location/Location;
    ...
    :cond_2
    :goto_3
    invoke-interface {v0, v4, v2}, Lcom/android/camera/protocol/ModeProtocol$TopAlert;->alertTopHint(II)V
    ...
    invoke-direct {v0, p1, v3, p2}, Lcom/android/camera/fragment/O0000o0o;-><init>(Lcom/android/camera/aiwatermark/data/WatermarkItem;ZLandroid/view/View;)V
...
.method private updateTextWatermarkItemRotation(Landroid/view/ViewStub;Landroid/widget/FrameLayout;ILcom/android/camera/data/data/runing/ComponentRunningAIWatermark;Lcom/android/camera/aiwatermark/data/WatermarkItem;)V
    ...
    :cond_1
    invoke-virtual {p5}, Lcom/android/camera/aiwatermark/data/WatermarkItem;->hasAltitude()Z

    move-result p1

    invoke-direct {p0, v1, v2, p1}, Lcom/android/camera/fragment/FragmentMainContent;->autoRelayoutUI(Ljava/lang/String;Landroid/widget/LinearLayout;Z)V
    ...
    invoke-direct {p0, v1, p1, v9, p3}, Lcom/android/camera/fragment/FragmentMainContent;->initWatermarkLocation(Landroid/widget/FrameLayout$LayoutParams;Landroid/util/Size;Landroid/graphics/Rect;I)[I
    ...
    invoke-virtual {p4, p1, v9, v3}, Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;->updateLocation([ILandroid/graphics/Rect;I)V
    ...
    :cond_3
    invoke-direct {p0, p5, p3, v1}, Lcom/android/camera/fragment/FragmentMainContent;->calculateLP(Lcom/android/camera/aiwatermark/data/WatermarkItem;ILandroid/widget/FrameLayout$LayoutParams;)Landroid/widget/FrameLayout$LayoutParams;
...
.method private updateWatermarkItemBackground(Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;)V
    ...
    invoke-static {v6}, Lcom/android/camera/Util;->getBitmapSize(I)Landroid/util/Size;
    ...
    iget v8, p0, Lcom/android/camera/fragment/FragmentMainContent;->mSuperMoonScaleSize:F
...
# virtual methods
.method public synthetic O00000o(Landroid/view/View;Landroid/view/MotionEvent;)Z
    .locals 0
...
.method public synthetic O00000o0(Landroid/view/View;Landroid/view/View;)V
    .locals 2
    ...
    :cond_0
    new-instance p2, Lcom/android/camera/fragment/O0000o0;

    invoke-direct {p2, p0, p1}, Lcom/android/camera/fragment/O0000o0;-><init>(Lcom/android/camera/fragment/FragmentMainContent;Landroid/view/View;)V
...
.method public synthetic O0000o0(Z)V
    .locals 0
...
.method public synthetic O0000o0O(Z)V
    .locals 6
...
.method public synthetic O000oO0O()V
    .locals 1
...
.method public hideReferenceGradienter()V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/fragment/O0000o;-><init>(Lcom/android/camera/fragment/FragmentMainContent;)V
...
.method protected initView(Landroid/view/View;)V
    ...
    invoke-static {}, Lcom/android/camera/aiwatermark/util/WatermarkConstant;->calcSuperMoonScale()F

    move-result v0

    iput v0, p0, Lcom/android/camera/fragment/FragmentMainContent;->mSuperMoonScaleSize:F
...
.method public onResume()V
    ...
    new-instance v1, Lcom/android/camera/fragment/O0000oOO;

    invoke-direct {v1, p0}, Lcom/android/camera/fragment/O0000oOO;-><init>(Lcom/android/camera/fragment/FragmentMainContent;)V
...
.method public provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-virtual {p3, p1}, LO00000Oo/O00000oO/O000000o/O00000o;->O000O00o(I)Z
    ...
    :goto_5
    invoke-virtual {p0, v5}, Lcom/android/camera/fragment/FragmentMainContent;->setWatermarkVisible(I)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/FragmentMainContent;->mOnClickListener:Landroid/view/View$OnClickListener;

    invoke-direct {p1, p3, v0}, Lcom/android/camera/aiwatermark/DragListener;-><init>(Landroid/graphics/Rect;Landroid/view/View$OnClickListener;)V
    ...
    iget-object p3, p0, Lcom/android/camera/fragment/FragmentMainContent;->mListener:Lcom/android/camera/aiwatermark/DragListener;
    ...
    invoke-static {p1, v6}, Lcom/android/camera/animation/type/SlideOutOnSubscribe;->directSetResult(Landroid/view/View;I)V
    ...
    invoke-direct {p1, v1, v6}, Lcom/android/camera/animation/type/SlideOutOnSubscribe;-><init>(Landroid/view/View;I)V
    ...
    new-instance p2, Lcom/android/camera/fragment/O0000Ooo;

    invoke-direct {p2, p0}, Lcom/android/camera/fragment/O0000Ooo;-><init>(Lcom/android/camera/fragment/FragmentMainContent;)V
...
.method public setIdPhotoBoxVisible(Z)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/camera/fragment/O0000oO0;-><init>(Lcom/android/camera/fragment/FragmentMainContent;Z)V
...
.method public updateMimojiFaceDetectResultTip(Z)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/camera/fragment/O0000oO;-><init>(Lcom/android/camera/fragment/FragmentMainContent;Z)V
...
.method public updateWatermarkSample(Lcom/android/camera/aiwatermark/data/WatermarkItem;)V
    ...
    const-string v4, "updateWatermarkSample Item Key = %s"
    ...
    :goto_0
    invoke-direct {p0, v3, v4}, Lcom/android/camera/fragment/FragmentMainContent;->showWatermarkItem(Landroid/widget/FrameLayout;Z)V
    ...
    :goto_1
    invoke-direct {p0, v3, v0}, Lcom/android/camera/fragment/FragmentMainContent;->showWatermarkItem(Landroid/widget/FrameLayout;Z)V

    invoke-direct {p0, v2}, Lcom/android/camera/fragment/FragmentMainContent;->updateWatermarkItemBackground(Lcom/android/camera/data/data/runing/ComponentRunningAIWatermark;)V
