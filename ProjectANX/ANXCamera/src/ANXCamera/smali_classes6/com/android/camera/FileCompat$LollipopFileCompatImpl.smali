...
.method public getDocumentFileByPath(Ljava/lang/String;ZLjava/lang/String;Z)Landroidx/documentfile/provider/DocumentFile;
    ...
    invoke-virtual {v13, v12}, Landroidx/documentfile/provider/DocumentFile;->createDirectory(Ljava/lang/String;)Landroidx/documentfile/provider/DocumentFile;
    ...
    :cond_6
    invoke-virtual {v13, v12}, Landroidx/documentfile/provider/DocumentFile;->findFile(Ljava/lang/String;)Landroidx/documentfile/provider/DocumentFile;
    ...
    const-string v9, "createFile error"

    if-eqz p4, :cond_b

    :try_start_0
    invoke-virtual {v13, v4}, Landroidx/documentfile/provider/DocumentFile;->findFile(Ljava/lang/String;)Landroidx/documentfile/provider/DocumentFile;

    move-result-object v6

    if-nez v6, :cond_10

    invoke-virtual {v13, v4}, Landroidx/documentfile/provider/DocumentFile;->createDirectory(Ljava/lang/String;)Landroidx/documentfile/provider/DocumentFile;
    ...
    invoke-static {v3, v9, v0}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    :cond_e
    :try_start_1
    invoke-virtual {v13, v10, v4}, Landroidx/documentfile/provider/DocumentFile;->createFile(Ljava/lang/String;Ljava/lang/String;)Landroidx/documentfile/provider/DocumentFile;
    ...
    invoke-static {v3, v9, v4}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
