...
.field private mCurTvLocation:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurWidth:I

    iput v0, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurTvLocation:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput p2, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurWidth:I

    iput p2, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurTvLocation:I
...
.method private judgeCorridinate(FF)I
    ...
    iget-boolean v0, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsRTL:Z
...
.method private updateInnerContainer(IZ)V
    ...
    iget p2, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurWidth:I
    ...
    iget v6, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurWidth:I

    new-array v7, v4, [J

    invoke-virtual {p2, v3, v6, v7}, Lmiuix/animation/controller/AnimState;->add(Lmiuix/animation/property/ViewProperty;I[J)Lmiuix/animation/controller/AnimState;
    ...
    iget v2, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurWidth:I

    new-array v3, v4, [J

    invoke-virtual {p1, v0, v2, v3}, Lmiuix/animation/controller/AnimState;->add(Lmiuix/animation/property/ViewProperty;I[J)Lmiuix/animation/controller/AnimState;
...
.method private updateTvCurrent(ZF)V
    ...
    iget-boolean v5, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsRTL:Z
    ...
    iget v4, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurrentValue:I
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/camera/timerburst/CustomSeekBar;->showOrHideAnim(Landroid/view/View;Z)V
    ...
    :cond_3
    iget-boolean v4, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsRTL:Z

    if-nez v4, :cond_4

    iget v4, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mTvEndX:F

    iget v9, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCircleIndexX:F

    sub-float/2addr v4, v9

    iget v9, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mTvWidth:F
    ...
    iget-boolean v9, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsEnlargeState:Z
    ...
    iget-boolean p1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsRTL:Z
    ...
    iget v8, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mTvEndX:F
    ...
    :cond_d
    iget p1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurTvLocation:I

    if-ne p1, v6, :cond_e

    iget p1, v4, Landroid/widget/RelativeLayout$LayoutParams;->rightMargin:I

    sub-int/2addr p1, v7

    iput p1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurTvLocation:I
    ...
    iget v3, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurTvLocation:I

    new-array v6, v2, [J

    invoke-virtual {p1, v1, v3, v6}, Lmiuix/animation/controller/AnimState;->add(Lmiuix/animation/property/ViewProperty;I[J)Lmiuix/animation/controller/AnimState;
    ...
    iget v3, v4, Landroid/widget/RelativeLayout$LayoutParams;->rightMargin:I
    ...
    iput v1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurTvLocation:I
    ...
    iget-object v1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mTvParentLayout:Landroid/widget/RelativeLayout;

    invoke-virtual {v1, p1}, Landroid/widget/RelativeLayout;->getLocationOnScreen([I)V

    iget v1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mTvEndX:F
    ...
    iget p1, v4, Landroid/widget/RelativeLayout$LayoutParams;->leftMargin:I
    ...
    iput v7, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mCurTvLocation:I
    ...
    invoke-virtual {v1, p2, v3, v4}, Lmiuix/animation/controller/AnimState;->add(Lmiuix/animation/property/ViewProperty;I[J)Lmiuix/animation/controller/AnimState;
...
.method public initSeekBarConfig([IIILjava/lang/String;Lcom/android/camera/timerburst/CustomSeekBar$AddSeekBarValueListener;)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsRTL:Z
    ...
    invoke-static {p3, v0}, Lcom/android/camera/log/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v1, v4}, Lcom/android/camera/log/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-boolean p1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsEnlargeState:Z
    ...
    iget-object p1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mConfigArray:[I
    ...
    :cond_5
    iget-boolean v1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mIsRTL:Z

    if-eqz v1, :cond_6

    iget v1, p0, Lcom/android/camera/timerburst/CustomSeekBar;->mTotalwidth:I
