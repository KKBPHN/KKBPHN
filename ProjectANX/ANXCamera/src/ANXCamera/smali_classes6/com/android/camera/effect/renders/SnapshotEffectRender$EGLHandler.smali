...
.method private applyEffectOnlyWatermarkRange(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;)[B
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/camera/effect/renders/Render;->deleteBuffer()V
...
.method private blockSplitApplyEffect(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;IZLcom/android/camera/effect/renders/SnapshotEffectRender$Size;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;)V
    ...
    iget-boolean v5, v11, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mHasDualWaterMark:Z

    move/from16 v25, v3

    iget-boolean v3, v11, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mHasFrontWaterMark:Z

    move/from16 v26, v4

    iget-object v4, v11, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mTimeWaterMarkText:Ljava/lang/String;
    ...
    invoke-static/range {v17 .. v23}, Lcom/android/camera/Util;->getWatermarkRange(IIIZZLjava/lang/String;Lcom/android/camera/effect/renders/DeviceWatermarkParam;)[I
    ...
    const-string v5, "blockSplitApplyEffect: rotation = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v5, v11, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mJpegOrientation:I
    ...
    invoke-direct {v3, v5, v7, v15, v6}, Landroid/graphics/RectF;-><init>(FFFF)V
    ...
    invoke-static {v5, v6, v7, v4, v15}, Lcom/android/camera/effect/ShaderNativeUtil;->genWaterMarkRange(IIIII)V
    ...
    iget v4, v0, Lcom/android/camera/effect/framework/graphics/Block;->mWidth:I
    ...
    invoke-static {v11, v11, v4, v3}, Landroid/opengl/GLES20;->glViewport(IIII)V
    ...
    invoke-static/range {v40 .. v46}, Lcom/android/camera/effect/ShaderNativeUtil;->mergeWaterMarkRange(IIIIIII)V
