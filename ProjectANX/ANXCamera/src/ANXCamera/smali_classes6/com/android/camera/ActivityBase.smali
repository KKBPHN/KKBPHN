...
.field protected static final MSG_CANCEL_PRESENTATION:I = 0x5
...
.field protected static final MSG_SHOW_PRESENTATION:I = 0x4
...
.field protected mErrorDialog:Landroid/app/AlertDialog;
...
.method static synthetic access$000(Lcom/android/camera/ActivityBase;Landroid/graphics/Bitmap;)V
    .locals 0
...
.method public gotoGallery()V
    ...
    invoke-virtual {v2, v8}, Landroid/content/Intent;->resolveActivity(Landroid/content/pm/PackageManager;)Landroid/content/ComponentName;
    ...
    :cond_3
    const-string v5, "gotoGallery: com.miui.camera.action.REVIEW"
    ...
    invoke-virtual {v5}, Lcom/android/camera/ThumbnailUpdater;->getViewRect()Landroid/graphics/Rect;
    ...
    invoke-virtual {v5}, Lcom/android/camera/CameraBrightness;->getCurrentBrightnessAuto()F
    ...
    invoke-virtual {v2, v5, v8}, Landroid/content/Intent;->putExtra(Ljava/lang/String;F)Landroid/content/Intent;
    ...
    invoke-virtual {v5}, LO00000Oo/O00000oO/O000000o/O00000o;->OO00ooO()Z
    ...
    :goto_9
    const-string v4, "using_deputy_screen"
