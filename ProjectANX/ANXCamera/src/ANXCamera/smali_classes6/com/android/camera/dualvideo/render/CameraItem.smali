...
.method private drawBlurCover(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    ...
    sget-object v1, Lcom/android/camera/dualvideo/render/CameraItem$2;->$SwitchMap$com$android$camera$dualvideo$render$FaceType:[I
    ...
    const-string p1, "drawBlurCover: face type error!!"
...
.method private drawDarkCorner(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    ...
    invoke-virtual {p2, v0}, Lcom/android/camera/dualvideo/render/MiscTextureManager;->getTexture(Ljava/lang/String;)Lcom/android/gallery3d/ui/BasicTexture;
    ...
    iget v3, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mX:I

    iget v4, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I

    iget v5, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mWidth:I
    ...
    iget v5, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mX:I

    iget v1, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I

    iget v2, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mHeight:I
    ...
    iget v7, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mWidth:I
...
.method private drawExpand(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    .locals 7
    ...
    iget v0, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mX:I

    add-int/lit8 v3, v0, 0xa

    iget p0, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I
...
.method private drawExpandAndShrinkHandler(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    .locals 2
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Lcom/android/camera/dualvideo/render/CameraItem;->drawExpand(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V

    goto :goto_0

    :cond_2
    invoke-direct {p0, p1, p2}, Lcom/android/camera/dualvideo/render/CameraItem;->drawShrink(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
...
.method private drawLabel(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    .locals 7
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/dualvideo/util/DualVideoConfigManager;->getConfigDescription(Lcom/android/camera/dualvideo/render/LayoutType;)Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/android/camera/dualvideo/render/MiscTextureManager;->getTexTransMatrix()[F

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/android/camera/effect/GLCanvasState;->setTexMatrix([F)V

    invoke-virtual {p2}, Lcom/android/camera/dualvideo/render/MiscTextureManager;->getTexOrientation()I
    ...
    iget v1, v1, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mX:I
    ...
    iget v1, v1, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I
...
.method private drawSelectedFrame(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    ...
    invoke-virtual {v3, v2}, Lcom/android/camera/dualvideo/render/CameraItem;->getRenderAttri(I)Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;

    move-result-object v2

    new-instance v10, Lcom/android/camera/effect/draw_mode/DrawFillRectAttribute;

    iget v5, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mX:I

    iget v6, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I

    sget v7, Lcom/android/camera/dualvideo/render/RenderUtil;->SELECT_FRAME_LINE_WIDTH:I

    iget v8, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mHeight:I
    ...
    invoke-interface {v0, v10}, Lcom/android/gallery3d/ui/GLCanvas;->draw(Lcom/android/camera/effect/draw_mode/DrawAttribute;)V

    new-instance v4, Lcom/android/camera/effect/draw_mode/DrawFillRectAttribute;

    iget v5, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mX:I

    iget v6, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mWidth:I

    add-int/2addr v5, v6

    sget v14, Lcom/android/camera/dualvideo/render/RenderUtil;->SELECT_FRAME_LINE_WIDTH:I

    sub-int v12, v5, v14

    iget v13, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I

    iget v15, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mHeight:I
    ...
    invoke-interface {v0, v4}, Lcom/android/gallery3d/ui/GLCanvas;->draw(Lcom/android/camera/effect/draw_mode/DrawAttribute;)V

    new-instance v4, Lcom/android/camera/effect/draw_mode/DrawBasicTexAttribute;

    const-string v5, "s_f_top"

    invoke-virtual {v1, v5}, Lcom/android/camera/dualvideo/render/MiscTextureManager;->getTexture(Ljava/lang/String;)Lcom/android/gallery3d/ui/BasicTexture;
    ...
    invoke-virtual {v7}, Lcom/android/gallery3d/ui/BasicTexture;->getHeight()I
    ...
    invoke-virtual {v1, v4}, Lcom/android/camera/dualvideo/render/MiscTextureManager;->getTexture(Ljava/lang/String;)Lcom/android/gallery3d/ui/BasicTexture;
    ...
    iget v7, v2, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mWidth:I
    ...
    sget-object v4, Lcom/android/camera/dualvideo/render/CameraItem$2;->$SwitchMap$com$android$camera$dualvideo$util$SelectIndex:[I
    ...
    :goto_0
    invoke-virtual {v1, v3}, Lcom/android/camera/dualvideo/render/MiscTextureManager;->getTexture(Ljava/lang/String;)Lcom/android/gallery3d/ui/BasicTexture;
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/android/camera/dualvideo/render/MiscTextureManager;->gemAnimTexTransMatrix()[F

    move-result-object v1

    invoke-virtual {v3, v1}, Lcom/android/camera/effect/GLCanvasState;->setTexMatrix([F)V
...
.method private drawShrink(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    .locals 7
...
.method private genPreviewAttri(Lcom/android/camera/dualvideo/render/RegionHelper;)Lcom/android/camera/effect/draw_mode/DrawExtTexAttribute;
    ...
    invoke-static {v1, p0, v0, p1}, Lcom/android/camera/dualvideo/render/RenderUtil;->generatePreviewTransMatrix(Lcom/android/camera/dualvideo/render/FaceType;Lcom/android/camera/dualvideo/render/LayoutType;Lcom/android/gallery3d/ui/BasicTexture;Landroid/graphics/Rect;)[F
...
.method public draw(Lcom/android/gallery3d/ui/GLCanvas;ILcom/android/camera/dualvideo/render/MiscTextureManager;)V
    .locals 0
    ...
    :pswitch_0
    invoke-direct {p0, p1, p3}, Lcom/android/camera/dualvideo/render/CameraItem;->drawExpandAndShrinkHandler(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
    ...
    :pswitch_2
    invoke-direct {p0, p1, p3}, Lcom/android/camera/dualvideo/render/CameraItem;->drawLabel(Lcom/android/gallery3d/ui/GLCanvas;Lcom/android/camera/dualvideo/render/MiscTextureManager;)V
...
.method public getHandleArea(Lcom/android/camera/dualvideo/render/MiscTextureManager;)Landroid/graphics/Rect;
    .locals 5
    .annotation build Landroid/annotation/SuppressLint;
        value = {
            "SwitchIntDef"
    ...
    iget v3, p0, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mY:I
...
.method public setRenderAttri(Lcom/android/camera/effect/draw_mode/DrawExtTexAttribute;I)V
    .locals 0
...
.method public setSelectTypeWithAnim(Lcom/android/camera/dualvideo/util/SelectIndex;Z)V
    ...
    iget-object p1, p0, Lcom/android/camera/dualvideo/render/CameraItem;->mSelectedType:Lcom/android/camera/dualvideo/util/SelectIndex;
...
.method public updateRenderAttri(Lcom/android/camera/dualvideo/render/RegionHelper;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/dualvideo/render/CameraItem;->setRenderAttri(Lcom/android/camera/effect/draw_mode/DrawExtTexAttribute;I)V
