...
.method static synthetic O000000o(ILjava/util/ArrayList;)Lcom/android/camera/dualvideo/render/CameraItemInterface;
    .locals 1
    ...
    new-instance v0, Lcom/android/camera/dualvideo/view/O0000Oo0;

    invoke-direct {v0, p0}, Lcom/android/camera/dualvideo/view/O0000Oo0;-><init>(I)V
...
.method static synthetic O000000o(FFLcom/android/camera/protocol/ModeProtocol$DualVideoRenderProtocol;)Lcom/android/camera/dualvideo/render/LayoutType;
    .locals 0
...
.method static synthetic O000000o(ILandroid/graphics/Rect;Lcom/android/camera/protocol/ModeProtocol$DualVideoRenderProtocol;)V
    .locals 1
    ...
    new-instance v0, Lcom/android/camera/dualvideo/view/O0000Ooo;

    invoke-direct {v0, p0}, Lcom/android/camera/dualvideo/view/O0000Ooo;-><init>(I)V
    ...
    new-instance p2, Lcom/android/camera/dualvideo/view/O0000o00;

    invoke-direct {p2, p1}, Lcom/android/camera/dualvideo/view/O0000o00;-><init>(Landroid/graphics/Rect;)V
...
.method static synthetic O000000o(Landroid/graphics/Rect;Lcom/android/camera/dualvideo/render/CameraItemInterface;)V
    .locals 3
...
.method static synthetic O000000o(ILcom/android/camera/dualvideo/render/CameraItemInterface;)Z
    .locals 0
...
.method static synthetic O00000Oo(ILcom/android/camera/dualvideo/render/CameraItemInterface;)Z
    .locals 0
...
.method private getMiscTexManager()Lcom/android/camera/dualvideo/render/MiscTextureManager;
    ...
    sget-object v0, Lcom/android/camera/dualvideo/view/O00000o0;->INSTANCE:Lcom/android/camera/dualvideo/view/O00000o0;

    invoke-virtual {p0, v0}, Ljava/util/Optional;->map(Ljava/util/function/Function;)Ljava/util/Optional;

    move-result-object p0

    sget-object v0, Lcom/android/camera/dualvideo/view/O0000o0O;->INSTANCE:Lcom/android/camera/dualvideo/view/O0000o0O;
...
.method private getRect(I)Landroid/graphics/Rect;
    ...
    new-instance v1, Lcom/android/camera/dualvideo/view/O0000OoO;

    invoke-direct {v1, p1, v0}, Lcom/android/camera/dualvideo/view/O0000OoO;-><init>(ILandroid/graphics/Rect;)V
    ...
    new-instance v1, Lcom/android/camera/dualvideo/view/O00000oO;

    invoke-direct {v1, p0, v0}, Lcom/android/camera/dualvideo/view/O00000oO;-><init>(Lcom/android/camera/dualvideo/view/TouchEventView$TouchHelper;Landroid/graphics/Rect;)V
...
.method private getRenderList()Ljava/util/Optional;
    ...
    sget-object v0, Lcom/android/camera/dualvideo/view/O000000o;->INSTANCE:Lcom/android/camera/dualvideo/view/O000000o;

    invoke-virtual {p0, v0}, Ljava/util/Optional;->map(Ljava/util/function/Function;)Ljava/util/Optional;

    move-result-object p0

    sget-object v0, Lcom/android/camera/dualvideo/view/O00000Oo;->INSTANCE:Lcom/android/camera/dualvideo/view/O00000Oo;
...
.method private getSelectDescription(I)Ljava/lang/String;
    ...
    new-instance v1, Lcom/android/camera/dualvideo/view/O0000o0;

    invoke-direct {v1, p1}, Lcom/android/camera/dualvideo/view/O0000o0;-><init>(I)V
...
# virtual methods
.method public synthetic O000000o(Landroid/graphics/Rect;Ljava/util/ArrayList;)V
    .locals 1
    ...
    invoke-direct {v0, p0}, Lcom/android/camera/dualvideo/view/O0000OOo;-><init>(Lcom/android/camera/dualvideo/view/TouchEventView$TouchHelper;)V
    ...
    new-instance v0, Lcom/android/camera/dualvideo/view/O0000Oo;

    invoke-direct {v0, p0, p1}, Lcom/android/camera/dualvideo/view/O0000Oo;-><init>(Lcom/android/camera/dualvideo/view/TouchEventView$TouchHelper;Landroid/graphics/Rect;)V
...
.method public synthetic O000000o(FFLcom/android/camera/dualvideo/render/CameraItemInterface;)Z
    .locals 0
...
.method public synthetic O000000o(Lcom/android/camera/dualvideo/render/CameraItemInterface;)Z
    .locals 2
    ...
    invoke-interface {p1, v0}, Lcom/android/camera/dualvideo/render/CameraItemInterface;->getHandleArea(Lcom/android/camera/dualvideo/render/MiscTextureManager;)Landroid/graphics/Rect;
...
.method public synthetic O00000Oo(Landroid/graphics/Rect;Lcom/android/camera/dualvideo/render/CameraItemInterface;)V
    .locals 0
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/dualvideo/render/CameraItemInterface;->getHandleArea(Lcom/android/camera/dualvideo/render/MiscTextureManager;)Landroid/graphics/Rect;
...
.method protected getVirtualViewAt(FF)I
    ...
    new-instance v2, Lcom/android/camera/dualvideo/view/O0000O0o;

    invoke-direct {v2, p1, p2}, Lcom/android/camera/dualvideo/view/O0000O0o;-><init>(FF)V
    ...
    new-instance v2, Lcom/android/camera/dualvideo/view/O00000oo;

    invoke-direct {v2, p0, p1, p2}, Lcom/android/camera/dualvideo/view/O00000oo;-><init>(Lcom/android/camera/dualvideo/view/TouchEventView$TouchHelper;FF)V
