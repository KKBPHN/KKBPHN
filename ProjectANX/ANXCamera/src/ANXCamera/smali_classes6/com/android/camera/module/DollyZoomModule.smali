...
.method static synthetic O00000Oo(Landroid/net/Uri;)V
    .locals 2
...
.method static synthetic O00000Oo(Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;)V
    .locals 2
...
.method static synthetic O00oo00O()V
    .locals 4
...
.method static synthetic access$400(Lcom/android/camera/module/DollyZoomModule;)V
    .locals 0
...
.method static synthetic access$500(Lcom/android/camera/module/DollyZoomModule;)J
    .locals 2
...
.method private initDollyZoomMode()V
    ...
    invoke-virtual {v1}, Lcom/mi/device/Common;->Oo0Oo()Z
    ...
    new-instance v9, Lcom/android/camera/module/O000Oo00;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/camera/module/O000Oo00;-><init>(Lcom/android/camera/module/DollyZoomModule;IIII)V

    invoke-virtual {v8, v9}, Landroid/opengl/GLSurfaceView;->queueEvent(Ljava/lang/Runnable;)V
    ...
    iput-boolean v7, p0, Lcom/android/camera/module/DollyZoomModule;->mPendingStart:Z
...
.method private onDollyZoomState()V
    ...
    const-string v7, "onDollyZoomState unknown state:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_EARLY_STOP_BY_ALGO zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_MOVE_OUT_ZOOM zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_MOVE_OUT_FRAME zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_BAD_ALGO_RESLUT zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_NORMAL_END zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_RUNNING zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_INITIALIZED zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_WAITING zoomScale:"
    ...
    const-string v7, "onDollyZoomState RUN_STATE_FAILED zoomScale:"
    ...
    iget v2, p0, Lcom/android/camera/module/DollyZoomModule;->mLastDollyZoomState:I
    ...
    const-string v2, "value_dolly_zoom_state_frame_out"

    goto :goto_4

    :cond_2
    :goto_3
    const-string v2, "value_dolly_zoom_state_target_lost"
    ...
    new-instance v4, Lcom/android/camera/module/O000OOo0;

    invoke-direct {v4, p0, v0, v3, v1}, Lcom/android/camera/module/O000OOo0;-><init>(Lcom/android/camera/module/DollyZoomModule;IFI)V
...
.method private saveVideo()V
    ...
    iget-object v0, p0, Lcom/android/camera/module/DollyZoomModule;->mVideoFileName:Ljava/lang/String;
...
.method private setOrientationParameter()V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/module/O000OOo;-><init>(Lcom/android/camera/module/DollyZoomModule;)V
...
.method private updateFocusMode()V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/CameraCapabilities;->getMinimumFocusDistance()F
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera2/Camera2Proxy;->setFocusDistance(F)V
...
# virtual methods
.method public synthetic O000000o(IFI)V
    .locals 16
    ...
    invoke-static {v12, v2}, Lcom/android/camera/statistic/CameraStatUtils;->trackDollyZoomZoomValue(ZF)V
    ...
    :cond_7
    iput-boolean v11, v0, Lcom/android/camera/module/DollyZoomModule;->mIsRecording:Z
    ...
    new-instance v13, Lcom/android/camera/module/O000Oo0O;

    invoke-direct {v13, v0, v4}, Lcom/android/camera/module/O000Oo0O;-><init>(Lcom/android/camera/module/DollyZoomModule;Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;)V
    ...
    iget v5, v0, Lcom/android/camera/module/DollyZoomModule;->mLastRecordingState:I
    ...
    const-string v6, "onDollyZoomState mLastRecordingState:"

    invoke-virtual {v15, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v6, v0, Lcom/android/camera/module/DollyZoomModule;->mLastRecordingState:I

    invoke-virtual {v15, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, " GetEncoderState:"
    ...
    :goto_3
    invoke-static {v5, v2}, Lcom/android/camera/statistic/CameraStatUtils;->trackDollyZoomZoomValue(ZF)V

    if-ne v1, v12, :cond_b

    iget-boolean v5, v0, Lcom/android/camera/module/DollyZoomModule;->mIsVideoSaveCancel:Z
    ...
    const-string v7, "onDollyZoomState mIsVideoSaveCancel:"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v7, v0, Lcom/android/camera/module/DollyZoomModule;->mIsVideoSaveCancel:Z
    ...
    invoke-interface {v4, v5, v12}, Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;->updateCaptureMessage(IZ)V

    iget-object v5, v0, Lcom/android/camera/module/BaseModule;->mHandler:Landroid/os/Handler;

    new-instance v6, Lcom/android/camera/module/O000Oo0o;

    invoke-direct {v6, v4}, Lcom/android/camera/module/O000Oo0o;-><init>(Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;)V
    ...
    new-instance v5, Lcom/android/camera/module/O000Oo0;

    invoke-direct {v5, v0, v4}, Lcom/android/camera/module/O000Oo0;-><init>(Lcom/android/camera/module/DollyZoomModule;Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;)V
    ...
    :cond_f
    iget v0, v0, Lcom/android/camera/module/DollyZoomModule;->mLastDollyZoomState:I

    if-ne v0, v10, :cond_10

    invoke-interface {v4, v2}, Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;->updateZoomRatioHint(F)V
...
.method public synthetic O000000o(IIII)V
    .locals 4
    ...
    invoke-virtual {v1, v2, v3, p1}, Lcom/xiaomi/dollyzoomprocess/MediaEffectCamera;->ConstructMediaEffectCamera(III)V
...
.method public synthetic O000000o(Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;)V
    .locals 2
    ...
    iget p0, p0, Lcom/android/camera/module/DollyZoomModule;->mResetCaptureHintCont:I
...
.method public synthetic O000000o(Lcom/xiaomi/dollyzoomprocess/MediaEffectCamera;)V
    .locals 1
...
.method public synthetic O00000o0(Lcom/android/camera/protocol/ModeProtocol$DollyZoomProcess;)V
    .locals 2
...
.method public onDestroy()V
    ...
    sget-object v1, Lcom/android/camera/module/O000OOOo;->INSTANCE:Lcom/android/camera/module/O000OOOo;
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/camera/module/O000OOoo;-><init>(Lcom/android/camera/module/DollyZoomModule;Lcom/xiaomi/dollyzoomprocess/MediaEffectCamera;)V
...
.method public onNewUriArrived(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    :cond_0
    new-instance p2, Lcom/android/camera/module/O000OOoO;

    invoke-direct {p2, p1}, Lcom/android/camera/module/O000OOoO;-><init>(Landroid/net/Uri;)V
...
.method public onShutterButtonClick(I)V
    ...
    const-string p1, "value_dolly_zoom_start_record"
...
.method public onSurfaceChanged(Ljavax/microedition/khronos/opengles/GL10;II)V
    ...
    iput-boolean p2, p0, Lcom/android/camera/module/DollyZoomModule;->mInitRender:Z
...
.method public setFrameAvailable(Z)V
    ...
    const-string v2, "setFrameAvailable "
