...
.method private parseDocAndSave(IILcom/android/zxing/PreviewImage;[FLjava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-direct {v1, v2, v3, v0}, Lcom/android/camera/storage/ParallelSaveRequest;->refreshThumbnail(ILjava/lang/String;Landroid/net/Uri;)V
...
.method private refreshThumbnail(ILjava/lang/String;Landroid/net/Uri;)V
    .locals 6

    iget-boolean v0, p0, Lcom/android/camera/storage/ParallelSaveRequest;->mNeedThumbnail:Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/storage/ParallelSaveRequest;->isFinal()Z
    ...
    iget v0, p0, Lcom/android/camera/storage/AbstractSaveRequest;->height:I
    ...
    iget-object v2, p0, Lcom/android/camera/storage/ParallelSaveRequest;->mData:[B

    invoke-static {v2, p1, v0, p3, v1}, Lcom/android/camera/Thumbnail;->createThumbnail([BIILandroid/net/Uri;Z)Lcom/android/camera/Thumbnail;
    ...
    const-string v1, "Just update the uri silently "
    ...
    iget-object p1, p0, Lcom/android/camera/storage/ParallelSaveRequest;->mSaverCallback:Lcom/android/camera/storage/SaverCallback;

    const/4 v0, -0x1

    invoke-interface {p1, v0, p3}, Lcom/android/camera/storage/SaverCallback;->updatePreviewThumbnailUri(ILandroid/net/Uri;)V
...
.method public save()V
    ...
    invoke-direct {v0, v3, v6, v1}, Lcom/android/camera/storage/ParallelSaveRequest;->refreshThumbnail(ILjava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-interface {v7, v4, v5, v12}, Lcom/android/camera/storage/SaverCallback;->notifyNewMediaData(Landroid/net/Uri;Ljava/lang/String;I)V
