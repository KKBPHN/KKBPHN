...
.method public static createThumbnailFromUri(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/Thumbnail;
    ...
    invoke-static {v2, v10, v11, v4, v7}, Landroid/provider/MediaStore$Images$Thumbnails;->getThumbnail(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v3, v15, v8}, Lcom/android/camera/Thumbnail;->getScaledBitmapFromFile(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v3, v15}, Lcom/android/camera/Thumbnail;->createVideoThumbnailBitmap(Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method public static getLastThumbnailFromContentResolver(Landroid/content/Context;[Lcom/android/camera/Thumbnail;Landroid/net/Uri;)I
    ...
    iget-object v10, v2, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;
    ...
    :cond_2
    iget-object v7, v2, Lcom/android/camera/Thumbnail$Media;->path:Ljava/lang/String;
    ...
    iget-wide v12, v2, Lcom/android/camera/Thumbnail$Media;->id:J
    ...
    :try_start_0
    invoke-static {v7, v9}, Landroid/media/ThumbnailUtils;->createImageThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    iget v0, v2, Lcom/android/camera/Thumbnail$Media;->width:I

    iget v5, v2, Lcom/android/camera/Thumbnail$Media;->height:I

    iget v10, v2, Lcom/android/camera/Thumbnail$Media;->orientation:I

    invoke-static {v7, v0, v5, v10}, Lcom/android/camera/Thumbnail;->getScaledBitmapFromFile(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v10, v0, v4}, Lcom/android/camera/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/Thumbnail;
    ...
    iget-wide v0, v2, Lcom/android/camera/Thumbnail$Media;->id:J
    ...
    invoke-static {v8, v1}, Lcom/android/camera/storage/HDR10Thumbnail/HDR10ThumbnailUtil;->getHdr10Bitmap(Landroid/opengl/EGLContext;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    iget-boolean v0, v2, Lcom/android/camera/Thumbnail$Media;->isGif:Z
    ...
    iget v1, v2, Lcom/android/camera/Thumbnail$Media;->width:I

    iget v2, v2, Lcom/android/camera/Thumbnail$Media;->height:I
...
.method private static getScaledBitmapFromFile(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v6, p2, p3, v0}, Landroid/graphics/Matrix;->setRotate(FFF)V
    ...
    const-string v0, "decode fail from "
    ...
    invoke-static {p3, p0, p2}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
