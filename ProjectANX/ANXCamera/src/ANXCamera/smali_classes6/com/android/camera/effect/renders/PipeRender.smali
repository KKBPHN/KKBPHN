...
.method public draw(Lcom/android/camera/effect/draw_mode/DrawAttribute;)Z
    ...
    :goto_4
    sget-object v12, Lcom/android/camera/effect/renders/PipeRender;->TAG:Ljava/lang/String;
    ...
    invoke-static {v12, v13}, Lcom/android/camera/effect/framework/gles/OpenGlUtils;->checkGlErrorAndWarning(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v5, :cond_7

    iget-object v12, v0, Lcom/android/camera/effect/renders/PipeRender;->mDoubleBuffer:Lcom/android/camera/effect/DoubleBuffer;

    invoke-virtual {v12}, Lcom/android/camera/effect/DoubleBuffer;->getOutputBuffer()Lcom/android/camera/effect/FrameBuffer;

    move-result-object v12

    invoke-virtual {v0, v12}, Lcom/android/camera/effect/renders/RenderGroup;->beginBindFrameBuffer(Lcom/android/camera/effect/FrameBuffer;)V
    ...
    iget-object v11, v0, Lcom/android/camera/effect/renders/PipeRender;->mDoubleBuffer:Lcom/android/camera/effect/DoubleBuffer;

    invoke-virtual {v11}, Lcom/android/camera/effect/DoubleBuffer;->getInputBuffer()Lcom/android/camera/effect/FrameBuffer;

    move-result-object v11

    invoke-virtual {v11}, Lcom/android/camera/effect/FrameBuffer;->getId()I
    ...
    iget-object v5, v0, Lcom/android/camera/effect/renders/PipeRender;->mDoubleBuffer:Lcom/android/camera/effect/DoubleBuffer;

    invoke-virtual {v5}, Lcom/android/camera/effect/DoubleBuffer;->getOutputBuffer()Lcom/android/camera/effect/FrameBuffer;
    ...
    invoke-virtual {v11}, Lcom/android/camera/effect/DoubleBuffer;->swapBuffer()V
