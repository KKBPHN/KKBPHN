...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget p1, p0, Lcom/android/camera/features/gif/DragTextView;->endx:F

    iget v0, p0, Lcom/android/camera/features/gif/DragTextView;->startx:F

    sub-float/2addr p1, v0

    float-to-int p1, p1

    iput p1, p0, Lcom/android/camera/features/gif/DragTextView;->horVector:I

    iget p1, p0, Lcom/android/camera/features/gif/DragTextView;->endy:F

    iget v0, p0, Lcom/android/camera/features/gif/DragTextView;->starty:F

    sub-float/2addr p1, v0

    float-to-int p1, p1

    iput p1, p0, Lcom/android/camera/features/gif/DragTextView;->verVector:I

    iget p1, p0, Lcom/android/camera/features/gif/DragTextView;->leftParent:I

    iget v0, p0, Lcom/android/camera/features/gif/DragTextView;->horVector:I

    add-int/2addr p1, v0

    iput p1, p0, Lcom/android/camera/features/gif/DragTextView;->leftParentAfter:I

    iget p1, p0, Lcom/android/camera/features/gif/DragTextView;->topParent:I

    iget v2, p0, Lcom/android/camera/features/gif/DragTextView;->verVector:I

    add-int/2addr p1, v2

    iput p1, p0, Lcom/android/camera/features/gif/DragTextView;->topParentAfter:I

    iget p1, p0, Lcom/android/camera/features/gif/DragTextView;->rightParent:I

    add-int/2addr p1, v0

    iput p1, p0, Lcom/android/camera/features/gif/DragTextView;->rightParentAfter:I

    iget p1, p0, Lcom/android/camera/features/gif/DragTextView;->bottomParent:I
    ...
    iget v2, p0, Lcom/android/camera/features/gif/DragTextView;->rightParentAfter:I

    iget v3, p0, Lcom/android/camera/features/gif/DragTextView;->bottomParentAfter:I
