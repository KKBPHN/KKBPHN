...
.method public onBoundsChange(Landroid/graphics/Rect;Z)V
    ...
    iget-object v1, p0, Lcom/android/camera/ui/SmoothDrawHelper;->mOutterPath:Landroid/graphics/Path;

    iget-object v2, p0, Lcom/android/camera/ui/SmoothDrawHelper;->mLayer:Landroid/graphics/RectF;

    iget-object v3, p0, Lcom/android/camera/ui/SmoothDrawHelper;->mRadii:[F

    iget v4, p0, Lcom/android/camera/ui/SmoothDrawHelper;->mRadius:F

    move-object v0, p0

    move v5, v6

    invoke-direct/range {v0 .. v6}, Lcom/android/camera/ui/SmoothDrawHelper;->getSmoothPathFromProvider(Landroid/graphics/Path;Landroid/graphics/RectF;[FFFF)Landroid/graphics/Path;
    ...
    :cond_2
    iget-object p1, p0, Lcom/android/camera/ui/SmoothDrawHelper;->mOutterPath:Landroid/graphics/Path;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/camera/ui/SmoothDrawHelper;->getNormalPath(Landroid/graphics/Path;Landroid/graphics/RectF;[FFFF)Landroid/graphics/Path;
