...
.method private applyEffect(Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;)[B
    ...
    invoke-static/range {v26 .. v32}, Lcom/android/camera/Util;->getWatermarkRange(IIIZZLjava/lang/String;Lcom/android/camera/effect/renders/DeviceWatermarkParam;)[I
    ...
    invoke-virtual/range {v29 .. v35}, Lcom/android/camera/effect/renders/PixelEffectRender;->drawTexture(IFFFFZ)V
...
.method private applyEffectForAIWatermark(Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;Z)[B
    ...
    invoke-direct/range {v22 .. v43}, Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;-><init>(Landroid/media/Image;Landroid/util/Size;Landroid/util/Size;IIIFJZZZLjava/lang/String;Ljava/lang/String;ZZLcom/android/camera/effect/renders/DeviceWatermarkParam;Lcom/android/camera/effect/EffectController$EffectRectAttribute;Ljava/util/List;Lcom/android/camera/aiwatermark/data/WatermarkItem;Lcom/android/camera/aiwatermark/data/WatermarkItem;)V
    ...
    invoke-virtual {v2}, Lcom/android/camera/aiwatermark/data/WatermarkItem;->isTextWatermark()Z

    move-result v4

    if-eqz v4, :cond_5

    invoke-virtual {v2}, Lcom/android/camera/aiwatermark/data/WatermarkItem;->getTextBitmap()Landroid/graphics/Bitmap;
    ...
    :cond_5
    invoke-virtual {v2}, Lcom/android/camera/aiwatermark/data/WatermarkItem;->getResId()I

    move-result v4

    invoke-static {v4}, Lcom/android/camera/Util;->convertResToBitmap(I)Landroid/graphics/Bitmap;
    ...
    const-string v7, "superMoonScale:"

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v4}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v4, " now scale:"
...
.method private blockSplitApplyEffect(Lcom/android/camera/effect/draw_mode/DrawYuvAttribute;)[B
    ...
    const-string v5, "[loop%d/%d]begin"
    ...
    invoke-virtual {v2, v0}, Lcom/android/camera/effect/framework/utils/CounterUtil;->reset(Ljava/lang/String;)V
    ...
    iget v2, v5, Lcom/android/camera/effect/framework/graphics/Block;->mWidth:I
    ...
    invoke-virtual/range {v29 .. v29}, Lcom/android/camera/effect/renders/PipeRender;->deleteBuffer()V
