...
.method public reverse(Z)Z
    ...
    :goto_0
    iget-object v6, p0, Lcom/android/camera/fragment/top/TopBarAnimationComponent;->mHidedViews:Ljava/util/List;
    ...
    :cond_7
    :goto_3
    invoke-direct {p0, v1, v7, v8}, Lcom/android/camera/fragment/top/TopBarAnimationComponent;->addTopBarItemInAnimator(ILandroid/view/View;Lcom/android/camera/data/data/config/TopConfigItem;)Landroid/animation/ObjectAnimator;
    ...
    :cond_8
    invoke-static {v7}, Lcom/android/camera/animation/type/AlphaInOnSubscribe;->directSetResult(Landroid/view/View;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/camera/fragment/top/O0000ooO;-><init>(Lcom/android/camera/fragment/top/TopBarAnimationComponent;)V
