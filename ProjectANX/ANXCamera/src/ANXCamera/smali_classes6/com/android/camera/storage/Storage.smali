...
.method public static addXmpData([BJ[FLjava/lang/String;)[B
    ...
    :try_start_4
    invoke-static {p1, v2}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    const-string p4, " built xmp data complete"
    ...
    :try_start_9
    invoke-static {v1, p3}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_9
    .catchall {:try_start_9 .. :try_end_9} :catchall_2

    :try_start_a
    invoke-static {v1, p2}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_a
    ...
    :try_start_c
    invoke-static {p1, p3}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    :try_start_e
    invoke-static {p1, p2}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    const-string p2, "build xmp bytes error"
...
.method public static getAvailableSpace(Ljava/lang/String;)J
    ...
    sget-object v4, Lcom/android/camera/storage/Storage;->HIDEDIRECTORY:Ljava/lang/String;
    ...
    invoke-static {v2, v3, p0}, Lcom/android/camera/log/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private static updateImage(Landroid/content/Context;[BZLcom/android/gallery3d/exif/ExifInterface;Landroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;Z)Landroid/net/Uri;
    ...
    :try_start_8
    invoke-static {v11, v9}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_8
    .catchall {:try_start_8 .. :try_end_8} :catchall_4
    ...
    :goto_8
    :try_start_9
    invoke-static {v11, v10}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_9
    ...
    :try_start_10
    invoke-virtual {v0, v5, v13, v15, v15}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    :try_start_11
    invoke-static {v13, v10}, Lcom/android/camera/storage/Storage;->extractDateTaken(Landroid/database/Cursor;Landroid/content/ContentValues;)V
    :try_end_11
    ...
    const-string v13, "renameTo failed, tmpPath = "
    ...
    :cond_17
    invoke-virtual {v10, v0}, Landroid/content/ContentValues;->putAll(Landroid/content/ContentValues;)V
    ...
    invoke-static {v1, v4, v12}, Lcom/android/camera/storage/Storage;->getMediaUri(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;

    move-result-object v5

    invoke-virtual {v0, v5, v10}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    const-string v7, "updateImage create new uri "
    ...
    const-string v7, "fail to rename "

    if-eqz v3, :cond_1a

    invoke-static {v9, v12}, Lcom/android/camera/storage/Storage;->renameSdcardFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v9}, Lcom/android/camera/storage/Storage;->deleteSdcardFile(Ljava/lang/String;)Z
    ...
    invoke-static {v3, v6}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :goto_17
    invoke-static {v9}, Lcom/android/camera/FileCompat;->removeDocumentFileForPath(Ljava/lang/String;)V
    ...
    :cond_1c
    invoke-static {v1, v12, v2, v3, v4}, Lcom/android/camera/storage/Storage;->saveToCloudAlbum(Landroid/content/Context;Ljava/lang/String;JZ)V
