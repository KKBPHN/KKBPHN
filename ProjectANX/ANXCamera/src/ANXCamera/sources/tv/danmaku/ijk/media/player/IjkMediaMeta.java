...
public class IjkMediaMeta {
    ...
    public final ArrayList mStreams = new ArrayList();
    ...
    public class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            ...
            if (j < 1000) {
                return String.format(Locale.US, "%d bit/s", new Object[]{Long.valueOf(j)});
            }
            return String.format(Locale.US, "%d kb/s", new Object[]{Long.valueOf(j / 1000)});
        }
        ...
        public String getChannelLayoutInline() {
            ...
            return String.format(Locale.US, "%x", new Object[]{Long.valueOf(j)});
        }
        ...
        public String getResolutionInline() {
            ...
            return String.format(Locale.US, "%d x %d [SAR %d:%d]", new Object[]{Integer.valueOf(i), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen)});
        }
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        String str = IJKM_KEY_BITRATE;
        ijkMediaMeta.mBitrate = ijkMediaMeta.getLong(str);
        String str2 = "video";
        int i = -1;
        int i2 = ijkMediaMeta.getInt(str2, -1);
        String str3 = "audio";
        int i3 = ijkMediaMeta.getInt(str3, -1);
        ...
        while (it.hasNext()) {
            ...
            if (bundle2 != null) {
                ...
                if (!TextUtils.isEmpty(ijkStreamMeta.mType)) {
                    ...
                    ijkStreamMeta.mBitrate = (long) ijkStreamMeta.getInt(str);
                    if (ijkStreamMeta.mType.equalsIgnoreCase(str2)) {
                    ...
                    } else if (ijkStreamMeta.mType.equalsIgnoreCase(str3)) {
    ...
    public String getDurationInline() {
        long j = (this.mDurationUS + 5000) / ExtraTextUtils.MB;
        long j2 = j / 60;
        long j3 = j % 60;
        long j4 = j2 / 60;
        long j5 = j2 % 60;
        return String.format(Locale.US, "%02d:%02d:%02d", new Object[]{Long.valueOf(j4), Long.valueOf(j5), Long.valueOf(j3)});
    }
