...
public final class MediaBrowserCompat {
    ...
    public class ConnectionCallback {
        ...
        @RequiresApi(21)
        class ConnectionCallbackApi21 extends android.media.browse.MediaBrowser.ConnectionCallback {
        ...
        public ConnectionCallback() {
            this.mConnectionCallbackFwk = VERSION.SDK_INT >= 21 ? new ConnectionCallbackApi21() : null;
        }
    ...
    public abstract class ItemCallback {
        ...
        @RequiresApi(23)
        class ItemCallbackApi23 extends android.media.browse.MediaBrowser.ItemCallback {
            ItemCallbackApi23() {
            }
        ...
        public ItemCallback() {
            this.mItemCallbackFwk = VERSION.SDK_INT >= 23 ? new ItemCallbackApi23() : null;
        }
    ...
    @RequiresApi(21)
    class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal {
    ...
    public class MediaItem implements Parcelable {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static List fromMediaItemList(List<Object> list) {
    ...
    public abstract class SubscriptionCallback {
        ...
        @RequiresApi(21)
        class SubscriptionCallbackApi21 extends android.media.browse.MediaBrowser.SubscriptionCallback {
        ...
        public SubscriptionCallback() {
            ...
            android.media.browse.MediaBrowser.SubscriptionCallback subscriptionCallback = i >= 26 ? new SubscriptionCallbackApi26() : i >= 21 ? new SubscriptionCallbackApi21() : null;
            this.mSubscriptionCallbackFwk = subscriptionCallback;
        }
