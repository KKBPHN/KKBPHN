...
public final class MediaMetadataCompat implements Parcelable {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            if (!MediaMetadataCompat.METADATA_KEYS_TYPE.containsKey(str) || ((Integer) MediaMetadataCompat.METADATA_KEYS_TYPE.get(str)).intValue() == 3) {
                if (VERSION.SDK_INT >= 19) {
                    bundle = this.mBundle;
                    r4 = (Parcelable) ratingCompat.getRating();
                } else {
                    bundle = this.mBundle;
                    r4 = ratingCompat;
                }
    ...
    static {
        ...
        ArrayMap arrayMap8 = METADATA_KEYS_TYPE;
        String str5 = METADATA_KEY_DISPLAY_ICON;
        arrayMap8.put(str5, valueOf3);
        ArrayMap arrayMap9 = METADATA_KEYS_TYPE;
    ...
    public Object getMediaMetadata() {
        if (this.mMetadataFwk == null && VERSION.SDK_INT >= 21) {
            Parcel obtain = Parcel.obtain();
