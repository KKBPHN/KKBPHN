...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public final class CustomAction implements Parcelable {
        ...
        public Object getCustomAction() {
            if (this.mCustomActionFwk != null || VERSION.SDK_INT < 21) {
                return this.mCustomActionFwk;
            }
            android.media.session.PlaybackState.CustomAction.Builder builder = new android.media.session.PlaybackState.CustomAction.Builder(this.mAction, this.mName, this.mIcon);
    ...
    public Object getPlaybackState() {
        if (this.mStateFwk == null && VERSION.SDK_INT >= 21) {
            ...
            for (CustomAction customAction : this.mCustomActions) {
                builder.addCustomAction((android.media.session.PlaybackState.CustomAction) customAction.getCustomAction());
            }
