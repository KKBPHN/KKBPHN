...
public class XMPMetaImpl implements XMPMeta, XMPConst {
    ...
    public XMPProperty getProperty(String str, String str2, int i) {
        ParameterAsserts.assertSchemaNS(str);
        ParameterAsserts.assertPropName(str2);
    ...
    /* access modifiers changed from: protected */
    public Object getPropertyObject(String str, String str2, int i) {
        ParameterAsserts.assertSchemaNS(str);
        ParameterAsserts.assertPropName(str2);
        XMPNode findNode = XMPNodeUtils.findNode(this.tree, XMPPathParser.expandXPath(str, str2), false, null);
        if (findNode == null) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:69:0x012d, code lost:
        if (r8.hasNext() == false) goto L_0x014e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:77:0x0147, code lost:
        if (r10.equals(r2) != false) goto L_0x014a;
     */
    ...
    public void setLocalizedText(String str, String str2, String str3, String str4, String str5, PropertyOptions propertyOptions) {
        XMPNode xMPNode;
        boolean z;
        ParameterAsserts.assertSchemaNS(str);
        ParameterAsserts.assertArrayName(str2);
