...
public class XMPNormalizer {
    ...
    private static void compareAliasedSubtrees(XMPNode xMPNode, XMPNode xMPNode2, boolean z) {
    ...
    private static void migrateAudioCopyright(XMPMeta xMPMeta, XMPNode xMPNode) {
        ...
        try {
            ...
            xMPMeta3.setLocalizedText(XMPConst.NS_DC, "rights", "", XMPConst.X_DEFAULT, sb4.toString(), null);
            xMPNode.getParent().removeChild(xMPNode);
        } catch (XMPException unused) {
        }
    }
    ...
    private static void transplantArrayItemAlias(Iterator it, XMPNode xMPNode, XMPNode xMPNode2) {
