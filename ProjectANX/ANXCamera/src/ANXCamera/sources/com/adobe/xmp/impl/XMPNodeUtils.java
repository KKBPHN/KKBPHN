...
public class XMPNodeUtils implements XMPConst {
    ...
    static void appendLangItem(XMPNode xMPNode, String str, String str2) {
    ...
    static Object[] chooseLocalizedText(XMPNode xMPNode, String str, String str2) {
    ...
    static XMPNode findChildNode(XMPNode xMPNode, String str, boolean z) {
    ...
    private static int findIndexedItem(XMPNode xMPNode, String str, boolean z) {
        try {
    ...
    static XMPNode findNode(XMPNode xMPNode, XMPPath xMPPath, boolean z, PropertyOptions propertyOptions) {
        XMPNode xMPNode2;
    ...
    private static XMPNode findQualifierNode(XMPNode xMPNode, String str, boolean z) {
    ...
    static XMPNode findSchemaNode(XMPNode xMPNode, String str, String str2, boolean z) {
        XMPNode findChildByName = xMPNode.findChildByName(str);
        if (findChildByName == null && z) {
    ...
    static XMPNode findSchemaNode(XMPNode xMPNode, String str, boolean z) {
        return findSchemaNode(xMPNode, str, null, z);
    }

    private static XMPNode followXPathStep(XMPNode xMPNode, XMPPathSegment xMPPathSegment, boolean z) {
        int i;
    ...
    private static int lookupFieldSelector(XMPNode xMPNode, String str, String str2) {
        int i = -1;
        int i2 = 1;
    ...
    static int lookupLanguageItem(XMPNode xMPNode, String str) {
        if (xMPNode.getOptions().isArray()) {
    ...
    private static int lookupQualSelector(XMPNode xMPNode, String str, String str2, int i) {
