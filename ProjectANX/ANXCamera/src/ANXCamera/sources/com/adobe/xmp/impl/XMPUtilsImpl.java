...
public class XMPUtilsImpl implements XMPConst {
    ...
    private static void appendSubtree(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, XMPNode xMPNode2, boolean z, boolean z2) {
    ...
    private static char checkQuotes(String str, char c) {
        char c2;
    ...
    private static boolean itemValuesMatch(XMPNode xMPNode, XMPNode xMPNode2) {
        boolean z;
        PropertyOptions options = xMPNode.getOptions();
