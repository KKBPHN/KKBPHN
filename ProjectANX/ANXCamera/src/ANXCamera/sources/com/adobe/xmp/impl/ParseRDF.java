...
public class ParseRDF implements XMPError, XMPConst {
    ...
    private static void rdf_EmptyPropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
        boolean z2;
        int i;
        String nodeName;
        String nodeValue;
                    ...
                    if (z3 || z4) {
                        ...
                        for (i = 0; i < node.getAttributes().getLength(); i++) {
                            ...
                            if (item2 != node2 && !str3.equals(item2.getPrefix()) && (item2.getPrefix() != null || !str3.equals(item2.getNodeName()))) {
                                ...
                                addQualifierNode(addChildNode, nodeName, nodeValue);
                            }
                        }
                        return;
                    }
    ...
    private static void rdf_NodeElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
    ...
    private static void rdf_NodeElementAttrs(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
        int i = 0;
        for (int i2 = 0; i2 < node.getAttributes().getLength(); i2++) {
            Node item = node.getAttributes().item(i2);
            String str = "xmlns";
    ...
    private static void rdf_ParseTypeResourcePropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
    ...
    private static void rdf_PropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
    ...
    private static void rdf_PropertyElementList(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
        for (int i = 0; i < node.getChildNodes().getLength(); i++) {
            Node item = node.getChildNodes().item(i);
            if (!isWhitespaceNode(item)) {
    ...
    private static void rdf_ResourcePropertyElement(XMPMetaImpl xMPMetaImpl, XMPNode xMPNode, Node node, boolean z) {
                ...
                for (int i2 = 0; i2 < node.getChildNodes().getLength(); i2++) {
                    ...
                    if (!isWhitespaceNode(item2)) {
                        if (item2.getNodeType() == 1 && !z2) {
                            ...
                            xMPException = new XMPException("Invalid child of resource property element", 202);
                            throw xMPException;
                        } else {
