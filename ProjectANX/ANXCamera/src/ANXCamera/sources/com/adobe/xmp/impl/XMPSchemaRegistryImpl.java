...
public final class XMPSchemaRegistryImpl implements XMPSchemaRegistry, XMPConst {
    ...
    private void registerStandardAliases() {
        ...
        registerAlias(XMPConst.NS_XMP, "Format", XMPConst.NS_DC, IjkMediaMeta.IJKM_KEY_FORMAT, null);
        ...
        registerAlias(XMPConst.NS_PHOTOSHOP, ExifInterface.TAG_COPYRIGHT, XMPConst.NS_DC, "rights", aliasOptions);
