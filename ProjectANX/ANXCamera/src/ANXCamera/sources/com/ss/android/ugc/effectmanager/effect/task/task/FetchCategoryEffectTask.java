...
public class FetchCategoryEffectTask extends NormalTask {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void execute() {
        FetchCategoryEffectTaskResult fetchCategoryEffectTaskResult;
            ...
            if (i != 0) {
                try {
                    if (isCanceled()) {
                        ...
                        fetchCategoryEffectTaskResult = new FetchCategoryEffectTaskResult(null, exceptionResult);
                        break;
                    }
                    ...
                    if (categoryEffectListResponse.checkValue()) {
                        ...
                        fetchCategoryEffectTaskResult = new FetchCategoryEffectTaskResult(null, exceptionResult2);
                        break;
                    }
                } catch (Exception e) {
                    if (this.mCurCnt == 0 || (e instanceof StatusCodeException)) {
                        sendMessage(21, new FetchCategoryEffectTaskResult(null, new ExceptionResult(e)));
                    }
                }
            } else {
                return;
