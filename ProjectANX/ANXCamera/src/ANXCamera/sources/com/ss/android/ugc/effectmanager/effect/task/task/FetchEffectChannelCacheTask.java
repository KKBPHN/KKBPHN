...
public class FetchEffectChannelCacheTask extends NormalTask {
    ...
    private List getCategoryAllEffects(EffectCategoryModel effectCategoryModel, EffectChannelModel effectChannelModel) {
        ArrayList arrayList = new ArrayList();
    ...
    public void execute() {
        ...
        if (queryToStream == null) {
            effectChannelTaskResult = new EffectChannelTaskResult(new EffectChannelResponse(this.panel), new ExceptionResult(10004));
        } else {
        ...
        sendMessage(14, effectChannelTaskResult);
    }
}
