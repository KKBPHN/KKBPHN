...
public class VESDK {
    ...
    public static boolean needUpdateEffectModelFiles() {
    ...
    public static void setEffectModelsPath(@NonNull String str) {
    ...
    public static void setLogLevel(byte b) {
        ...
        VideoSdkCore.setLogLevel(LogUtil.getAndroidLogLevel(b));
    }
    ...
    public static void updateEffectModelFiles() {
