...
public class TESharedContext {
    ...
    private static final String LOG_TAG = "TESharedContext";
    ...
    private boolean initEGL(EGLContext eGLContext, int i, int i2, int i3, Object obj) {
        ...
        int[] iArr2 = {12352, 4, 12324, mBitsR, 12323, mBitsG, 12322, mBitsB, 12321, mBitsA, 12339, i4, 12344};
        if (i4 == 12610) {
                ...
                if (!EGL14.eglChooseConfig(this.mDisplay, iArr2, 0, eGLConfigArr, 0, eGLConfigArr.length, iArr8, 0)) {
                    ...
                    if (this.mContext == EGL14.EGL_NO_CONTEXT) {
                        ...
                        if (i4 != 2) {
                            ...
                            eglCreatePixmapSurface = EGL14.eglCreateWindowSurface(this.mDisplay, this.mConfig, obj, iArr7, 0);
                        } else {
    ...
    public boolean updateSurface(int i, int i2, int i3, Object obj) {
        ...
        if (i3 != 2) {
            if (i3 != 4) {
                if (i3 != 12610) {
                    eglCreatePixmapSurface = EGL14.eglCreatePbufferSurface(this.mDisplay, this.mConfig, iArr, 0);
                } else {
                    iArr[0] = 12344;
                    iArr[2] = 12344;
                }
            ...
            eglCreatePixmapSurface = EGL14.eglCreatePixmapSurface(this.mDisplay, this.mConfig, 0, iArr, 0);
        }
        this.mSurface = eglCreatePixmapSurface;
        if (this.mSurface != EGL14.EGL_NO_SURFACE) {
            return makeCurrent();
