...
public class DownloadEffectTask extends NormalTask {
    ...
    private int mCurCnt;
    private List mDownLoadUrl = EffectUtils.getUrl(this.mEffect.getFileUrl());
    ...
    public void execute() {
        ...
        fetchEffect.setListener(new SyncTaskListener() {
            ...
            public void onResponse(SyncTask syncTask, EffectTaskResult effectTaskResult) {
