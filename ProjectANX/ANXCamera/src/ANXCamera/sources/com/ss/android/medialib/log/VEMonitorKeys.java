...
public class VEMonitorKeys {
    ...
    private static Set sDoubleKeys = new ArraySet();
    private static Set sIntKeys = new ArraySet();
    private static Set sStringKeys = new ArraySet();
    ...
    public static int getType(String str) {
        return sIntKeys.contains(str) ? TYPE_INT : sDoubleKeys.contains(str) ? TYPE_DOUBLE : TYPE_STRING;
    }
}
