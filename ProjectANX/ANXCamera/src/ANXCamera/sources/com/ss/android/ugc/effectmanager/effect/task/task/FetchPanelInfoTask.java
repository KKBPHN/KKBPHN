            ...
            if (i != 0) {
                try {
                    if (isCanceled()) {
                        ...
                        fetchPanelInfoTaskResult = new FetchPanelInfoTaskResult(null, exceptionResult);
                        break;
                    }
                    ...
                    if (panelInfoResponse.checkValue()) {
                        ...
                        fetchPanelInfoTaskResult = new FetchPanelInfoTaskResult(null, exceptionResult2);
                        break;
                    }
                } catch (Exception e) {
                    if (this.mCurCnt == 0 || (e instanceof StatusCodeException)) {
                        sendMessage(22, new FetchPanelInfoTaskResult(null, new ExceptionResult(e)));
                    }
                }
            } else {
                return;
