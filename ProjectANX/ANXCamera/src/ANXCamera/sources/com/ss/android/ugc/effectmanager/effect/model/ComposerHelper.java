...
public class ComposerHelper {
    ...
    private static List serverURLs = new ArrayList();
    ...
    @NonNull
    public static List getServerUrls() {
        return serverURLs;
    }
    ...
    public static void setServerUrls(@NonNull List list) {
        serverURLs = list;
    }
    ...
    public static int versionCompare(@NonNull String str, @NonNull String str2) {
        ...
        int length = (i >= split.length || i >= split2.length) ? split.length - split2.length : Integer.valueOf(split[i]).compareTo(Integer.valueOf(split2[i]));
