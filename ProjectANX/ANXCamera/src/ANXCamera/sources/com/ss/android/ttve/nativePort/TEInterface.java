...
public final class TEInterface extends TENativeServiceBase {
    ...
    private native void nativeSetWaterMark(long j, ArrayList arrayList, int i, int i2, int i3, int i4, int i5, long j2, int i6, VEWatermarkMask vEWatermarkMask);
    ...
    public int addExternalTrack(String[] strArr, String[] strArr2, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, double d, double d2, double d3, double d4, int i) {
        ...
        return nativeAddExternalTrack(j, strArr, strArr4, iArr5, iArr8, iArr6, iArr7, d5, d6, d7, d8, 5, i2);
    }
    ...
    public int processLongPressEvent(float f, float f2) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeProcessLongPressEvent(j, f, f2);
    }

    public int processPanEvent(float f, float f2, float f3, float f4, float f5) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeProcessPanEvent(j, f, f2, f3, f4, f5);
    }

    public int processRotationEvent(float f, float f2) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeProcessRotationEvent(j, f, f2);
    }

    public int processScaleEvent(float f, float f2) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeProcessScaleEvent(j, f, f2);
    }
    ...
    public int processTouchMoveEvent(float f, float f2) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeProcessTouchMoveEvent(j, f, f2);
    }
    ...
    public int set2DBrushCanvasAlpha(float f) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeSet2DBrushCanvasColor(j, f);
    }

    public int set2DBrushColor(float f, float f2, float f3, float f4) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeSet2DBrushColor(j, f, f2, f3, f4);
    }

    public int set2DBrushSize(float f) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeSet2DBrushSize(j, f);
    }
    ...
    public void setDisplayState(float f, float f2, float f3, float f4, int i, int i2, boolean z) {
        long j = this.mNative;
        if (j != 0) {
            nativeSetDisplayState(j, f, f2, f3, f4, i, i2, z ? 1 : 0);
        }
    }
    ...
    public void setWaterMark(ArrayList arrayList, int i, int i2, int i3, int i4, int i5, long j, VEWaterMarkPosition vEWaterMarkPosition, VEWatermarkMask vEWatermarkMask) {
        long j2 = this.mNative;
        if (j2 != 0) {
