...
public class EffectStore {
    ...
    private final List mCurDownloadingEffects = new ArrayList();
    ...
    public List getCurrentDownloadingEffectList() {
    ...
    public void updateEffectListDownloadStatus(String str, List list, ExceptionResult exceptionResult) {
        synchronized (this.mCurDownloadingEffects) {
