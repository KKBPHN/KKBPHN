...
class MiCamAlgoInterfaceJNI {
    ...
    static native long createSessionByOutputConfigurations(BufferFormat bufferFormat, List list, @NonNull SessionStatusCallback sessionStatusCallback);

    static native long createSessionWithSurfaces(BufferFormat bufferFormat, List list, @NonNull SessionStatusCallback sessionStatusCallback);
    ...
    static native int processFrameWithSync(long j, @NonNull List list, @NonNull Image image, int i);
}
