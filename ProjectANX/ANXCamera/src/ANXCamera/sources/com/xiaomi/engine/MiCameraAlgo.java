...
public final class MiCameraAlgo {
    ...
    public static TaskSession createSessionByOutputConfigurations(@NonNull BufferFormat bufferFormat, @NonNull List list, SessionStatusCallback sessionStatusCallback) {
    ...
    public static TaskSession createSessionWithSurfaces(@NonNull BufferFormat bufferFormat, @NonNull List list, SessionStatusCallback sessionStatusCallback) {
