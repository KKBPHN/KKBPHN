...
public final class GraphDescriptorBean implements Parcelable {
    ...
    public String toString() {
        return String.format(Locale.ENGLISH, "GraphDescriptorBean{ mOperationModeID=%s , mStreamNumber=%s, mIsSnapshot=%s, mCameraCombinationMode=0x%x }", new Object[]{Integer.valueOf(this.mOperationModeID), Integer.valueOf(this.mStreamNumber), Boolean.valueOf(this.mIsSnapshot), Integer.valueOf(this.mCameraCombinationMode)});
    }
