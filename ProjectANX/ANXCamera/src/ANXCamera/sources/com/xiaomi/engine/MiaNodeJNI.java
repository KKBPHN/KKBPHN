...
public class MiaNodeJNI {
    ...
    private static native int processRequest(@NonNull List list, @NonNull Image image, int i, boolean z);
    ...
    public int process(@NonNull List list, @NonNull Image image, int i, boolean z) {
        int processRequest;
        synchronized (this.mObjLock) {
            if (!sInitialized) {
                initialize(i);
