...
public class MediaEffectCamera {
    ...
    private static native void EnableFilmPictureJni(long j, boolean z);
    ...
    private static native boolean SetEncoderTypeJni(String str);
    ...
    public void EnableFilmPicture(boolean z) {
        String str = TAG;
        StringBuilder sb = new StringBuilder();
        sb.append("enablefilmpicture MediaFilterCamera: ");
        sb.append(z);
        Log.d(str, sb.toString());
        EnableFilmPictureJni(this.mMediaFilterCamera, z);
    }
    ...
    public void StartRecording(String str, String str2, String str3, String str4) {
        ...
        sb.append(str);
        Log.d(str5, sb.toString());
        StartRecordingJni(this.mMediaFilterCamera, 0, str, str2, str3, str4, 0, 1.0f, FunctionParseBeautyBodySlimCount.TIP_INTERVAL_TIME);
    }

    public void StartRecording(String str, String str2, String str3, String str4, long j, float f, long j2) {
        String str5 = TAG;
        StringBuilder sb = new StringBuilder();
        sb.append("Start MediaFilterCamera: ");
        sb.append(this.mMediaFilterCamera);
        ...
        sb.append(j3);
        Log.d(str5, sb.toString());
        StartRecordingJni(this.mMediaFilterCamera, 0, str, str2, str3, str4, j, f, j3);
    }
