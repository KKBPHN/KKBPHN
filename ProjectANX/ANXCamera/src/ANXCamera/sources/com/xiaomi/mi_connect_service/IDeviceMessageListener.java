...
public interface IDeviceMessageListener extends IInterface {
    ...
    public abstract class Stub extends Binder implements IDeviceMessageListener {
        private static final String DESCRIPTOR = "com.xiaomi.mi_connect_service.IDeviceMessageListener";
        static final int TRANSACTION_onMessage = 1;

        class Proxy implements IDeviceMessageListener {
        ...
        public static IDeviceMessageListener asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IDeviceMessageListener)) ? new Proxy(iBinder) : (IDeviceMessageListener) queryLocalInterface;
        }
