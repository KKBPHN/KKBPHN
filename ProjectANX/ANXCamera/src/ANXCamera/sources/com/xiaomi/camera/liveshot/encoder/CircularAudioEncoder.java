...
public class CircularAudioEncoder extends CircularMediaEncoder {
    ...
    public CircularAudioEncoder(MediaFormat mediaFormat, long j, long j2, Queue queue) {
        ...
        if (this.mAudioRecord.getRecordingState() != 0) {
            ...
            try {
                ...
                Log.d(TAG, "HW AAC encoder not found fallback to default instead", (Throwable) e);
            }
            if (!z) {
                try {
