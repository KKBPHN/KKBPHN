...
public class PictureInfo {
    ...
    public byte[] getXpCommentBytes() {
        ...
        sb2.append("　sensor_type:");
        sb2.append(this.mLensType);
        String str = " ";
        sb2.append(str);
        sb.append(sb2.toString());
        StringBuilder sb3 = new StringBuilder();
        sb3.append("exposureValue:");
        sb3.append(this.mEvValue);
        sb3.append(str);
        sb.append(sb3.toString());
        StringBuilder sb4 = new StringBuilder();
        sb4.append("SceneShotburst:");
        sb4.append(this.mIsShotBurst);
        sb4.append(str);
        sb.append(sb4.toString());
        StringBuilder sb5 = new StringBuilder();
        sb5.append("LensApertues:");
        sb5.append(this.mLensApertues);
        sb5.append(str);
        sb.append(sb5.toString());
        StringBuilder sb6 = new StringBuilder();
        sb6.append("LensFocal:");
        sb6.append(this.mLensfocal);
        sb6.append(str);
        sb.append(sb6.toString());
        StringBuilder sb7 = new StringBuilder();
        sb7.append("SceneProfession:");
        sb7.append(this.mIsProfession);
        sb7.append(str);
        sb.append(sb7.toString());
        StringBuilder sb8 = new StringBuilder();
        sb8.append("ScenePanorama:");
        sb8.append(isPanorama());
        sb8.append(str);
        sb.append(sb8.toString());
        StringBuilder sb9 = new StringBuilder();
        sb9.append("ZoomMultiple:");
        sb9.append(this.mZoomMulti);
        sb9.append(str);
        sb.append(sb9.toString());
        StringBuilder sb10 = new StringBuilder();
        sb10.append("afRoi:");
        sb10.append(this.mAfRoi);
        sb10.append(str);
        sb.append(sb10.toString());
        StringBuilder sb11 = new StringBuilder();
        sb11.append("FaceRoi:");
        sb11.append(this.mfaceInfo);
        sb11.append(str);
        sb.append(sb11.toString());
        StringBuilder sb12 = new StringBuilder();
        sb12.append("FilterId:");
        sb12.append(this.mFilterId);
        sb12.append(str);
        sb.append(sb12.toString());
        StringBuilder sb13 = new StringBuilder();
        sb13.append("AIScene:");
        sb13.append(getAiType());
        sb13.append(str);
        sb.append(sb13.toString());
        StringBuilder sb14 = new StringBuilder();
        sb14.append("preview_super_night_exif:");
        sb14.append(getPreviewSuperNightExif());
        sb14.append(str);
        sb.append(sb14.toString());
        String str2 = this.mCaptureResultInfo;
        if (str2 != null) {
            sb.append(str2);
        }
        String str3 = this.mAlgoExif;
        if (str3 != null) {
            sb.append(str3);
        }
        ...
        try {
            bArr2 = RsaUtil.encryptByPublicKey(sb.toString().getBytes("UTF-16LE"));
            return bArr2;
    ...
    public String setAfRoi(int i, int i2, int i3) {
        ...
        if (i5 < 90) {
            ...
            sb.append(str5);
            sb.append(this.mXStart);
            sb.append(str4);
            i4 = this.mYStart;
        } else if (i5 < 180) {
            sb = new StringBuilder();
            sb.append(str5);
            sb.append(i3 - this.mYStart);
            sb.append(str4);
            i4 = this.mXStart;
        } else if (i5 < 270) {
            sb = new StringBuilder();
            sb.append(str5);
            sb.append(i2 - this.mXStart);
            sb.append(str4);
            sb.append(i3 - this.mYStart);
            sb.append(str3);
            sb.append(this.mAfMrRoi.getWidth());
            sb.append(str2);
            sb.append(this.mAfMrRoi.getHeight());
            sb.append(str);
            this.mAfRoi = sb.toString();
            return this.mAfRoi;
        } else {
            sb = new StringBuilder();
            sb.append(str5);
            sb.append(this.mYStart);
            sb.append(str4);
            i4 = i2 - this.mXStart;
        }
        sb.append(i4);
    ...
    public PictureInfo setZoomMulti(float f) {
        this.mZoomMulti = f;
        try {
            this.mInfo.put(ZOOM_MULTIPLE, (double) this.mZoomMulti);
        } catch (JSONException e) {
