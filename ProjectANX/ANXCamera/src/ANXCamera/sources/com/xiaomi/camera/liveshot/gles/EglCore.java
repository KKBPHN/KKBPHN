...
public final class EglCore {
    ...
    private void checkEglSurface(@NonNull EGLSurface eGLSurface) {
        if (eGLSurface == EGL14.EGL_NO_SURFACE || EGL14.eglGetError() != 12288) {
    ...
    public EGLSurface createOffscreenSurface(@IntRange(from = 0) int i, @IntRange(from = 0) int i2) {
        ...
        checkEglSurface(eglCreatePbufferSurface);
        String str = TAG;
        StringBuilder sb = new StringBuilder();
        sb.append("createOffscreenSurface ");
        sb.append(this.mEGLDisplay.getNativeHandle());
        Log.d(str, sb.toString());
