...
public class MiImage {
    ...
    private void fromImage(Image image) {
        ...
        int i2 = 0;
        while (i2 < planeArr.length) {
            int rowStride = planeArr2[i2].getRowStride();
            int rowStride2 = planeArr[i2].getRowStride();
            ByteBuffer buffer = planeArr2[i2].getBuffer();
            ByteBuffer buffer2 = planeArr[i2].getBuffer();
            if (planeArr2[i2].getPixelStride() == planeArr[i2].getPixelStride()) {
                ...
                if (rowStride == rowStride2) {
                    ...
                    int width = effectivePlaneSizeForImage.getWidth() * planeArr2[i2].getPixelStride();
                ...
                sb.append(planeArr7[i2].getPixelStride());
                sb.append(" must be same as destination image pixel stride ");
                sb.append(planeArr8[i2].getPixelStride());
