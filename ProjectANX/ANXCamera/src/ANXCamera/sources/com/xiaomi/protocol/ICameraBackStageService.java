...
public interface ICameraBackStageService extends IInterface {
    ...
    public abstract class Stub extends Binder implements ICameraBackStageService {
        ...
        class Proxy implements ICameraBackStageService {
            ...
            public List configCaptureOutputBuffer(List list) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void onCaptureCompleted(List list, String str) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
    ...
    void addCapturePath(String str);

    List configCaptureOutputBuffer(List list);

    void configCaptureSession(BufferFormat bufferFormat);

    boolean needWaitProcess();

    void onCaptureCompleted(List list, String str);

    void onCaptureFailed(String str, int i);
}
