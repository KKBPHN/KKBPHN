package com.arcsoft.avatar2.provider;

import android.content.UriMatcher;
import android.net.Uri;

public class AvatarProfile {
    public static final String AUTHORITY = "com.arcsoft.content.provider.avatar2.content.provider";
    public static final Uri AVATAR_URI = Uri.parse("content://com.arcsoft.content.provider.avatar2.content.provider/avatar_db");
    ...
    protected static final String a = "content://com.arcsoft.content.provider.avatar2.content.provider/";
    public static final UriMatcher sUriMatcher = new UriMatcher(-1);

    static {
        sUriMatcher.addURI(AUTHORITY, "avatar_db", 1);
    }
}
