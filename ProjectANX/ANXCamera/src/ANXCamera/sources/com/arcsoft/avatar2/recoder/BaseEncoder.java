...
public abstract class BaseEncoder {
    ...
    public void drain() {
        ...
        while (true) {
            ...
            if (-1 == dequeueOutputBuffer) {
                ...
                if (bufferInfo.size != 0) {
                    ...
                    CodecLog.d(u, sb7.toString());
                    bufferInfo.presentationTimeUs = a();
                    StringBuilder sb8 = new StringBuilder();
                    sb8.append("time_diff _");
                    sb8.append(name);
                    sb8.append("= ");
                    sb8.append(bufferInfo.presentationTimeUs - this.z);
                    CodecLog.d(u, sb8.toString());
        ...
        CodecLog.d(u, sb10.toString());
    }

    /* JADX WARNING: Code restructure failed: missing block: B:17:0x005d, code lost:
        com.arcsoft.avatar2.util.CodecLog.d(r1, r12);
     */
