...
public class WideSelfieEngine {
    ...
    private static final String a = "com.arcsoft.camera.wideselfie.WideSelfieEngine";
    private static WideSelfieEngine b;
