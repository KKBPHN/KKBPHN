...
public class MuxerWrapper {
    ...
    public MuxerWrapper(@Nullable FileDescriptor fileDescriptor, int i2, RecordingListener recordingListener) {
        ...
        try {
            ...
            if (recordingListener2 != null) {
                recordingListener2.onRecordingListener(609, Integer.valueOf(0));
            }
        }
    }
    ...
    public synchronized int addTrack(@NonNull MediaFormat mediaFormat) {
        ...
        try {
            ...
            if (this.k != null) {
                this.k.onRecordingListener(610, Integer.valueOf(i2));
            }
            e2.printStackTrace();
        }
        return i2;
    ...
    public synchronized void startMuxer() {
        ...
        if (this.c == this.b) {
            try {
                ...
                if (this.k != null) {
                    this.k.onRecordingListener(611, Integer.valueOf(0));
                }
                e2.printStackTrace();
            }
            this.d = true;
        ...
        if (this.e != null) {
            ...
            if (this.c == 0) {
                try {
                    ...
                    if (this.k != null) {
                        this.k.onRecordingListener(613, Integer.valueOf(0));
                    }
                }
                try {
                    this.e.release();
                    ...
                    if (this.k != null) {
                        this.k.onRecordingListener(614, Integer.valueOf(0));
                    }
                }
                this.e = null;
    ...
    public synchronized void writeSampleData(int i2, @NonNull ByteBuffer byteBuffer, @NonNull BufferInfo bufferInfo) {
        ...
        try {
            ...
            e2.printStackTrace();
            if (this.k != null) {
                this.k.onRecordingListener(612, Integer.valueOf(0));
            }
        }
    }
}
