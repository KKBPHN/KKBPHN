...
import com.arcsoft.avatar.AvatarConfig.ASAvatarTongueAnimationParam;
...
public class AvatarEngine implements AvatarConfig {
    ...
    private int a(String str) {
        return nativeSetHeadWearGrayTexture(this.e, str);
    }
    ...
    public int avatarProcessWithInfoEx(ASVLOFFSCREEN asvloffscreen, int i, boolean z, int i2, ASAvatarProcessInfo aSAvatarProcessInfo, boolean z2) {
        return nativeProcessWithInfoToEdit(this.e, asvloffscreen, i, z, i2, aSAvatarProcessInfo, z2);
    }
    ...
    public boolean nativeProcessWithInfoToPreview(ASVLOFFSCREEN asvloffscreen, int i, boolean z, int i2, ASAvatarProcessInfo aSAvatarProcessInfo, boolean z2) {
        return nativeProcessWithInfoToPreview(this.e, asvloffscreen, i, z, i2, aSAvatarProcessInfo, z2);
    }
    ...
    public int readRGBA(String str, int i, int i2, byte[] bArr) {
        return nativeReadRGBA(this.e, str, i, i2, bArr);
    }
    ...
    public synchronized int renderThumb(int i, int i2, int i3, int i4, byte[] bArr, int i5, int i6, int i7, float[] fArr, float f2) {
        ...
        synchronized (this) {
            ...
            nativeRenderThumb = nativeRenderThumb(this.e, i, i2, i3, i4, bArr, i5, i6, i7, fArr, f2);
    ...
    public int renderWithBackground(String str, ASVLOFFSCREEN asvloffscreen, int i, boolean z, int i2, int i3, int i4, int i5, boolean z2, int[] iArr, byte[] bArr) {
        return nativeRenderWithBackground(this.e, str, asvloffscreen, i, z, i2, i3, i4, i5, z2, iArr, bArr);
    }
    ...
    public int setHairRenderParam(boolean z, boolean z2) {
        return nativeSetHairRenderParam(this.e, z, z2);
    }
    ...
    public int setTongueAnimationParam(ASAvatarTongueAnimationParam aSAvatarTongueAnimationParam) {
        return nativeSetTongueAnimationParam(this.e, aSAvatarTongueAnimationParam);
    }

    public int setToothTexture(String str) {
        return nativeSetToothTexture(this.e, str);
    }
