...
public class ColorLookupFilter extends BaseOriginalFilter {
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                colorLookupFilter.mLookupSourceTexture = OpenGlUtils.loadTexture(BeautificationSDK.sContext, colorLookupFilter.mColorLookupTableName);
            }
        });
    }
    ...
    public String toString() {
        ...
        sb.append("ColorLookupFilter(");
        sb.append(this.mColorLookupTableSize);
        sb.append("x");
        sb.append(this.mColorLookupTableSize);
        sb.append(", ");
        sb.append(this.mColorLookupTableName);
        sb.append(")");
        return sb.toString();
    }
}
