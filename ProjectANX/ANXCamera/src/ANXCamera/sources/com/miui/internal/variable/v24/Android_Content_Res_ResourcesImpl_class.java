...
public class Android_Content_Res_ResourcesImpl_class extends com.miui.internal.variable.Android_Content_Res_ResourcesImpl_class {
    ...
    /* access modifiers changed from: protected */
    public Drawable handleLoadDrawable(long j, ResourcesImpl resourcesImpl, Resources resources, TypedValue typedValue, int i, Theme theme, boolean z) {
    ...
    /* access modifiers changed from: protected */
    public Drawable originalLoadDrawable(long j, ResourcesImpl resourcesImpl, Resources resources, TypedValue typedValue, int i, Theme theme, boolean z) {
