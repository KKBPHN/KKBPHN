...
public class ViewDragHelper {
    ...
    private boolean checkTouchSlop(View view, float f, float f2) {
        ...
        if (z3 && z4) {
            ...
            if (z4 && Math.abs(f) < ((float) this.mTouchSlop) && Math.abs(f2) > ((float) this.mTouchSlop)) {
                z = true;
            }
            return z;
        }
    ...
    public boolean checkTouchSlop(int i, int i2) {
        ...
        if (z3 && z4) {
            ...
            if (z4 && Math.abs(f2) > ((float) this.mTouchSlop)) {
                z = true;
            }
            return z;
        }
                    ...
                    if (this.mDragState != 1) {
                        ...
                        while (i2 < pointerCount) {
                            ...
                            if (isValidPointerForActionMove(pointerId)) {
                                ...
                                float f = x - this.mInitialMotionX[pointerId];
                                float f2 = y - this.mInitialMotionY[pointerId];
                                reportNewEdgeDrags(f, f2, pointerId);
                                if (this.mDragState != 1) {
                                    View findTopChildUnder = findTopChildUnder((int) x, (int) y);
                                    if (checkTouchSlop(findTopChildUnder, f, f2) && tryCaptureViewForDrag(findTopChildUnder, pointerId)) {
                                        break;
                                    }
                                } else {
                                    break;
                ...
                if (actionMasked == 2) {
                    ...
                    for (int i = 0; i < pointerCount; i++) {
                        ...
                        if (isValidPointerForActionMove(pointerId)) {
                            ...
                            if (this.mDragState != 1) {
                                View findTopChildUnder = findTopChildUnder((int) x, (int) y);
                                if (findTopChildUnder != null && checkTouchSlop(findTopChildUnder, f, f2) && tryCaptureViewForDrag(findTopChildUnder, pointerId)) {
                                    break;
                                }
                            } else {
                                break;
                    ...
                    if (actionMasked == 5) {
                        ...
                        if (i2 == 0) {
                            ...
                            if ((i3 & i4) != 0) {
                                this.mCallback.onEdgeTouched(i3 & i4, pointerId2);
                            }
                        } else if (i2 == 2) {
                            View findTopChildUnder2 = findTopChildUnder((int) x2, (int) y2);
                            if (findTopChildUnder2 == this.mCapturedView) {
                                tryCaptureViewForDrag(findTopChildUnder2, pointerId2);
                            }
                        }
                    } else if (actionMasked == 6) {
