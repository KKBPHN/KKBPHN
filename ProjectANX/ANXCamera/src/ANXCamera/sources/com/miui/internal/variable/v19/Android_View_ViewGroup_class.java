...
public class Android_View_ViewGroup_class extends com.miui.internal.variable.v16.Android_View_ViewGroup_class {
    ...
    static {
        String str = "I";
        R_styleable_ViewGroup_layoutMode = Field.of(com.miui.internal.variable.v16.Android_View_ViewGroup_class.com_android_internal_R_styleable, "ViewGroup_layoutMode", str).getInt(null);
        LAYOUT_MODE_UNDEFINED = Field.of(ViewGroup.class, "LAYOUT_MODE_UNDEFINED", str).getInt(null);
    }
