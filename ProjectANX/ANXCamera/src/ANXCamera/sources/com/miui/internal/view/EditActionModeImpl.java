...
public class EditActionModeImpl extends ActionModeImpl implements EditActionMode {
    ...
    public void setButton(int i, int i2) {
        setButton(i, (CharSequence) this.mContext.getResources().getString(i2));
    }

    public void setButton(int i, int i2, int i3) {
        setButton(i, (CharSequence) this.mContext.getResources().getString(i2), i3);
    }
    ...
    public void setTitle(int i) {
        setTitle((CharSequence) this.mContext.getResources().getString(i));
    }
