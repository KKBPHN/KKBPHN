...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPreserveIconSpacing = obtainStyledAttributes.getBoolean(com.miui.internal.R.styleable.MenuView_preserveIconSpacing, false);
    ...
    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(com.miui.internal.R.layout.list_menu_item_checkbox, this, false);
        addView(this.mCheckBox);
    }

    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(com.miui.internal.R.layout.list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(com.miui.internal.R.layout.list_menu_item_radio, this, false);
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(com.miui.internal.R.id.title);
        int i = this.mTextAppearance;
        if (i != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = (TextView) findViewById(com.miui.internal.R.id.shortcut);
    ...
    public void setCheckable(boolean z) {
        ...
        if (z || this.mRadioButton != null || this.mCheckBox != null) {
            ...
            MarginLayoutParams marginLayoutParams = (MarginLayoutParams) this.mRelativeLayout.getLayoutParams();
