...
public class NotificationTarget extends CustomTarget {
    ...
    public NotificationTarget(Context context2, int i, int i2, int i3, RemoteViews remoteViews2, Notification notification2, int i4, String str) {
        ...
        Preconditions.checkNotNull(notification2, "Notification object can not be null!");
        this.notification = notification2;
        Preconditions.checkNotNull(remoteViews2, "RemoteViews object can not be null!");
