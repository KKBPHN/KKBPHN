...
class DataCacheGenerator implements DataFetcherGenerator, DataCallback {
    ...
    DataCacheGenerator(List list, DecodeHelper decodeHelper, FetcherReadyCallback fetcherReadyCallback) {
