...
public class ResourceDrawableDecoder implements ResourceDecoder {
    ...
    private Context findContextForPackage(Uri uri, String str) {
        ...
        try {
            this = this;
            this = this.context.createPackageContext(str, 0);
            r2 = this;
            return this;
        } catch (NameNotFoundException e) {
            if (str.contains(r2.context.getPackageName())) {
                return r2.context;
            }
    ...
    @Nullable
    public Resource decode(@NonNull Uri uri, int i, int i2, @NonNull Options options) {
