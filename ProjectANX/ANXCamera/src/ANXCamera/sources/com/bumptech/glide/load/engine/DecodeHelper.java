...
final class DecodeHelper {
    ...
    /* access modifiers changed from: 0000 */
    public void init(GlideContext glideContext2, Object obj, Key key, int i, int i2, DiskCacheStrategy diskCacheStrategy2, Class cls, Class cls2, Priority priority2, Options options2, Map map, boolean z, boolean z2, DiskCacheProvider diskCacheProvider2) {
