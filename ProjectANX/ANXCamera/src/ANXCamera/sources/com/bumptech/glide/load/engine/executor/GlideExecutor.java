...
public final class GlideExecutor implements ExecutorService {
    ...
    public static GlideExecutor newUnlimitedSourceExecutor() {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, Integer.MAX_VALUE, KEEP_ALIVE_TIME_MS, TimeUnit.MILLISECONDS, new SynchronousQueue(), new DefaultThreadFactory(DEFAULT_SOURCE_UNLIMITED_EXECUTOR_NAME, UncaughtThrowableStrategy.DEFAULT, false));
        return new GlideExecutor(threadPoolExecutor);
    }
