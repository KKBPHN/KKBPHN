...
public class RequestOptions extends BaseRequestOptions {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions bitmapTransform(@NonNull Transformation transformation) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions option(@NonNull Option option, @NonNull Object obj) {
