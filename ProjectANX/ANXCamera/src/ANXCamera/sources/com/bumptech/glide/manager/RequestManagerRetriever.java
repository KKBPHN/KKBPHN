...
public class RequestManagerRetriever implements Callback {
    ...
    @TargetApi(26)
    @Deprecated
    private void findAllFragmentsWithViews(@NonNull FragmentManager fragmentManager, @NonNull ArrayMap arrayMap) {
    ...
    @Deprecated
    private void findAllFragmentsWithViewsPreO(@NonNull FragmentManager fragmentManager, @NonNull ArrayMap arrayMap) {
        int i = 0;
        while (true) {
            int i2 = i + 1;
            String str = "key";
            this.tempBundle.putInt(str, i);
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.Collection, code=java.util.Collection<androidx.fragment.app.Fragment>, for r2v0, types: [java.util.Collection<androidx.fragment.app.Fragment>, java.util.Collection] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void findAllSupportFragmentsWithViews(@Nullable Collection<androidx.fragment.app.Fragment> collection, @NonNull Map map) {
        if (collection != null) {
