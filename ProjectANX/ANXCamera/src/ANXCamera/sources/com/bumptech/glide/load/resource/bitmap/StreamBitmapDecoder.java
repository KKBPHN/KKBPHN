...
public class StreamBitmapDecoder implements ResourceDecoder {
    ...
    class UntrustedCallbacks implements DecodeCallbacks {
    ...
    public Resource decode(@NonNull InputStream inputStream, int i, int i2, @NonNull Options options) {
        ...
        if (inputStream instanceof RecyclableBufferedInputStream) {
            ...
            RecyclableBufferedInputStream recyclableBufferedInputStream2 = new RecyclableBufferedInputStream(inputStream, this.byteArrayPool);
            z = true;
            recyclableBufferedInputStream = recyclableBufferedInputStream2;
        }
        ExceptionCatchingInputStream obtain = ExceptionCatchingInputStream.obtain(recyclableBufferedInputStream);
        try {
            return this.downsampler.decode((InputStream) new MarkEnforcingInputStream(obtain), i, i2, options, (DecodeCallbacks) new UntrustedCallbacks(recyclableBufferedInputStream, obtain));
        } finally {
            obtain.release();
            if (z) {
