...
public final class GlideBuilder {
    ...
    @NonNull
    public GlideBuilder addGlobalRequestListener(@NonNull RequestListener requestListener) {
    ...
    public Glide build(@NonNull Context context) {
        ...
        if (this.memorySizeCalculator == null) {
            this.memorySizeCalculator = new Builder(context2).build();
        }
        ...
        if (this.engine == null) {
            Engine engine2 = new Engine(this.memoryCache, this.diskCacheFactory, this.diskCacheExecutor, this.sourceExecutor, GlideExecutor.newUnlimitedSourceExecutor(), this.animationExecutor, this.isActiveResourceRetentionAllowed);
            this.engine = engine2;
        }
    ...
    @NonNull
    public GlideBuilder setDefaultRequestOptions(@NonNull RequestOptionsFactory requestOptionsFactory) {
    ...
    @NonNull
    public GlideBuilder setDefaultTransitionOptions(@NonNull Class cls, @Nullable TransitionOptions transitionOptions) {
