...
class EngineJob implements Callback, Poolable {
    ...
    class EngineResourceFactory {
        ...
        public EngineResource build(Resource resource, boolean z, Key key, ResourceListener resourceListener) {
    ...
    EngineJob(GlideExecutor glideExecutor, GlideExecutor glideExecutor2, GlideExecutor glideExecutor3, GlideExecutor glideExecutor4, EngineJobListener engineJobListener2, ResourceListener resourceListener2, Pool pool2) {
    ...
    @VisibleForTesting
    EngineJob(GlideExecutor glideExecutor, GlideExecutor glideExecutor2, GlideExecutor glideExecutor3, GlideExecutor glideExecutor4, EngineJobListener engineJobListener2, ResourceListener resourceListener2, Pool pool2, EngineResourceFactory engineResourceFactory2) {
    ...
    /* access modifiers changed from: 0000 */
    @VisibleForTesting
    public synchronized EngineJob init(Key key2, boolean z, boolean z2, boolean z3, boolean z4) {
        this.key = key2;
        this.isCacheable = z;
    ...
    public void onResourceReady(Resource resource2, DataSource dataSource2) {
        synchronized (this) {
    ...
    public synchronized void start(DecodeJob decodeJob2) {
