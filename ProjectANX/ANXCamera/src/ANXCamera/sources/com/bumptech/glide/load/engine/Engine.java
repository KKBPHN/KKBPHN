...
public class Engine implements EngineJobListener, ResourceRemovedListener, ResourceListener {
    ...
    class DecodeJobFactory {
        ...
        final Pool pool = FactoryPools.threadSafe(150, new Factory() {
        ...
        public DecodeJob build(GlideContext glideContext, Object obj, EngineKey engineKey, Key key, int i, int i2, Class cls, Class cls2, Priority priority, DiskCacheStrategy diskCacheStrategy, Map map, boolean z, boolean z2, boolean z3, Options options, Callback callback) {
            ...
            Preconditions.checkNotNull(decodeJob);
            DecodeJob decodeJob2 = decodeJob;
            int i5 = this.creationOrder;
            int i6 = i5;
            this.creationOrder = i5 + 1;
            return decodeJob2.init(glideContext2, obj2, engineKey2, key2, i3, i4, cls3, cls4, priority2, diskCacheStrategy2, map2, z4, z5, z6, options2, callback2, i6);
        }
    }
    ...
    class EngineJobFactory {
        ...
        public EngineJob build(Key key, boolean z, boolean z2, boolean z3, boolean z4) {
            ...
            Preconditions.checkNotNull(engineJob);
            return engineJob.init(key, z, z2, z3, z4);
        }
    ...
    class LazyDiskCacheProvider implements DiskCacheProvider {
