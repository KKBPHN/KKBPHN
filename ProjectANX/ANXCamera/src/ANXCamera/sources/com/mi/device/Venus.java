...
public final class Venus extends Common {
    ...
    public float[] OO00O() {
        return new float[]{0.0f, 119.0f, 237.0f, 394.0f, 512.0f, 581.0f, 700.0f};
    }

    public float[] OO00O0o() {
        return new float[]{0.6f, 1.0f, 2.0f, 5.0f, 10.0f, 15.0f, 30.0f};
    }
    ...
    public String Oo0OO0() {
        return ComponentConfigRatio.RATIO_FULL_20X9;
    }
