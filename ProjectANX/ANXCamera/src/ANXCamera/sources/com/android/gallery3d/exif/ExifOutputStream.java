...
public class ExifOutputStream extends FilterOutputStream {
    ...
    private void createRequiredIfdAndTag() {
        ...
        if (buildUninitializedTag != null) {
                    ...
                    if (buildUninitializedTag6 != null) {
                        ...
                        if (buildUninitializedTag7 != null) {
                            ...
                            for (int i2 = 0; i2 < this.mExifData.getStripCount(); i2++) {
                                jArr[i2] = (long) this.mExifData.getStrip(i2).length;
                            }
            ...
            ifdData3.removeTag(ExifInterface.getTrueTagKey(i));
            return;
        }
    ...
    private void writeExifData(boolean z) {
        ExifData exifData = this.mExifData;
        String str = TAG;
        if (exifData == null) {
            Log.w(str, "null exif data");
            return;
        }
        ...
        if (calculateAllOffset <= 65535) {
            ...
            if (z) {
                Log.d(str, "writeExifDataForHeif");
                orderedDataOutputStream.write(new byte[]{69, 120, 105, 102});
            }
            ...
            orderedDataOutputStream.writeShort(this.mExifData.getByteOrder() == ByteOrder.BIG_ENDIAN ? TIFF_BIG_ENDIAN : TIFF_LITTLE_ENDIAN);
        ...
        switch (exifTag.getDataType()) {
            ...
            case 9:
                ...
                while (i2 < componentCount2) {
                    orderedDataOutputStream.writeInt((int) exifTag.getValueAt(i2));
                    i2++;
                }
                return;
            case 5:
            case 10:
                ...
                while (i2 < componentCount3) {
                    orderedDataOutputStream.writeRational(exifTag.getRational(i2));
                    i2++;
                }
                return;
            default:
