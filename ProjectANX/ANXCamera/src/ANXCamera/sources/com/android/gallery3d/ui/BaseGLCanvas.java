...
public class BaseGLCanvas implements GLCanvas {
    ...
    private final ArrayList mDeletePrograms = new ArrayList();
    private final ArrayList mDeleteSurfaceTexture = new ArrayList();
    ...
    public void recycledResources() {
        ...
        synchronized (this.mDeleteSurfaceTexture) {
            Iterator it = this.mDeleteSurfaceTexture.iterator();
            while (it.hasNext()) {
                SurfaceTexture surfaceTexture = (SurfaceTexture) it.next();
