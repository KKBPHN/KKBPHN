...
public class AFFrameControl {
    ...
    public class MarshalQueryableAFFrameControl implements MarshalQueryable {
        private static final int SIZE = 920;

        class MarshalAFFrameControl extends Marshaler {
            protected MarshalAFFrameControl(TypeReference typeReference, int i) {
