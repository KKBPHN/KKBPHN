...
public class AECFrameControl {
    ...
    public AECExposureData[] mAecExposureDatas = new AECExposureData[3];

    public class AECExposureData {
        /* access modifiers changed from: private */
        public float mDeltaEVFromTarget;
        /* access modifiers changed from: private */
        public long mExposureTime;
        /* access modifiers changed from: private */
        public float mLinearGain;
        /* access modifiers changed from: private */
    ...
    public class MarshalQueryableAECFrameControl implements MarshalQueryable {
        private static final int SIZE = 72;

        class MarshalAECFrameControl extends Marshaler {
            protected MarshalAECFrameControl(TypeReference typeReference, int i) {
