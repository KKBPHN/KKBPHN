    ...
    public AutoZoomCaptureResult(CaptureResult captureResult) {
        if (this.mAutoZoomAvailable) {
            try {
                ...
                Log.e(TAG, "Could not read AutoZoom tags from CaptureResult. This instance of Device will not try to read AutoZoom tags from subsequent results", (Throwable) e);
            }
        }
    }

    private Object getAutoZoomResult(VendorTag vendorTag, CaptureResult captureResult) {
