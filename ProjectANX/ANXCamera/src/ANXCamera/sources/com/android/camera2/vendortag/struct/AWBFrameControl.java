...
public class AWBFrameControl {
    ...
    public class MarshalQueryableAWBFrameControl implements MarshalQueryable {
        private static final int SIZE = 16;

        class MarshalerAWBFrameControl extends Marshaler {
            protected MarshalerAWBFrameControl(TypeReference typeReference, int i) {
