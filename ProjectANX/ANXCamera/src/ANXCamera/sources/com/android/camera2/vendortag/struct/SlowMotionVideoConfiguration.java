...
public class SlowMotionVideoConfiguration {
    ...
    public class MarshalQueryableSlowMotionVideoConfiguration implements MarshalQueryable {

        class SlowMotionVideoConfigurationMarshaler extends Marshaler {
            private static final int NATIVE_SIZE = 16;

            private SlowMotionVideoConfigurationMarshaler(MarshalQueryable marshalQueryable, TypeReference typeReference, int i) {
