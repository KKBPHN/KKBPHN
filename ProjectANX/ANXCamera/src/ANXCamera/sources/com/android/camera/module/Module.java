...
public interface Module extends BaseProtocol, IBluetoothHeadsetConnectionState {
    ...
    void fillFeatureControl(StartControl startControl);

    int getModuleIndex();

    int getPortraitLightingVersion();

    List getSupportedSettingKeys();
    ...
    void notifyAfterFirstFrameArrived();
