...
public class MiGLSurfaceViewRender {
    ...
    private final OnFrameAvailableListener mUpdateListener = new OnFrameAvailableListener() {
        public void onFrameAvailable(SurfaceTexture surfaceTexture) {
            ...
            Log.d(MiGLSurfaceViewRender.TAG, sb.toString());
    ...
    private void InitShaders() {
        ...
        if (this.mmodelMatrixPreviewFilter < 0) {
            Log.d(str3, "mpreviewFilterProgramID glGet modelViewProjectionMatrix Location error ");
        }
    ...
    public void setFilterRGBColor(ByteBuffer byteBuffer) {
        this.RGBColor = byteBuffer;
    }
