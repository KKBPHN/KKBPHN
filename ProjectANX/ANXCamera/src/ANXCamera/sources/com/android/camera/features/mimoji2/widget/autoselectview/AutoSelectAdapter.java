...
public class AutoSelectAdapter extends Adapter implements OnPositionChangedListener {
    private ArrayList mDdataList;
    ...
    public interface OnSelectListener {
        void onSelectListener(Object obj, int i);
    }

    public AutoSelectAdapter(ArrayList arrayList) {
    ...
    public int getItemCount() {
        ArrayList arrayList = this.mDdataList;
        if (arrayList == null) {
            return 0;
        }
    ...
    public synchronized void setDataList(ArrayList arrayList) {
        this.mDdataList = arrayList;
    ...
    public synchronized void updateData(int i, SelectItemBean selectItemBean) {
        if (this.mDdataList != null && i >= 0) {
            if (i <= getItemCount() - 1) {
                this.mDdataList.set(i, selectItemBean);
                notifyItemChanged(i);
            }
        }
    }
