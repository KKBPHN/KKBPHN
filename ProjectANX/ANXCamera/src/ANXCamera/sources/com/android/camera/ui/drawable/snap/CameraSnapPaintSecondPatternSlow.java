...
public class CameraSnapPaintSecondPatternSlow extends PaintPattern {
    ...
    public void directlyResult() {
        ...
        ((CameraSnapPaintSecond) cameraPaintBase).quarterAngelCurrent = ((CameraSnapPaintSecond) cameraPaintBase).quarterAngelDst;
        ((CameraSnapPaintSecond) cameraPaintBase).squashAngelCurrent = ((CameraSnapPaintSecond) cameraPaintBase).squashAngelDst;
    ...
    public void prepareTargetPattern() {
        ...
        float f = (float) 46;
        ((CameraSnapPaintSecond) cameraPaintBase).quarterAngelDst = 90.0f / ((float) 11);
        ((CameraSnapPaintSecond) cameraPaintBase).squashAngelDst = 4.0f - (f / ((float) 79));
