...
public final class CameraMetadataSerializer {
        ...
        try {
            ...
            if (writer != null) {
                try {
                    ...
                    Log.e(TAG, str, (Throwable) e);
                }
            }
        } catch (IOException e2) {
            Log.e(TAG, "dumpMetadata - Failed to dump metadata", (Throwable) e2);
            if (writer != null) {
                writer.close();
            }
        } finally {
    ...
    public static void serialize(String str, CameraMetadata cameraMetadata, File file) {
        try {
            ...
            Log.e(TAG, "Could not write capture data to file.", (Throwable) e);
        }
    }
