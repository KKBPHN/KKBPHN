...
public class BeautyMenuAnimator {
    ...
    interface ChildAnimationsProvider {
        ArrayList expandAnimation(ViewGroup viewGroup);

        ArrayList shrinkAnimation(ViewGroup viewGroup);
    }

    public class CommonChildAnimationsProvider implements ChildAnimationsProvider {
        private CubicEaseOutInterpolator mCubicEaseOut = new CubicEaseOutInterpolator();

        public ArrayList expandAnimation(ViewGroup viewGroup) {
        ...
        public ArrayList shrinkAnimation(ViewGroup viewGroup) {
            int childCount = viewGroup.getChildCount();
            if (childCount <= 0) {
                return null;
            }
    ...
    public class ThreeChildAnimationProvider implements ChildAnimationsProvider {
        private CubicEaseOutInterpolator mCubicEaseOut = new CubicEaseOutInterpolator();
    ...
    private List getChildExpandAnimations() {
    ...
    private List getChildShrinkAnimations() {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<androidx.core.view.ViewPropertyAnimatorCompat>, for r1v0, types: [java.util.List, java.util.List<androidx.core.view.ViewPropertyAnimatorCompat>] */
