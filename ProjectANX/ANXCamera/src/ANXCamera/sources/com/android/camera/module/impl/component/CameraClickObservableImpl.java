...
public class CameraClickObservableImpl implements CameraClickObservable {
    private List mBottomTipObservableArray = new ArrayList();
    private List mBottomTipObserverArray = new ArrayList();
    private List mBottomTipTipMsgArray = new ArrayList();
    ...
    public void subscribe(int i) {
        ...
        while (i3 < this.mBottomTipTipMsgArray.size()) {
            int[] iArr = (int[]) this.mBottomTipTipMsgArray.get(i3);
        ...
        if (i2 >= 0) {
            int[] iArr2 = (int[]) this.mBottomTipObservableArray.get(i2);
