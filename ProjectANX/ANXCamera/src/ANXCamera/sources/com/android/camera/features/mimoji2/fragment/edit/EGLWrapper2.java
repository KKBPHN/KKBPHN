...
public class EGLWrapper2 {
    private static final int EGL_RECORDABLE_ANDROID = 12610;
    private static final String TAG = "EGLWrapper2";
    ...
    public EGLWrapper2(int i, int i2) {
    ...
    public EGLWrapper2(Surface surface) {
        this.mEGLContext = EGL14.EGL_NO_CONTEXT;
        this.mEGLDisplay = EGL14.EGL_NO_DISPLAY;
        this.mEGLSurface = EGL14.EGL_NO_SURFACE;
        this.mEGLConfigs = new EGLConfig[1];
    ...
    public EGLWrapper2(Surface surface, EGLContext eGLContext) {
        this.mEGLContext = EGL14.EGL_NO_CONTEXT;
        this.mEGLDisplay = EGL14.EGL_NO_DISPLAY;
        this.mEGLSurface = EGL14.EGL_NO_SURFACE;
        this.mEGLConfigs = new EGLConfig[1];
