...
public abstract class BaseWaterMarkDrawable {
    ...
    protected List mWaterMarkInfos;
    private int mWidth;

    public BaseWaterMarkDrawable(List list) {
        this.mWaterMarkInfos = list;
        List list2 = this.mWaterMarkInfos;
    ...
    private void draw() {
        List list = this.mWaterMarkInfos;
    ...
    private void drawFaceInfoText(Canvas canvas, String str, int i, int i2) {
        ...
        while (matcher.find()) {
            ...
            canvas.drawText(group, f, f4, paint);
            f3 += f2;
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!CameraSettings.isFrontMirror()) {
            ...
            if (i2 == 90 || i2 == 270) {
                bitmap = this.mWaterMarkBitmap;
                i = 1;
            } else {
                bitmap = this.mWaterMarkBitmap;
                i = 0;
            }
            this.mWaterMarkBitmap = Util.flipBitmap(bitmap, i);
        }
    ...
    public void setWaterMarkInfos(List list) {
        this.mWaterMarkInfos = list;
    }
}
