...
public class MimojiEditGLTextureView2 extends GLTextureView implements Renderer {
    ...
    public static final String TAG = "MimojiEditGLTextureView2";
        ...
        private void logConfig(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            ...
            while (true) {
                ...
                if (i < iArr2.length) {
                    ...
                    String access$100 = MimojiEditGLTextureView2.TAG;
    ...
    public MimojiEditGLTextureView2(Context context) {
        this(context, null);
    }

    public MimojiEditGLTextureView2(Context context, AttributeSet attributeSet) {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (!this.mIsStopRender) {
            ...
            this.mAvatar = AvatarEngineManager2.getInstance().getAvatar();
            ...
            if (this.mSaveConfigThum) {
                ...
                this.mAvatar.renderThumb(244, af.cj, 21, 20, bArr, 200, 200, 800, BACKGROUND_COLOR, 1.0f);
    ...
    public void setIsStopRenderForce(boolean z) {
        String str = TAG;
        StringBuilder sb = new StringBuilder();
        sb.append("setIsStopRenderForce :");
        sb.append(z);
        Log.d(str, sb.toString());
