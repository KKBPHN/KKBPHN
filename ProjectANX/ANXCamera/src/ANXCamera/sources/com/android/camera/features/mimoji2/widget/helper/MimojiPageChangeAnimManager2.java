...
public class MimojiPageChangeAnimManager2 {
    ...
    private int heightSurfacePixel;
    ...
    public int getNavigationBarHeight(Context context) {
        if (Display.checkDeviceHasNavigationBar(context)) {
            return Display.getNavigationBarHeight(context);
        }
        return 0;
    }
    ...
    public void resetTextureViewPosition(int i) {
        ...
        if (i == 6) {
            ...
            LayoutParams layoutParams2 = this.layoutParamsTextureView;
            int i5 = this.widthSurfacePixel;
            layoutParams2.width = i5;
            layoutParams2.height = i5;
            this.xCoordinateStartTexture = (this.screenWidth / 2) - (i5 / 2);
    ...
    public void translateYTextureView() {
        ...
        ofFloat.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                LayoutParams access$000 = mimojiPageChangeAnimManager2.layoutParamsTextureView;
