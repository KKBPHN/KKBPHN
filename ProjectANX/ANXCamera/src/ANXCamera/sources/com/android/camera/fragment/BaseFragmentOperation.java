...
public class BaseFragmentOperation {
    ...
    public BaseFragmentOperation featureWith(int i, String str) {
        checkOperation();
        this.operateType = 1;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x001c, code lost:
        if (r2.equals(r3.pendingFragmentAlias) != false) goto L_0x001e;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean saveWith(BaseFragmentOperation baseFragmentOperation) {
        if (this.operateType == baseFragmentOperation.operateType && this.containerViewId == baseFragmentOperation.containerViewId) {
            if (this.pendingFragmentInfo != baseFragmentOperation.pendingFragmentInfo) {
                String str = this.pendingFragmentAlias;
                if (str != null) {
                }
            }
            return true;
