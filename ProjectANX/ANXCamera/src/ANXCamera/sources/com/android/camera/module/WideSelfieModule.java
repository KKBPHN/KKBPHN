...
public class WideSelfieModule extends BaseModule implements CameraAction, CameraPreviewCallback, WideSelfStateCallback, FaceDetectionCallback {
    ...
    class MainHandler extends Handler {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00c2, code lost:
            if (r7.isActivityPaused() == false) goto L_0x007d;
         */
            ...
            if (!WideSelfieModule.this.isCreated()) {
                ...
                if (i == 2) {
                    ...
                    if (i == 51) {
                        ...
                        WideSelfieEngineWrapper access$200 = WideSelfieModule.this.mWideSelfEngine;
                        WideSelfieModule wideSelfieModule2 = WideSelfieModule.this;
                        CameraSize cameraSize2 = wideSelfieModule2.mPreviewSize;
                        int i2 = cameraSize2.width;
                        int i3 = cameraSize2.height;
                        CameraSize cameraSize3 = wideSelfieModule2.mPictureSize;
                        access$200.setCameraParameter("1", i2, i3, cameraSize3.width, cameraSize3.height);
                    } else if (i != 10) {
                        String str = "no consumer for this message: ";
                        if (!BaseModule.DEBUG) {
                            String access$000 = WideSelfieModule.TAG;
                    ...
                    wideSelfieModule4.handleUpdateFaceView(z2, z);
                }
            }
        }
    }
    ...
    class SaveOutputImageTask extends AsyncTask {
        ...
        private void addImageAsApplication(String str, String str2, byte[] bArr, int i, int i2, int i3) {
            ...
            String access$0002 = WideSelfieModule.TAG;
            StringBuilder sb2 = new StringBuilder();
            ...
            if (camera != null) {
                ...
                if (uri != null) {
                    ...
                    String access$0003 = WideSelfieModule.TAG;
        ...
        public Integer doInBackground(Void... voidArr) {
            ...
            if (i2 > 0 || i > 0) {
                int i3 = C0122O00000o.instance().OO0Oo00() ? 2 : Util.isGlobalVersion() ? 0 : 1;
                long currentTimeMillis = System.currentTimeMillis();
                ...
                beautyShot.uninit();
                String access$0004 = WideSelfieModule.TAG;
            ...
            addImageAsApplication(generateFilepath4Image, str, encodeNv21ToJpeg, this.mWidth, this.mHeight, this.mOrientation);
            HashMap hashMap = new HashMap();
            hashMap.put(BaseEvent.COUNT, String.valueOf(1));
            CameraStatUtils.trackGeneralInfo(hashMap, false, false, 176, this.mTriggerMode, true, this.mActualCameraId, this.mBeautyValues, null, BaseEvent.AUTO_OFF);
    ...
    private void startSaveTask(byte[] bArr, int i, int i2, int i3) {
        ...
        SaveOutputImageTask saveOutputImageTask = new SaveOutputImageTask(this.mActivity, charSequence, bArr2, i5, i4, z, this.mJpegRotation, this.mActualCameraId, this.mTriggerMode, this.mBeautyValues, this.mStopCaptureMode, new SaveStateCallback() {
            public void onSaveCompleted() {
                Log.k(3, WideSelfieModule.TAG, "onSaveCompleted");
                if (WideSelfieModule.this.mShowWarningToast) {
                    ...
                    WideSelfieModule wideSelfieModule = WideSelfieModule.this;
                    ToastUtils.showToast((Context) wideSelfieModule.mActivity, string, 80, 0, wideSelfieModule.mToastOffsetY);
                }
    ...
    private void stopWideSelfieShooting(boolean z, boolean z2, String str) {
        ...
        Log.k(3, TAG, "stopWideSelfieShooting");
    ...
    private void updatePictureAndPreviewSize() {
        PictureSizeManager.initialize(this.mCameraCapabilities.getSupportedOutputSizeWithAssignedMode(35), C0122O00000o.instance().OO00oOO(), 176, this.mBogusCameraId);
        CameraSize bestPictureSize = PictureSizeManager.getBestPictureSize(this.mModuleIndex);
        if (C0124O00000oO.O0o00O0) {
    ...
    public void fillFeatureControl(StartControl startControl) {
        ...
        if (startControl.mTargetMode == 176 && C0122O00000o.instance().OOOo00()) {
    ...
    public boolean onBackPressed() {
        ...
        if (!isProcessingSaveTask()) {
            playCameraSound(3);
            stopWideSelfieShooting(true, false, Panorama.STOP_CAPTURE_MODE_ON_HOME_OR_BACK);
        }
        return true;
    }
    ...
    public void onHostStopAndNotifyActionStop() {
        if (this.mIsShooting) {
            ...
            playCameraSound(3);
            stopWideSelfieShooting(false, false, Panorama.STOP_CAPTURE_MODE_ON_HOME_OR_BACK);
    ...
    public void onMove(int i, int i2, Point point, Point point2, boolean z) {
        ...
        if (z || z3 || z2) {
            String str = z3 ? Panorama.STOP_CAPTURE_MODE_HORIZONTAL_OUT : z2 ? Panorama.STOP_CAPTURE_MODE_VERTICAL_OUT : Panorama.STOP_CAPTURE_MODE_FILL;
            String str2 = TAG;
            StringBuilder sb = new StringBuilder();
    ...
    public void onOrientationChanged(int i, int i2, int i3) {
        ...
        if (this.mIsShooting && !this.mStopedForRotation) {
            ...
            if (abs >= 60) {
                ...
                stopWideSelfieShooting(false, true, Panorama.STOP_CAPTURE_MODE_ROTATE_OUT);
            }
        }
    }
    ...
    public void onPreviewUpdate(byte[] bArr, int i, int i2, final Rect rect, final Rect rect2) {
        if (bArr != null) {
            final Bitmap rotateBitmap = O00000o0.rotateBitmap(O00000o0.O00000o0(bArr, i, i2), CameraAppImpl.getAndroidContext().getResources().getInteger(R.integer.front_lens_orientation), true);
    ...
    public void onShutterButtonClick(int i) {
        if (!this.mPaused && getCameraState() != 0 && !isIgnoreTouchEvent() && !this.mActivity.isScreenSlideOff()) {
            ...
            if (!this.mIsShooting) {
                ...
                stopWideSelfieShooting(true, false, Panorama.STOP_CAPTURE_MODE_ON_SHUTTER_BUTTON);
            }
        }
    }
        ...
        synchronized (this.mDeviceLock) {
            ...
            this.mCamera2Device.captureBurstPictures(-1, new PictureCallbackWrapper() {
                public void onPictureTakenFinished(boolean z) {
                    ...
                    sb.append(z);
                    Log.k(2, access$000, sb.toString());
                }
                ...
                public boolean onPictureTakenImageConsumed(Image image, TotalCaptureResult totalCaptureResult) {
                    ...
                    if (image != null) {
                        if (WideSelfieModule.this.mFirstFrameNv21Data == null) {
                            WideSelfieModule.this.mFirstFrameNv21Data = O00000o0.getDataFromImage(image, 2);
                        }
