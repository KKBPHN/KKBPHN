...
public class FrontBeautyMenu extends AbBottomMenu implements OnClickListener {
    ...
    private boolean isJustBeautyTab() {
        ...
        if (!(currentMode == 162 || currentMode == 161 || currentMode == 174 || currentMode == 183 || currentMode == 171 || currentMode == 176)) {
            z = false;
        }
        return z;
    }
    ...
    public void addAllView() {
        ...
        for (int i = 0; i < menuData.size(); i++) {
            ...
            if (!isJustBeautyTab() || menuItem.type == 1) {
                ...
                colorActivateTextView.setActivateColor(isJustBeautyTab() ? ColorConstant.COLOR_COMMON_NORMAL : ColorConstant.COLOR_COMMON_SELECTED);
