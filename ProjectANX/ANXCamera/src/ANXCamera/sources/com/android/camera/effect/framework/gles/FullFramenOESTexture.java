...
public class FullFramenOESTexture extends FrameTexture {
    ...
    public void enableMirror() {
        Matrix.setRotateM(this.orientationMatrix, 0, 90.0f, 0.0f, 0.0f, 1.0f);
        Matrix.rotateM(this.orientationMatrix, 0, 180.0f, 0.0f, 1.0f, 0.0f);
        Matrix.setIdentityM(this.transformMatrix, 0);
    }
