...
public class FastmotionTextureVideoView extends TextureView implements SurfaceTextureListener, Callback, OnPreparedListener, OnVideoSizeChangedListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnBufferingUpdateListener {
    public static final int CENTER = 2;
    public static final int CENTER_CROP = 1;
    public static final int FIT_CENTER = 4;
    public static final int FIT_LEFT_TOP_FULL_SCREEN = 6;
    public static final int FIT_LEFT_TOP_FULL_SCREEN_AUTO = 7;
    ...
    private static final String TAG = "FastmotionTextureVideoView";
    private static final HandlerThread sThread = new HandlerThread(TAG);
    private Builder attrBuilder;
    ...
    class ScaleManager {
        ...
        private Matrix getLeftTopFullAutoScale() {
            Matrix fitCenter = fitCenter();
            fitCenter.postRotate(90.0f, (float) (this.mViewSize.getWidth() / 2), (float) (this.mViewSize.getHeight() / 2));
            fitCenter.postScale(((float) this.mVideoSize.getWidth()) / ((float) this.mVideoSize.getHeight()), ((float) this.mVideoSize.getWidth()) / ((float) this.mVideoSize.getHeight()), (float) (this.mViewSize.getWidth() / 2), (float) (this.mViewSize.getHeight() / 2));
            return fitCenter;
        }
        ...
        public Matrix getScaleMatrix(int i) {
            switch (i) {
                ...
                case 7:
                    return getLeftTopFullAutoScale();
                default:
                    return null;
            }
        }
    ...
    public FastmotionTextureVideoView(Context context) {
        super(context);
        init();
    }

    public FastmotionTextureVideoView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    public FastmotionTextureVideoView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void openVideo() {
        ...
        if ("android.resource".equals(this.mUri.getScheme()) || this.mUri.getPath() == null || new File(this.mUri.getPath()).exists()) {
            int i = 0;
            release(false);
            try {
                ...
                if (this.attrBuilder == null) {
                    this.attrBuilder = new Builder();
                    this.attrBuilder.setLegacyStreamType(3);
                    this.mMediaPlayer.setAudioAttributes(this.attrBuilder.build());
                }
                ...
                if (this.mIsNeedAudio) {
                    ...
                    if (this.mediaExtractor == null) {
                        ...
                        this.mediaExtractor.setDataSource(this.mContext, this.mUri, null);
                    }
                ...
                if (this.mMediaPlayerCallback != null) {
                    this.mHandler.post(new Runnable() {
                        public void run() {
                            if (FastmotionTextureVideoView.this.mMediaPlayerCallback != null) {
                                FastmotionTextureVideoView.this.mMediaPlayerCallback.onError(FastmotionTextureVideoView.this.mMediaPlayer, 1, 0);
                            }
                        }
                    });
                }
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(5:12|13|14|15|(1:17)) */
    ...
    public boolean handleMessage(Message message) {
        synchronized (FastmotionTextureVideoView.class) {
            int i = message.what;
            if (i == 1) {
                this.mTargetState = 3;
                openVideo();
    ...
    public void onBufferingUpdate(final MediaPlayer mediaPlayer, final int i) {
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                public void run() {
                    if (FastmotionTextureVideoView.this.mMediaPlayerCallback != null) {
                        FastmotionTextureVideoView.this.mMediaPlayerCallback.onBufferingUpdate(mediaPlayer, i);
                    }
                }
            });
        }
    ...
    public void onCompletion(final MediaPlayer mediaPlayer) {
        ...
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                public void run() {
                    if (FastmotionTextureVideoView.this.mMediaPlayerCallback != null) {
                        FastmotionTextureVideoView.this.mMediaPlayerCallback.onCompletion(mediaPlayer);
                    }
                }
            });
        }
    ...
    public boolean onError(final MediaPlayer mediaPlayer, final int i, final int i2) {
        ...
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                public void run() {
                    if (FastmotionTextureVideoView.this.mMediaPlayerCallback != null) {
                        FastmotionTextureVideoView.this.mMediaPlayerCallback.onError(mediaPlayer, i, i2);
                    }
                }
            });
        }
    ...
    public boolean onInfo(final MediaPlayer mediaPlayer, final int i, final int i2) {
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                public void run() {
                    if (FastmotionTextureVideoView.this.mMediaPlayerCallback != null) {
                        FastmotionTextureVideoView.this.mMediaPlayerCallback.onInfo(mediaPlayer, i, i2);
                    }
                }
            });
        }
        ...
        if (this.mTargetState == 1 && this.mCurrentState == 1) {
            ...
            if (this.mMediaPlayerCallback != null) {
                this.mHandler.post(new Runnable() {
                    public void run() {
                        if (FastmotionTextureVideoView.this.mMediaPlayerCallback != null) {
                            FastmotionTextureVideoView.this.mMediaPlayerCallback.onPrepared(mediaPlayer);
                        }
                    }
                });
            }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                public void run() {
                    if (FastmotionTextureVideoView.this.mMediaPlayerCallback != null) {
                        FastmotionTextureVideoView.this.mMediaPlayerCallback.onSurfaceReady(FastmotionTextureVideoView.this.mSurface);
                    }
                }
            });
        }
            ...
            this.mHandler.post(new Runnable() {
                public void run() {
                    ...
                    if (i != 0) {
                        int i2 = i2;
                        if (i2 != 0) {
                            FastmotionTextureVideoView.this.setVideoSpecifiedSize(i, i2);
                        }
                    }
                }
            });
