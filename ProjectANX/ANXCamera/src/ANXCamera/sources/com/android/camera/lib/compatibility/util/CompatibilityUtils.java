...
public class CompatibilityUtils {
    ...
    public static void createCaptureSessionWithSessionConfiguration(CameraDevice cameraDevice, int i, InputConfiguration inputConfiguration, List list, CaptureRequest captureRequest, StateCallback stateCallback, Handler handler) {
    ...
    public static long extractVersionCode(PackageInfo packageInfo) {
        return V28Utils.extractVersionCode(packageInfo);
    }

    public static List getAvailableSessionKeys(CameraCharacteristics cameraCharacteristics) {
        return V28Utils.getAvailableSessionKeys(cameraCharacteristics);
    }
