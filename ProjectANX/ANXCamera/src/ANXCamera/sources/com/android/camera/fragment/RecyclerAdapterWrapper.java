...
public class RecyclerAdapterWrapper extends Adapter {
    private static final int FOOTER_VIEW_TYPE = -2000;
    private static final int HEADER_VIEW_TYPE = -1000;
    private final Adapter mBase;
    private final Class mBaseHolderClass;
    private final List mFooters = new ArrayList();
    private final List mHeaders = new ArrayList();
    private AdapterDataObserver o;

    public RecyclerAdapterWrapper(Adapter adapter) {
        ...
        if (genericSuperclass instanceof ParameterizedType) {
            ...
            if (type instanceof Class) {
                cls = (Class) type;
                this.mBaseHolderClass = cls;
                Adapter adapter2 = this.mBase;
        ...
        cls = ViewHolder.class;
        this.mBaseHolderClass = cls;
        Adapter adapter22 = this.mBase;
        AnonymousClass1 r02 = new AdapterDataObserver() {
            public void onChanged() {
                super.onChanged();
                RecyclerAdapterWrapper.this.notifyDataSetChanged();
            }
        ...
        this.o = r02;
        adapter22.registerAdapterDataObserver(r02);
    }
