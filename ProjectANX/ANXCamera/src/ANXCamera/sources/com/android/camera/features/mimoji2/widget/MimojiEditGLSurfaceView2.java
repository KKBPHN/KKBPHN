package com.android.camera.features.mimoji2.widget;
...
public class MimojiEditGLSurfaceView2 extends GLSurfaceView implements Renderer {
    ...
    public static final String TAG = "MimojiEditGLSurfaceView2";
        ...
        private void logConfig(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig) {
            ...
            while (true) {
                ...
                if (i < iArr2.length) {
                    ...
                    String access$100 = MimojiEditGLSurfaceView2.TAG;
    ...
    public MimojiEditGLSurfaceView2(Context context) {
        this(context, null);
    }

    public MimojiEditGLSurfaceView2(Context context, AttributeSet attributeSet) {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (!this.mIsStopRender) {
            AvatarEngineManager2.getInstance().queryAvatar().avatarRender(this.mDeviceRotation, getWidth(), getHeight(), 0, false, null);
            if (this.mSaveConfigThum) {
                this.mSaveConfigThum = false;
                byte[] bArr = new byte[160000];
                AvatarEngineManager2.getInstance().queryAvatar().renderThumb(244, af.cj, 21, 20, bArr, 200, 200, 800, BACKGROUND_COLOR, 1.0f);
