...
public class CameraSnapPaintSecondPatternFast extends PaintPattern {
    ...
    public void directlyResult() {
        ...
        ((CameraSnapPaintSecond) cameraPaintBase).motionLineWidthCurrent = ((CameraSnapPaintSecond) cameraPaintBase).motionLineWidthDst;
        ((CameraSnapPaintSecond) cameraPaintBase).commonLineWidthCurrent = ((CameraSnapPaintSecond) cameraPaintBase).baseLineWidth;
        ((CameraSnapPaintSecond) cameraPaintBase).commonLineWidthDst = (float) Util.dpToPixel(3.5f);
    }
    ...
    public void prepareTargetPattern() {
        ...
        ((CameraSnapPaintSecond) cameraPaintBase).motionLineWidthDst = (float) Util.dpToPixel(6.0f);
