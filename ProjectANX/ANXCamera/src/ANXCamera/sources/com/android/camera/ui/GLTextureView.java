...
public class GLTextureView extends TextureView implements SurfaceTextureListener {
    ...
    class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        public EGLSurface createWindowSurface(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig, Object obj) {
            ...
            try {
                ...
                Log.e(GLTextureView.TAG, "eglCreateWindowSurface", (Throwable) e);
                return eGLSurface;
            }
        }
    ...
    class EglHelper {
        ...
        public static String formatEglError(String str, int i) {
            ...
            sb.append(str);
            sb.append(" failed");
            sb.append(EGLLogWrapper.getErrorString(i));
            return sb.toString();
        }
    ...
    class GLThread extends Thread {
        ...
        GLThread(WeakReference weakReference, int i, int i2) {
            this.mEventQueue = new ArrayList();
            this.mSizeChanged = true;
            this.mWidth = i;
            this.mHeight = i2;
            ...
            while (true) {
                ...
                while (true) {
                    try {
                        ...
                        try {
                            Log.d(TAG, "got exception", (Throwable) e2);
                            synchronized (GLTextureView.sGLThreadManager) {
                                stopEglSurfaceLocked();
                                stopEglContextLocked();
                                return;
