...
public class FragmentStickerPager extends Fragment {
    ...
    /* access modifiers changed from: private */
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<com.android.camera.sticker.StickerInfo>, for r4v0, types: [java.util.List, java.util.List<com.android.camera.sticker.StickerInfo>] */
