...
public class BaseItemAnimator extends DefaultItemAnimator {
    ...
    public static int DEFAULT_LIST_DURATION = 150;
    ...
    public BaseItemAnimator() {
        setAddDuration((long) DEFAULT_LIST_DURATION);
        setMoveDuration((long) DEFAULT_LIST_DURATION);
        setChangeDuration((long) DEFAULT_LIST_DURATION);
    }
    ...
    public void animateAddImpl(final ViewHolder viewHolder) {
        ...
        animate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                BaseItemAnimator.this.mAddAnimations.remove(viewHolder);
                BaseItemAnimator.this.dispatchFinishedWhenDone();
            }
            ...
            if (z4) {
                ...
                AnonymousClass3 r5 = new Runnable() {
                    public void run() {
                        ...
                        while (it.hasNext()) {
                            BaseItemAnimator.this.animateAddImpl((ViewHolder) it.next());
                        }
                        arrayList3.clear();
