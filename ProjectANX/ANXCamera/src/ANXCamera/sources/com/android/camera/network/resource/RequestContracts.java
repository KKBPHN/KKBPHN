...
public interface RequestContracts {
    public static final String HOST = "http://micloudweb.preview.n.xiaomi.com";
    public static final String HOST_I = "https://i.mi.com";

    public interface Download {
        public static final String JSON_KEY_SHA1 = "sha1Base16";
        public static final String JSON_KEY_URL = "url";
        public static final String PARAM_ID = "id";
        public static final String URL = "https://i.mi.com/gallery/public/resource/download";
    }
    ...
    public interface Info {
        ...
        public static final String URL = "https://i.mi.com/gallery/public/resource/info";
    }
}
