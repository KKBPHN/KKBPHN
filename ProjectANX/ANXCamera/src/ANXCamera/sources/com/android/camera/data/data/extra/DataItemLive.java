...
public class DataItemLive extends DataItemBase {
    ...
    private List mMiLiveSegmentData;
    ...
    private boolean mTimeFreezeFilmRatioEnabled = false;
    ...
    public void clearAll() {
        ...
        List list = this.mMiLiveSegmentData;
        if (list != null) {
            list.clear();
    ...
    public List getMiLiveSegmentData() {
    ...
    public List getRecordSegmentTimeInfo() {
    ...
    public void setMiLiveSegmentData(List list) {
        this.mMiLiveSegmentData = list;
    }

    public void setRecordSegmentTimeInfo(List list) {
