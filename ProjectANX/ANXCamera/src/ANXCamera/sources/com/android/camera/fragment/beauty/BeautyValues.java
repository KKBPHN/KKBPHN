...
public class BeautyValues implements Parcelable {
    ...
    public boolean isBeautyModelOn() {
        if (this.mBeautySlimFace <= 0 && this.mBeautyEnlargeEye <= 0 && this.mBeautyNose <= 0 && this.mBeautyRisorius <= 0) {
            int i = this.mBeautyLips;
            if (i == 0 || i == 0) {
                int i2 = this.mBeautyChin;
                if ((i2 == 0 || i2 == 0) && this.mBeautyNeck <= 0 && this.mBeautySmile <= 0 && this.mBeautySlimNose <= 0) {
                    int i3 = this.mBeautyHairLine;
                    if (i3 == 0 || i3 == 0) {
                        return false;
                    }
                }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        if (C0124O00000oO.Oo00O()) {
            ...
            i2 = this.mBeautyButtSlim;
        } else {
            parcel.writeInt(this.mBeautySkinColor);
            parcel.writeInt(this.mBeautySlimFace);
            parcel.writeInt(this.mBeautySkinSmooth);
            i2 = this.mBeautyEnlargeEye;
        }
        parcel.writeInt(i2);
    }
}
