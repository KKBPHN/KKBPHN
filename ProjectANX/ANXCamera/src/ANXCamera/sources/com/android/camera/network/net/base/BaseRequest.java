...
public abstract class BaseRequest implements ResponseErrorHandler {
    ...
    public final BaseRequest addParam(String str, String str2) {
    ...
    public final BaseRequest setCacheExpires(long j) {
        this.mCacheExpires = j;
        return this;
    }

    public final BaseRequest setCacheSoftTtl(long j) {
        this.mCacheSoftTtl = j;
        return this;
    }

    public final BaseRequest setOnResponseListener(ResponseListener responseListener) {
    ...
    public final BaseRequest setUseCache(boolean z) {
        this.mUseCache = z;
        return this;
    }

    public final Object simpleExecuteSync() {
