...
public class ShaderUtil {
    ...
    public static int createProgram(String str, String str2) {
        ...
        if (loadShader == 0) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append("Fail to init vertex shader ");
            sb2.append(str);
            sb = sb2.toString();
        } else {
            ...
            if (loadShader2 == 0) {
                ...
                sb3.append("Fail to init fragment shader ");
                sb3.append(str2);
                sb = sb3.toString();
            } else {
    ...
    public static boolean loadYuv444ToTextures(Buffer buffer, Buffer buffer2, Buffer buffer3, int i, int i2, int[] iArr) {
        ...
        if (buffer == null || buffer2 == null || buffer3 == null) {
            ...
            if (iArr2[2] == -1) {
                GLES20.glGenTextures(i5, iArr2, 2);
                GLES20.glActiveTexture(33986);
                GLES20.glBindTexture(i4, iArr2[2]);
                int i18 = i5;
                i17 = 3553;
                i16 = 0;
                i6 = i4;
                ...
                i7 = 10242;
                GLES20.glActiveTexture(33986);
                GLES20.glBindTexture(i6, iArr2[2]);
                i17 = 3553;
                i16 = 0;
                i15 = 6409;
                i12 = 0;
            ...
            GLES20.glTexImage2D(i17, i16, i15, i14, i13, i12, i11, i10, buffer3);
            GLES20.glTexParameterf(i6, 10240, 9729.0f);
            GLES20.glTexParameterf(i6, i9, 9729.0f);
            GLES20.glTexParameterf(i6, i7, f);
            GLES20.glTexParameterf(i6, i8, f);
            return true;
        }
    ...
    public static void loadYuvToTextures(Buffer buffer, Buffer buffer2, int i, int i2, int[] iArr) {
        ...
        GLES20.glTexParameterf(3553, i5, f);
    }
}
