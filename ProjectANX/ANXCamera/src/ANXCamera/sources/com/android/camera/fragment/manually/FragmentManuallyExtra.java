...
public class FragmentManuallyExtra extends BaseFragment implements OnClickListener {
    public static final int FRAGMENT_INFO = 254;
    private static final String TAG = "FragmentManuallyExtra";
    ...
    private void initLensRecyclerView(ComponentData componentData) {
        ...
        AnonymousClass2 r2 = new ExtraRecyclerViewAdapter(this.mFragmentManually, componentData, this.mCurrentMode, this.mManuallyListener, marginLayoutParams.height, this.mDegree) {
    ...
    public void animateOut() {
        View view = getView();
        if (view != null) {
            animateParentInOrOut(view, false, new O0000O0o(this));
        }
    }
  ...
  mth insns count: 85
    ...
    public void onClick(View view) {
        ...
        if (this.mTargetKey > 0) {
            ...
            sb.append(view.getContext().getString(this.mTargetKey));
            sb.append(" onClick: ");
            sb.append(this.mAutoButton.getContentDescription());
        ...
        switch (this.mTargetKey) {
            case R.string.pref_camera_iso_title_abbr /*2131756363*/:
                ...
                r5.setComponentValue(this.mCurrentMode, str3);
                this.mHorizontalView.getDrawAdapter().setCurrentValue(str3);
