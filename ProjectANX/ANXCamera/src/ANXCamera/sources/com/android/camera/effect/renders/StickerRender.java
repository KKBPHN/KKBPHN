...
public class StickerRender extends PixelEffectRender {
    ...
    private int processTexture(int i, int i2, int i3, int i4) {
        ...
        GLES20.glReadPixels(0, 0, i3, i4, 6408, 5121, getRGBABuffer(i6, i7));
        ...
        if (this.mNeedBeautify || (hasSticker() && this.mRGBABuffer != null)) {
            ...
            if (this.mNeedBeautify) {
                ...
                int i9 = this.mStBeautifyNative.processTexture(i, i3, i4, sTMobile106Arr2, this.mBeautifyTextureId[0], sTMobile106Arr) == 0 ? this.mBeautifyTextureId[0] : i;
            ...
            if (frameBufferCallback != null) {
                ...
                i8 = this.mStStickerNative.processTextureAndOutputBuffer(i5, humanActionDetect, rotateType, i3, i4, false, this.mTextureOutId[0], 6, allocate.array());
                if (i8 == 0) {
                    frameBufferCallback.onFrameBuffer(byteBuffer, i6, i7);
                }
            } else {
                i8 = this.mStStickerNative.processTexture(i5, humanActionDetect, rotateType, i3, i4, false, this.mTextureOutId[0]);
            }
        } else {
            i5 = i;
        }
