        ...
        if (this.data != null && !TextUtils.isEmpty(this.mSavePath)) {
            synchronized (this.mSavePath.intern()) {
                ...
                if (itemByPath != null) {
                    ...
                    boolean z = this.algorithmName != null && this.algorithmName.equals(Util.ALGORITHM_NAME_MIMOJI_CAPTURE);
                    Uri addImage = Storage.addImage(this.context, fileTitleFromPath, this.date, this.loc, this.orientation, this.data, this.isHeic, this.width, this.height, false, false, false, z, this.isParallelProcess, this.algorithmName, this.info, this.noGaussian);
                    ...
                    if (addImage != null) {
                        if (z2) {
                            ...
                            Log.k(3, TAG, "image save try to create thumbnail");
