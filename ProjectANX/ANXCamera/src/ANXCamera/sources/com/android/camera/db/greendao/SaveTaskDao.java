...
public class SaveTaskDao extends AbstractDao {
    ...
    public class Properties {
        ...
        public static final Property NoGaussian;
        ...
        static {
            ...
            Property property8 = new Property(7, Integer.TYPE, "noGaussian", false, ProcessingMetadataQuery.NO_GAUSSIAN);
            NoGaussian = property8;
        }
    }
    ...
    public static void createTable(Database database, boolean z) {
        ...
        sb.append(str);
        sb.append("\"tasks\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE ,\"start_time\" INTEGER,\"media_store_id\" INTEGER,\"media_path\" TEXT,\"progress_status\" INTEGER NOT NULL ,\"progress_percentage\" INTEGER NOT NULL ,\"jpeg_rotation\" INTEGER NOT NULL ,\"no_gaussian\" INTEGER NOT NULL );");
    ...
    public final void bindValues(SQLiteStatement sQLiteStatement, SaveTask saveTask) {
        ...
        sQLiteStatement.bindLong(8, (long) saveTask.getNoGaussian());
    }
    ...
    public final void bindValues(DatabaseStatement databaseStatement, SaveTask saveTask) {
        ...
        databaseStatement.bindLong(8, (long) saveTask.getNoGaussian());
    }
    ...
    public SaveTask readEntity(Cursor cursor, int i) {
        ...
        int i5 = i + 3;
        SaveTask saveTask = new SaveTask(valueOf, valueOf2, valueOf3, cursor.isNull(i5) ? null : cursor.getString(i5), cursor.getInt(i + 4), cursor.getInt(i + 5), cursor.getInt(i + 6), cursor.getInt(i + 7));
        return saveTask;
    }
    ...
    public void readEntity(Cursor cursor, SaveTask saveTask, int i) {
        ...
        saveTask.setNoGaussian(cursor.getInt(i + 7));
    }
