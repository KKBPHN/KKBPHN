...
public class TTLiveStickerResourceRequest extends BaseJsonRequest {
    ...
    public TTLiveStickerResourceRequest(String str, String str2) {
        ...
        addParam("region", str3);
    }

    /* access modifiers changed from: private */
    public List loadFromCache() {
        try {
    ...
    public void execute(final boolean z, final ResponseListener responseListener) {
        ...
        if (liveStickerLastCacheTime <= 0 || currentTimeMillis - liveStickerLastCacheTime > 86400000) {
    ...
    /* access modifiers changed from: protected */
    public List processJson(JSONObject jSONObject) {
        if (jSONObject != null) {
