...
public class DrawJPEGAttribute extends DrawAttribute {
    ...
    public boolean mIsUltraPixelWatermarkEnabled;
    ...
    public DrawJPEGAttribute(byte[] bArr, boolean z, int i, int i2, int i3, int i4, int i5, EffectRectAttribute effectRectAttribute, Location location, String str, long j, int i6, int i7, float f, boolean z2, String str2, boolean z3, PictureInfo pictureInfo, List list, boolean z4, boolean z5, String str3, boolean z6, boolean z7, DeviceWatermarkParam deviceWatermarkParam, boolean z8, int i8, int i9, boolean z9) {
        ...
        this.mIsUltraPixelWatermarkEnabled = z5;
        this.mTimeWaterMarkText = str3;
        this.mHasDualWaterMark = z6;
        this.mHasFrontWaterMark = z7;
        this.mDeviceWatermarkParam = deviceWatermarkParam;
        this.mIsPortraitRawData = z8;
        this.mTarget = 9;
