...
public class CameraFocusSplitAnimateDrawable extends Drawable implements Animatable {
    ...
    public CameraFocusSplitAnimateDrawable(Context context) {
        ...
        this.mSplitBigCircle.setTargetValues(1.0f, -1, 205, (float) Util.dpToPixel(1.33f));
        this.mPaintFocusCircle.setTargetValues(1.0f, -1, 205, (float) Util.dpToPixel(1.33f));
        this.mPaintExposureCircle.setTargetValues(1.0f, Color.rgb(255, 204, 0), 205, (float) Util.dpToPixel(1.33f));
    ...
    public void setExposureCenter(int i, int i2) {
        ...
        float f = (float) i;
        float f2 = (float) i2;
        this.mPaintExposureCircle.setMiddle(f, f2, (float) BIG_RADIUS);
        this.mPaintExposureCenterIndicator.setMiddle(f, f2, (float) CENTER_BASE_RADIUS);
        invalidateSelf();
    }
    ...
    public void setFocusCenter(int i, int i2) {
        ...
        float f = (float) i;
        float f2 = (float) i2;
        this.mPaintFocusCircle.setMiddle(f, f2, (float) BIG_RADIUS);
        this.mPaintFocusCenterIndicator.setMiddle(f, f2, (float) CENTER_BASE_RADIUS);
        invalidateSelf();
    }
    ...
    public void startFocusSuccessAnimation(int i, boolean z, int i2) {
        CameraFocusPaintCenterIndicator cameraFocusPaintCenterIndicator;
        CameraPaintBase cameraPaintBase;
        CameraFocusPaintCenterIndicator cameraFocusPaintCenterIndicator2;
        CameraPaintBase cameraPaintBase2;
        ...
        if (isAnimatorRunning(this.mTouchDownAnimator)) {
            ...
            if (this.mSuccessFlag == 5) {
                if (i2 == 0) {
                    ...
                    cameraPaintBase2 = this.mSplitBigCircle;
                } else if (i2 == 1) {
                    this.mFocusLocked = true;
                    cameraPaintBase2 = this.mPaintFocusCircle;
                } else if (i2 == 2) {
                    this.mExposureLocked = true;
                    cameraPaintBase2 = this.mPaintExposureCircle;
                    cameraFocusPaintCenterIndicator2 = this.mPaintExposureCenterIndicator;
                    start3ALockSuccessAnimation(cameraPaintBase2, cameraFocusPaintCenterIndicator2);
                }
                cameraFocusPaintCenterIndicator2 = this.mPaintFocusCenterIndicator;
                start3ALockSuccessAnimation(cameraPaintBase2, cameraFocusPaintCenterIndicator2);
            } else {
                if (i2 == 0) {
                    cameraPaintBase = this.mSplitBigCircle;
                } else if (i2 == 1) {
                    cameraPaintBase = this.mPaintFocusCircle;
                } else if (i2 == 2) {
                    cameraPaintBase = this.mPaintExposureCircle;
                    cameraFocusPaintCenterIndicator = this.mPaintExposureCenterIndicator;
                    startNormalFocusSuccessAnimation(cameraPaintBase, cameraFocusPaintCenterIndicator);
                }
                cameraFocusPaintCenterIndicator = this.mPaintFocusCenterIndicator;
                startNormalFocusSuccessAnimation(cameraPaintBase, cameraFocusPaintCenterIndicator);
            }
        }
    }
        ...
        this.mTouchDownAnimator.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (CameraFocusSplitAnimateDrawable.this.mTouchDownAnimator != null) {
                    ...
                    CameraFocusSplitAnimateDrawable.this.mTouchDownAnimator = null;
                }
                int access$300 = CameraFocusSplitAnimateDrawable.this.pendingState;
                if (access$300 != 1) {
                    CameraFocusSplitAnimateDrawable cameraFocusSplitAnimateDrawable = CameraFocusSplitAnimateDrawable.this;
                    if (access$300 != 3) {
                        cameraFocusSplitAnimateDrawable.startFocusingAnimation();
                    } else {
                        cameraFocusSplitAnimateDrawable.startFocusFailAnimation();
                    }
                } else {
                    CameraFocusSplitAnimateDrawable cameraFocusSplitAnimateDrawable2 = CameraFocusSplitAnimateDrawable.this;
                    cameraFocusSplitAnimateDrawable2.startFocusSuccessAnimation(cameraFocusSplitAnimateDrawable2.mSuccessFlag, CameraFocusSplitAnimateDrawable.this.mIsTouchFocus, i);
                }
            }
