...
public class SupportedConfigs {
    private List mConfigs;
    private List mSupportedConfigs;
    ...
    public void remove(int i) {
        int indexOf = this.mSupportedConfigs.indexOf(Integer.valueOf(i));
        if (indexOf > 0) {
            this.mSupportedConfigs.remove(i);
            this.mConfigs.remove(indexOf);
        }
    }
