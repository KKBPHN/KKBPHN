...
public class RenderGroup extends Render {
    ...
    private ArrayList mPartRenders = new ArrayList();
    private ArrayList mRenders = new ArrayList();
    private SparseArray mRendersMap = new SparseArray();
    ...
    private boolean recordRender(Render render) {
        ...
        Log.e(str, sb.toString(), (Throwable) new RuntimeException());
        return false;
    }
