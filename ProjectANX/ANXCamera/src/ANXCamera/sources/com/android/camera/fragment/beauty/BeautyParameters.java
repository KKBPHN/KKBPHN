...
public class BeautyParameters {
    ...
    public static final String TAG = "BeautyParameters";
    ...
    private Map getProcessorBeautyParams(IntelligentBeautyProcessor intelligentBeautyProcessor, int i) {
    ...
    private void setBeautyParameters() {
        ...
        if (EffectController.getInstance().isStickerEnable()) {
            IntelligentBeautyProcessor intelligentBeautyProcessor2 = this.mStickerMakeupProcessor;
            if (intelligentBeautyProcessor2 != null) {
                map = getProcessorBeautyParams(intelligentBeautyProcessor2, beautyShowLevel);
                intelligentBeautyProcessor = this.mStickerMakeupProcessor;
            } else {
                return;
            }
        } else {
            IntelligentBeautyProcessor intelligentBeautyProcessor3 = this.mMakeupProcessor;
            if (intelligentBeautyProcessor3 != null) {
                map = getProcessorBeautyParams(intelligentBeautyProcessor3, beautyShowLevel);
                intelligentBeautyProcessor = this.mMakeupProcessor;
            } else {
                return;
            }
        }
        intelligentBeautyProcessor.setBeautyParamsDegree(map);
    }
