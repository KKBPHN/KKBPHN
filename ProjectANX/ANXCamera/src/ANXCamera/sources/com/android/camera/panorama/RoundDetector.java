...
public class RoundDetector implements SensorEventListener {
    ...
    class LoopRangeLeft extends LoopRange {
    ...
    public void setStartPosition(int i, int i2, float f, float f2, boolean z) {
        ...
        synchronized (SynchronizedObject) {
            ...
            if (i2 == 0) {
                ...
                loopRange = new LoopRangeLeft(correctionCircleDegree, correctionCircleDegree2, m.cQ);
            } else {
                if (i3 < correctionCircleDegree2) {
                    correctionCircleDegree2 = 0;
                }
                loopRange = new LoopRange(correctionCircleDegree, correctionCircleDegree2, m.cQ);
            }
            this.mEndDegreeRange = loopRange;
            this.mDirection = i2;
