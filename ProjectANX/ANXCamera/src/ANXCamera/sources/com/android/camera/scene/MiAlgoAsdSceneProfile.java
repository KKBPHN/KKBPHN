...
public class MiAlgoAsdSceneProfile {
    ...
    private static List sSceneList = new ArrayList();
    ...
    static {
        ...
        create9.type = 9;
        int i = 2131756847;
        create9.valueArray.put(1, Integer.valueOf(HybridZoomingSystem.IS_3_OR_MORE_SAT ? R.string.ultra_wide_recommend_tip_hint_sat : R.string.ultra_wide_recommend_tip_hint));
        SparseArray sparseArray = create9.valueArray;
