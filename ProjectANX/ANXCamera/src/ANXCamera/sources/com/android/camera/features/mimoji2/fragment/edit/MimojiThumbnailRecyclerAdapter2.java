...
public class MimojiThumbnailRecyclerAdapter2 extends BaseRecyclerAdapter {
    ...
    class ThumbnailViewViewHolder extends BaseRecyclerViewHolder {
        ...
        public /* synthetic */ void O0000o(String str) {
        ...
        public void setData(ASAvatarConfigInfo aSAvatarConfigInfo, int i) {
            ...
            if (aSAvatarConfigInfo != null) {
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    z = aSAvatarConfigInfo == null && MimojiThumbnailRecyclerAdapter2.getSelectItem(aSAvatarConfigInfo.configType) == ((float) aSAvatarConfigInfo.configID);
                    ...
                    if (!z) {
                        ...
                        if (Util.isAccessible()) {
                            this.itemView.postDelayed(new C0270O0000oo(this, sb2), 100);
                            return;
                        }
                        return;
                    }
    ...
    public MimojiThumbnailRecyclerAdapter2(Context context, int i, String str) {
        this(null);
    ...
    public MimojiThumbnailRecyclerAdapter2(ArrayList arrayList) {
        super(arrayList);
