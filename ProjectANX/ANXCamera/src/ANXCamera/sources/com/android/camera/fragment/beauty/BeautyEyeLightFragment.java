...
public class BeautyEyeLightFragment extends BaseBeautyFragment implements OnClickListener {
    ...
    private static List EYE_LIGHT_TYPE_LIST = null;
    ...
    private void notifyItemChanged(int i, int i2) {
        if (i > -1) {
            if (Util.isAccessible()) {
                List list = EYE_LIGHT_TYPE_LIST;
                if (list != null) {
                    int textResource = ((EyeLightItem) list.get(i)).getTextResource();
        ...
        if (i2 > -1) {
            if (Util.isAccessible()) {
                List list2 = EYE_LIGHT_TYPE_LIST;
                if (list2 != null) {
                    int textResource2 = ((EyeLightItem) list2.get(i2)).getTextResource();
                    ...
                    if (findViewHolderForAdapterPosition2 != null && isAdded()) {
                        this.mAdapter.setAccessible(findViewHolderForAdapterPosition2.itemView, textResource2, true);
                    }
                }
            }
    ...
    public void onItemSelected(int i) {
        ...
        if (scrollIfNeed(this.mSelectPosition) || Util.isAccessible()) {
    ...
    private boolean scrollIfNeed(int i) {
        ...
        if (linearLayoutManagerWrapper == null) {
            ...
            sb.append(isAdded());
            Log.e(str, sb.toString(), (Throwable) new Exception());
            return false;
        }
    ...
    public void onClick(View view) {
        ...
        if ((cameraAction == null || !cameraAction.isDoingAction()) && view.getId() == R.id.eye_light_back_button) {
            ...
            if (makeupProtocol != null) {
                makeupProtocol.onMakeupItemSelected("pref_eye_light_type_key", R.string.eye_light, true);
            }
        }
    }
