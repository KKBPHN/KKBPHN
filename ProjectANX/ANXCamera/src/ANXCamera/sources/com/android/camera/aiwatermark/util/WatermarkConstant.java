...
public class WatermarkConstant {
    ...
    public static final String DEFAULT_LOCATION = "中国";
    ...
    public static final String EXTEND_TIME_1 = "super_moon_text_1";
    public static final String EXTEND_TIME_2 = "super_moon_text_4";
    public static final int EXTENT_SUPER_MOON_SILHOUETTE_TYPE = 11;
    public static final int EXTENT_SUPER_MOON_TEXT_TYPE = 12;
    public static final String FIRST_USE = "aiwatermark_first_use";
    public static final int FIXED_ORIENTATION = 0;
    ...
    public static final int LOCATION_TEXT_EMS_LIMIT = 24;
    public static final String LOCATION_TIME_1 = "location_time_1";
    public static final String LOCATION_TIME_2 = "location_time_2";
    ...
    public static final String SUPER_MOON_RESET = "super_moon_reset";
    public static final String SUPER_MOON_WINDOW = "super_moon_window";
    ...
    public static final int TIME_TYPE_EXTEND_1 = 2;
    public static final int TIME_TYPE_EXTEND_2 = 3;
    public static final int TIME_TYPE_LOCATION = 4;
    public static final int TIME_TYPE_LOCATION_TIME_1 = 5;
    public static final int TIME_TYPE_LOCATION_TIME_2 = 6;
    public static final int TIME_TYPE_LONGITUDE_LATITUDE = 7;
    ...
    public static float calcSuperMoonScale() {
        Rect displayRect = Util.getDisplayRect();
        Size bitmapSize = Util.getBitmapSize(R.drawable.ic_wp_super_moon_window);
        float f = 1.0f;
        if (!(displayRect.right - displayRect.left == bitmapSize.getWidth() || displayRect.bottom - displayRect.top == bitmapSize.getHeight())) {
            f = ((float) (displayRect.right - displayRect.left)) / (((float) bitmapSize.getWidth()) * 1.0f);
        }
        StringBuilder sb = new StringBuilder();
        sb.append("calcSuperMoonScaleSize rect:");
        sb.append(displayRect);
        sb.append(" size:");
        sb.append(bitmapSize);
        sb.append(" mSuperMoonScale:");
        sb.append(f);
        Log.d("WatermarkConstant", sb.toString());
        return f;
    }
}
