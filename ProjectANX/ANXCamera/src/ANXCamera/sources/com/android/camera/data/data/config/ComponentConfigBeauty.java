...
public class ComponentConfigBeauty extends ComponentData {
    ...
    public String getComponentValue(int i) {
        ...
        String str;
        if (isClosed(i)) {
            componentValue = BeautyConstant.LEVEL_CLOSE;
            str = "1: getComponentValue()";
        } else {
            componentValue = super.getComponentValue(i);
            logd("2: getComponentValue()", i, componentValue);
            str = "3: getComponentValue()";
        }
        logd(str, i, componentValue);
