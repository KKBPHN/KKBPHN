...
public class V6PreviewPanel extends V6RelativeLayout implements OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.v6_video_btn_play) {
            PlayVideoProtocol playVideoProtocol = (PlayVideoProtocol) ModeCoordinatorImpl.getInstance().getAttachProtocol(167);
            if (playVideoProtocol != null) {
    ...
    public void onResume() {
        ...
        setVisibility(((ActivityBase) getContext()).getCameraIntentManager().isScanQRCodeIntent() ? 4 : 0);
    }
