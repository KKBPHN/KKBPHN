...
public class UpdateConstant {
    ...
    @UpdateType
    public static final int[] AMBILIGHT_TYPES_ON_PREVIEW_SUCCESS = {24, 29, 35, 19, 9, 14, 25, 54, 70};
    @UpdateType
    public static final int[] CAMERA_TYPES_INIT = {24, 55, 44, 1, 22, 74, 82, 63, 15, 16, 6, TYPE_CAMERA_SESSION_PARAMS};
    @UpdateType
    public static final int[] CAMERA_TYPES_MANUALLY = {6, 16, 15, 63};
    @UpdateType
    public static final int[] CAMERA_TYPES_ON_PREVIEW_SUCCESS = {24, 2, 26, 27, 28, 29, 46, 47, 7, 8, 10, 11, 14, 19, 4, 13, 45, 5, 9, 20, 21, 34, 23, 25, 36, 73, 37, 42, 43, 48, 49, 52, 56, 30, 57, 61, 62, 66, 60, 70, 76, 78, 77, 84};
    @UpdateType
    ...
    @UpdateType
    public static final int[] SUPER_MOON_TYPES_INIT = {24, 55, 44, 1, 22, 74};
    @UpdateType
    public static final int[] SUPER_MOON_TYPES_ON_PREVIEW_SUCCESS = {24, 26, 27, 28, 29, 7, 8, 14, 19, 9, 20, 21, 34, 25, 36, 73, 42, 48, 30, 61, 62, 66, 70};
    public static final int TYPE_AI_ENHANCED_VIDEO = 85;
    public static final int TYPE_AI_SCENE = 36;
    public static final int TYPE_AI_SHUTTER = 82;
    ...
    public static final int TYPE_ASD_AI_WATERMARK = 89;
    ...
    public static final int TYPE_CAMERA_SESSION_PARAMS = 51966;
    ...
    public static final int TYPE_HDR10_VIDEO = 80;
    public static final int TYPE_HFR_DEFLICKER = 53;
    public static final int TYPE_HIGHQUALITY_PREFERRED = 84;
    public static final int TYPE_HISTOGRAM_STATS = 75;
    public static final int TYPE_INIT_AI_WATERMARK = 88;
    ...
    public static final int TYPE_SWITCH_ASD = 73;
    ...
    public static final int TYPE_VIDEO_BOKEH_WITH_COLOR_RETENTION = 81;
    ...
    @UpdateType
    public static final int[] VIDEO_TYPES_INIT = {24, 55, 19, 1, 60, 63, 11, TYPE_CAMERA_SESSION_PARAMS};
    @UpdateType
    public static final int[] VIDEO_TYPES_ON_PREVIEW_SUCCESS = {24, 29, 13, 35, 19, 47, 31, 5, 9, 10, 14, 25, 52, 53, 67, 68, 69, 60, 75, 65, 80, 81, 85};
    @UpdateType
    public static final int[] VIDEO_TYPES_RECORD = {19, 31, 40, 35, 33, 80};
    @UpdateType
