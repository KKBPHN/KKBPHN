...
public interface ILive {
    ...
    public interface ILivePlayer {
        ...
        void init(int i, int i2, int i3, int i4, List list, String str);
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<com.android.camera.module.impl.component.ILive$ILiveSegmentData>, for r4v0, types: [java.util.List, java.util.List<com.android.camera.module.impl.component.ILive$ILiveSegmentData>] */
