...
public class FuncFaceDetect extends FuncPreviewMetadata {
    private static final String TAG = "FuncFaceDetect";
    private WeakReference mFaceCallbackReference;
    private FaceAnalyzeInfo mFaceInfo;
    private boolean mNeedFaceInfo = CameraSettings.isFrontCamera();

    public FuncFaceDetect(WeakReference weakReference, WeakReference weakReference2) {
        super(weakReference);
        this.mFaceCallbackReference = weakReference2;
    }
