...
public class KaleidoscopeMenu extends AbBottomMenu implements OnClickListener {
    private static final int KALEIDOSCOPE_TYPE = 0;
    private SparseArray mKaleidoscopeMenuTabList;
    ...
    public SparseArray getMenuData() {
        SparseArray sparseArray = this.mKaleidoscopeMenuTabList;
        if (sparseArray != null) {
            return sparseArray;
        }
