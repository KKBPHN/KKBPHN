...
public class CameraFocusAnimateDrawable extends Drawable implements Animatable {
    ...
    public void draw(@NonNull Canvas canvas) {
        if (!(canvas == null || this.mMiddleX == -1.0f || this.mMiddleY == -1.0f)) {
            ...
            if (this.mSuccessFlag == 5) {
                ...
                this.mPaintEvText.setCurrentAlpha(m.br);
            } else {
    ...
    public void startEvAdjustAlphaAnim() {
        this.mEvAdjustAlphaAnimator.setIntValues(new int[]{204, 0});
        this.mEvAdjustAlphaAnimator.setDuration(200);
        this.mEvAdjustAlphaAnimator.setInterpolator(new CubicEaseOutInterpolator());
        this.mEvAdjustAlphaAnimator.addUpdateListener(new O000000o(this));
        ...
        this.mTouchDownAnimator.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (access$300 != 1) {
                    CameraFocusAnimateDrawable cameraFocusAnimateDrawable = CameraFocusAnimateDrawable.this;
                    if (access$300 != 3) {
                        cameraFocusAnimateDrawable.startFocusingAnimation();
                    } else {
                        cameraFocusAnimateDrawable.startFocusFailAnimation();
                    }
                } else {
                    CameraFocusAnimateDrawable cameraFocusAnimateDrawable2 = CameraFocusAnimateDrawable.this;
                    cameraFocusAnimateDrawable2.startFocusSuccessAnimation(cameraFocusAnimateDrawable2.mSuccessFlag, CameraFocusAnimateDrawable.this.mIsTouchFocus);
                }
            }
