...
public class CameraBackupSettings {
    ...
    static final PrefEntry[] PREF_ENTRIES = {PrefEntry.createIntEntry("version", CameraSettings.KEY_VERSION), PrefEntry.createBoolEntry(KEY_RECORD_LOCATION, CameraSettings.KEY_RECORD_LOCATION), PrefEntry.createBoolEntry(KEY_CAMERA_SOUND, CameraSettings.KEY_CAMERA_SOUND), PrefEntry.createBoolEntry(KEY_CAMERA_PROXIMITY_LOCK, CameraSettings.KEY_CAMERA_PROXIMITY_LOCK), PrefEntry.createBoolEntry(KEY_PRIORITY_STORAGE, CameraSettings.KEY_PRIORITY_STORAGE), PrefEntry.createBoolEntry(KEY_RETAIN_CAMERA_MODE, CameraSettings.KEY_RETAIN_CAMERA_MODE), PrefEntry.createStringEntry(KEY_CAMERA_SNAP, CameraSettings.KEY_CAMERA_SNAP), PrefEntry.createBoolEntry(KEY_CAPTURE_WHEN_STABLE, CameraSettings.KEY_CAPTURE_WHEN_STABLE), PrefEntry.createBoolEntry("watermark", "pref_time_watermark_key"), PrefEntry.createBoolEntry(KEY_DUALCAMERA_WATERMARK, "pref_dualcamera_watermark_key"), PrefEntry.createBoolEntry(KEY_CAMERA_USER_WATERMARK, "user_define_watermark_key"), PrefEntry.createBoolEntry(KEY_AUTO_CHROMA_FLASH, CameraSettings.KEY_AUTO_CHROMA_FLASH), PrefEntry.createBoolEntry(KEY_REFERENCE_LINE, CameraSettings.KEY_REFERENCE_LINE), PrefEntry.createBoolEntry(KEY_FOCUS_SHOOT, "pref_camera_focus_shoot_key"), PrefEntry.createBoolEntry(KEY_SCAN_QRCODE, CameraSettings.KEY_SCAN_QRCODE), PrefEntry.createBoolEntry(KEY_CAMERA_ASD_NIGHT, CameraSettings.KEY_CAMERA_ASD_NIGHT), PrefEntry.createBoolEntry(KEY_CAMERA_GROUPSHOT_PRIMITIVE, CameraSettings.KEY_CAMERA_GROUPSHOT_PRIMITIVE), PrefEntry.createStringEntry(KEY_LONG_PRESS_SHUTTER, CameraSettings.KEY_LONG_PRESS_SHUTTER), PrefEntry.createStringEntry(KEY_LONG_PRESS_SHUTTER_FEATURE, CameraSettings.KEY_LONG_PRESS_SHUTTER_FEATURE), PrefEntry.createStringEntry(KEY_FRONT_MIRROR, CameraSettings.KEY_FRONT_MIRROR), PrefEntry.createStringEntry(KEY_JPEG_QUALITY, CameraSettings.KEY_JPEG_QUALITY), PrefEntry.createBoolEntry(KEY_HEIC_FORMAT, CameraSettings.KEY_HEIC_FORMAT), PrefEntry.createBoolEntry(KEY_CAMERA_LYING_TIP_SWITCH, CameraSettings.KEY_CAMERA_LYING_TIP_SWITCH), PrefEntry.createBoolEntry(KEY_MOVIE_SOLID, CameraSettings.KEY_MOVIE_SOLID), PrefEntry.createStringEntry(KEY_VIDEO_ENCODER, CameraSettings.KEY_VIDEO_ENCODER), PrefEntry.createStringEntry(KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL, CameraSettings.KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL), PrefEntry.createBoolEntry(KEY_FACE_DETECTION, CameraSettings.KEY_FACE_DETECTION), PrefEntry.createBoolEntry(KEY_FINGERPRINT_CAPTURE, CameraSettings.KEY_FINGERPRINT_CAPTURE), PrefEntry.createStringEntry(KEY_VOLUME_CAMERA_FUNCTION, CameraSettings.KEY_VOLUME_CAMERA_FUNCTION), PrefEntry.createStringEntry(KEY_VOLUME_VIDEO_FUNCTION, CameraSettings.KEY_VOLUME_VIDEO_FUNCTION), PrefEntry.createStringEntry(KEY_VOLUME_PRO_VIDEO_FUNCTION, CameraSettings.KEY_VOLUME_PRO_VIDEO_FUNCTION), PrefEntry.createStringEntry(KEY_VOLUME_LIVE_FUNCTION, CameraSettings.KEY_VOLUME_LIVE_FUNCTION), PrefEntry.createStringEntry(KEY_ANTIBANDING, CameraSettings.KEY_ANTIBANDING), PrefEntry.createStringEntry(KEY_QC_CONTRAST, CameraSettings.KEY_QC_CONTRAST), PrefEntry.createStringEntry(KEY_QC_SATURATION, CameraSettings.KEY_QC_SATURATION), PrefEntry.createStringEntry(KEY_QC_SHARPNESS, CameraSettings.KEY_QC_SHARPNESS), PrefEntry.createStringEntry(KEY_WHITE_BALANCE, CameraSettings.KEY_WHITE_BALANCE), PrefEntry.createStringEntry("focus_position", CameraSettings.KEY_QC_FOCUS_POSITION), PrefEntry.createStringEntry(KEY_QC_EXPOSURETIME, CameraSettings.KEY_QC_EXPOSURETIME), PrefEntry.createStringEntry(KEY_QC_ISO, CameraSettings.KEY_QC_ISO), PrefEntry.createIntEntry(KEY_QC_MANUAL_WHITEBALANCE_VALUE, "pref_qc_manual_whitebalance_k_value_key"), PrefEntry.createStringEntry(KEY_FACE_BEAUTY, "pref_beautify_level_key_capture"), PrefEntry.createStringEntry(KEY_FACE_BEAUTY_SWITCH, CameraSettings.KEY_FACE_BEAUTY_SWITCH), PrefEntry.createIntEntry(KEY_BEAUTIFY_SLIM_FACE_RATIO, "pref_beautify_slim_face_ratio_key"), PrefEntry.createIntEntry(KEY_BEAUTIFY_SKIN_SMOOTH_RATIO, "pref_beautify_skin_smooth_ratio_key"), PrefEntry.createIntEntry(KEY_BEAUTIFY_SKIN_COLOR_RATIO, "pref_beautify_skin_color_ratio_key"), PrefEntry.createIntEntry(KEY_BEAUTIFY_ENLARGE_EYE_RATIO, "pref_beautify_enlarge_eye_ratio_key")};
}
