...
public class V28Utils {
    ...
    public static void createCaptureSessionWithSessionConfiguration(CameraDevice cameraDevice, int i, InputConfiguration inputConfiguration, List list, CaptureRequest captureRequest, StateCallback stateCallback, final Handler handler) {
