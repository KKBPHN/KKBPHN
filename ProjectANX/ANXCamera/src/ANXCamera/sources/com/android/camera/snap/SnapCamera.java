...
public class SnapCamera implements OnErrorListener, OnInfoListener {
    ...
    private final OnImageAvailableListener mPhotoAvailableListener = new OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader imageReader) {
            try {
                ...
                Log.e(SnapCamera.TAG, e.getMessage(), (Throwable) e);
            } catch (Throwable th) {
                r1.addSuppressed(th);
            }
        }
        ...
        try {
            ...
            if (isCamcorder()) {
                ...
                if (CamcorderProfile.hasProfile(this.mCameraId, preferVideoQuality)) {
                    camcorderProfile = CamcorderProfile.get(this.mCameraId, preferVideoQuality);
                } else {
                    String str = TAG;
                    StringBuilder sb = new StringBuilder();
                ...
                CameraSize bestPictureSize = PictureSizeManager.getBestPictureSize(163);
    ...
    private void initOrientationListener() {
        this.mOrientationListener = new OrientationEventListener(this.mContext, C0124O00000oO.OOoo0OO() ? 2 : 3) {
    ...
    public void onPictureTaken(byte[] bArr) {
        try {
            ...
            sb.append(SUFFIX);
            Uri addImageForSnapCamera = Storage.addImageForSnapCamera(this.mContext, sb.toString(), System.currentTimeMillis(), LocationManager.instance().getCurrentLocation(), ExifHelper.getOrientation(bArr), bArr, this.mWidth, this.mHeight, false, false, false, null, getPictureInfo());
    ...
    private void playSound() {
        ...
        if (miuiCameraSound != null && CameraSettings.isCameraSoundOpen()) {
    ...
    private void setRecorderOrientationHint() {
        ...
        if (this.mOrientation != -1) {
            sensorOrientation = (this.mCameraCapabilities.getFacing() == 0 ? (sensorOrientation - this.mOrientation) + m.cQ : sensorOrientation + this.mOrientation) % m.cQ;
        }
        String str = TAG;
        StringBuilder sb = new StringBuilder();
    ...
    private void setupMediaRecorder() {
        ...
        if (VideoModule.VIDEO_MAX_SINGLE_FILE_SIZE < availableSpace && C0122O00000o.instance().OO0o0O0()) {
            String str = TAG;
        ...
        try {
            ...
            sb8.append(sb4);
            Log.e(str3, sb8.toString(), (Throwable) e);
        } catch (Throwable th) {
        ...
        if (this.mMediaRecorder != null) {
            if (this.mRecording) {
                try {
                    ...
                    Log.w(TAG, "mMediaRecorder stop failed", (Throwable) e);
                }
            }
                            ...
                            public void onCaptureStarted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, long j, long j2) {
                                if (!SnapCamera.this.mRecording) {
                                    try {
                                        ...
                                        sb.append(e.getMessage());
                                        Log.e(access$100, sb.toString(), (Throwable) e);
                                        e.printStackTrace();
                                        SnapCamera.this.stopCamcorder();
                                    }
    ...
    public synchronized void takeSnap() {
        if (this.mCameraDevice == null) {
            ...
            try {
                ...
                if (C0122O00000o.instance().OO0oOo()) {
