...
public class DiskBasedCache implements Cache {
    ...
    class CacheHeader {
        ...
        private static List getAllResponseHeaders(Entry entry) {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<com.android.volley.Header>, for r2v0, types: [java.util.List<com.android.volley.Header>, java.util.List] */
