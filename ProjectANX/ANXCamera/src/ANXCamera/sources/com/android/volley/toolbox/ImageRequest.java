...
public class ImageRequest extends Request {
    ...
    @Deprecated
    public ImageRequest(String str, Listener listener, int i, int i2, Config config, ErrorListener errorListener) {
        this(str, listener, i, i2, ScaleType.CENTER_INSIDE, config, errorListener);
    }

    public ImageRequest(String str, Listener listener, int i, int i2, ScaleType scaleType, Config config, @Nullable ErrorListener errorListener) {
    ...
    /* JADX WARNING: type inference failed for: r5v1, types: [com.android.volley.Request] */
    ...
    public Response parseNetworkResponse(NetworkResponse networkResponse) {
        synchronized (sDecodeLock) {
            try {
                this = this;
                this = doParse(networkResponse);
                r5 = this;
            } catch (OutOfMemoryError e) {
                VolleyLog.e("Caught OOM for %d byte image, url=%s", Integer.valueOf(networkResponse.data.length), r5.getUrl());
