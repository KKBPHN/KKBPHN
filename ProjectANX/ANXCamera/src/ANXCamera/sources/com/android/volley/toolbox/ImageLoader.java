...
public class ImageLoader {
    ...
    class BatchedImageRequest {
        /* access modifiers changed from: private */
        public final List mContainers = new ArrayList();
    ...
    public Request makeImageRequest(String str, int i, int i2, ScaleType scaleType, final String str2) {
        ImageRequest imageRequest = new ImageRequest(str, new Listener() {
