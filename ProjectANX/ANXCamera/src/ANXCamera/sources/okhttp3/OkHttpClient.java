...
public class OkHttpClient implements Cloneable, Factory, WebSocket.Factory {
    static final List DEFAULT_CONNECTION_SPECS = Util.immutableList((Object[]) new ConnectionSpec[]{ConnectionSpec.MODERN_TLS, ConnectionSpec.CLEARTEXT});
    static final List DEFAULT_PROTOCOLS = Util.immutableList((Object[]) new Protocol[]{Protocol.HTTP_2, Protocol.HTTP_1_1});
    ...
    OkHttpClient(Builder builder) {
        ...
        if (builder.sslSocketFactory != null || !z) {
            ...
            certificateChainCleaner2 = CertificateChainCleaner.get(systemDefaultTrustManager);
        }
