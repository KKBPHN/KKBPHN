...
public final class Handshake {
    ...
    private Handshake(TlsVersion tlsVersion2, CipherSuite cipherSuite2, List list, List list2) {
    ...
    public static Handshake get(SSLSession sSLSession) {
        ...
        if (cipherSuite2 != null) {
            ...
            if (protocol != null) {
                ...
                List immutableList = certificateArr != null ? Util.immutableList((Object[]) certificateArr) : Collections.emptyList();
                Certificate[] localCertificates2 = sSLSession.getLocalCertificates();
                return new Handshake(forJavaName2, forJavaName, immutableList, localCertificates2 != null ? Util.immutableList((Object[]) localCertificates2) : Collections.emptyList());
            }
    ...
    public static Handshake get(TlsVersion tlsVersion2, CipherSuite cipherSuite2, List list, List list2) {
        if (tlsVersion2 == null) {
