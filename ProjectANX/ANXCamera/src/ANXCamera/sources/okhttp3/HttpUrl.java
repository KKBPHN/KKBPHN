                ...
                while (true) {
                    ...
                    if (charAt == 65535 || charAt == c2 || charAt == '/' || charAt == '\\' || charAt == c) {
                        ...
                        if (charAt == '@') {
                            String str3 = "%40";
                            if (!z) {
                                int delimiterOffset2 = Util.delimiterOffset(str2, i3, delimiterOffset, (char) com.android.camera.Util.ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR);
        ...
        public String toString() {
            ...
            if (!this.encodedUsername.isEmpty() || !this.encodedPassword.isEmpty()) {
                ...
                if (!this.encodedPassword.isEmpty()) {
                    sb.append(com.android.camera.Util.ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR);
