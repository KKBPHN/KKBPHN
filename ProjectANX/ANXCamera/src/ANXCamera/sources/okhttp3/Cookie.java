...
public final class Cookie {
    ...
    static Cookie parse(long j, HttpUrl httpUrl, String str) {
        ...
        while (i < length) {
            ...
            if (trimSubstring3.equalsIgnoreCase("expires")) {
                ...
                if (trimSubstring3.equalsIgnoreCase("domain")) {
                    str8 = parseDomain(trimSubstring4);
                    z4 = false;
        ...
        if (j3 != Long.MIN_VALUE) {
            ...
            Cookie cookie2 = new Cookie(trimSubstring, trimSubstring2, j2, str2, str5, z, z2, z4, z3);
            return cookie2;
        }
        j2 = j5;
        host = httpUrl.host();
        ...
        str5 = str3;
        Cookie cookie22 = new Cookie(trimSubstring, trimSubstring2, j2, str2, str5, z, z2, z4, z3);
        return cookie22;
    }
