...
public final class RealInterceptorChain implements Chain {
    ...
    public RealInterceptorChain(List list, StreamAllocation streamAllocation2, HttpCodec httpCodec2, RealConnection realConnection, int i, Request request2, Call call2, EventListener eventListener2, int i2, int i3, int i4) {
