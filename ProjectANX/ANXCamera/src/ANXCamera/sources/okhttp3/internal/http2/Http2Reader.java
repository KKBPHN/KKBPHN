...
final class Http2Reader implements Closeable {
    ...
    final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() {
            ...
            byte readByte = (byte) (this.source.readByte() & -1);
            this.flags = (byte) (this.source.readByte() & -1);
    ...
    private void readData(Handler handler, int i, byte b, int i2) {
        ...
        if (i2 != 0) {
            ...
            if (!z) {
                if ((b & 8) != 0) {
                    s = (short) (this.source.readByte() & -1);
                }
    ...
    static int readMedium(BufferedSource bufferedSource) {
        return (bufferedSource.readByte() & -1) | ((bufferedSource.readByte() & -1) << 16) | ((bufferedSource.readByte() & -1) << 8);
    }
    ...
    private void readPriority(Handler handler, int i) {
        int readInt = this.source.readInt();
        handler.priority(i, readInt & Integer.MAX_VALUE, (this.source.readByte() & -1) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    public boolean nextFrame(boolean z, Handler handler) {
        try {
            ...
            byte readByte = (byte) (this.source.readByte() & -1);
            if (!z || readByte == 4) {
                byte readByte2 = (byte) (this.source.readByte() & -1);
