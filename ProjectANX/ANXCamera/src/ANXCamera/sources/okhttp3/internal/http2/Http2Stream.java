...
public final class Http2Stream {
    ...
    Http2Stream(int i, Http2Connection http2Connection, boolean z, boolean z2, List list) {
    ...
    /* access modifiers changed from: 0000 */
    public void receiveHeaders(List list) {
        boolean z;
        synchronized (this) {
            z = true;
    ...
    public void sendResponseHeaders(List list, boolean z) {
        if (list != null) {
            boolean z2 = false;
            synchronized (this) {
                this.hasResponseHeaders = true;
    ...
    /* JADX INFO: finally extract failed */
    public synchronized List takeResponseHeaders() {
        List list;
        if (isLocallyInitiated()) {
