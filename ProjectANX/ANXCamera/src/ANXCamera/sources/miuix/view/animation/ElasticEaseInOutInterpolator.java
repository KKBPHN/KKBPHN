...
public class ElasticEaseInOutInterpolator implements Interpolator {
    ...
    public float getInterpolation(float f) {
        ...
        float f6 = f5 - 1.0f;
        return i < 0 ? ((float) (((double) f4) * Math.pow(2.0d, (double) (10.0f * f6)) * Math.sin((((double) (f6 - f2)) * 6.283185307179586d) / ((double) f3)))) * -0.5f : (float) ((((double) f4) * Math.pow(2.0d, (double) (-10.0f * f6)) * Math.sin((((double) (f6 - f2)) * 6.283185307179586d) / ((double) f3)) * 0.5d) + 1.0d);
    }
}
