...
public class ListenerNotifier {
    ...
    private static BaseNotifier[] sNotifiers = {new BaseNotifier() {
        ...
        public void doNotify(ListenerNode listenerNode, Object obj, Collection collection) {
    ...
    private ConcurrentLinkedQueue mPendingList = new ConcurrentLinkedQueue();
    ...
    abstract class BaseNotifier {
        ...
        public abstract void doNotify(ListenerNode listenerNode, Object obj, Collection collection);

        /* access modifiers changed from: 0000 */
        /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.Collection, code=java.util.Collection<miuix.animation.listener.UpdateInfo>, for r6v0, types: [java.util.Collection, java.util.Collection<miuix.animation.listener.UpdateInfo>] */
    ...
    class NotifyData {
        ConcurrentLinkedQueue updateList = new ConcurrentLinkedQueue();
    ...
    abstract class SingleNotifier extends BaseNotifier {
        ...
        /* access modifiers changed from: 0000 */
        /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.Collection, code=java.util.Collection<miuix.animation.listener.UpdateInfo>, for r4v0, types: [java.util.Collection, java.util.Collection<miuix.animation.listener.UpdateInfo>] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void doNotify(ListenerNode listenerNode, Object obj, Collection<UpdateInfo> collection) {
            for (UpdateInfo doNotify : collection) {
    ...
    private void executePendingList() {
        while (!this.mPendingList.isEmpty()) {
            this.mCurNotify = (PendingNotify) this.mPendingList.poll();
    ...
    private void notifyByType(int i, Object obj, UpdateInfo updateInfo, Collection collection) {
        if (getNodeCount() != 0) {
            ...
            if (pendingNotify == null) {
                ...
                while (it.hasNext()) {
                    if (((PendingNotify) it.next()).isSame(obj, i)) {
                        return;
                    }
                }
