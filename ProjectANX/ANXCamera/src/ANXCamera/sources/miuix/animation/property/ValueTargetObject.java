...
public class ValueTargetObject {
    ...
    public boolean equals(Object obj) {
        ...
        return obj3 != null ? Objects.equals(obj3, valueTargetObject.mTempObj) : Objects.equals(getRealObject(), valueTargetObject.getRealObject());
    }

    public Object getPropertyValue(String str, Class cls) {
        Object realObject = getRealObject();
        if (this.mTempObj != realObject) {
            Object invokeGetter = invokeGetter(str, cls, realObject);
            if (invokeGetter != null) {
                return invokeGetter;
            }
            Field field = getField(realObject, str, cls);
            if (field != null) {
                return getValueByField(realObject, field);
            }
        }
    ...
    public void setPropertyValue(String str, Class cls, Object obj) {
        ...
        if (this.mTempObj != realObject) {
            ...
            if (method != null) {
                invokeMethod(realObject, method, obj);
                return;
            }
            Field field = getField(realObject, str, cls);
            if (field != null) {
                setValueByField(realObject, field, obj);
                return;
            }
        }
