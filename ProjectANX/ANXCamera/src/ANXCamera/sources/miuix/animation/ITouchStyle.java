...
public interface ITouchStyle extends IStateContainer {
    ...
    void handleTouchOf(View view, OnClickListener onClickListener, OnLongClickListener onLongClickListener, AnimConfig... animConfigArr);

    void handleTouchOf(View view, OnClickListener onClickListener, AnimConfig... animConfigArr);
