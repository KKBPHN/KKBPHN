...
public class DirectIndexedFile {
    ...
    /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type = new int[Type.values().length];
        ...
        static {
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.STRING.ordinal()] = 1;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.BYTE_ARRAY.ordinal()] = 2;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.SHORT_ARRAY.ordinal()] = 3;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.INTEGER_ARRAY.ordinal()] = 4;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.LONG_ARRAY.ordinal()] = 5;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.BYTE.ordinal()] = 6;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.SHORT.ordinal()] = 7;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.INTEGER.ordinal()] = 8;
            $SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[Type.LONG.ordinal()] = 9;
        }
    }
        ...
        private int writeOffsets(DataOutput dataOutput, List list) {
            ...
            if (dataOutput == null || this.mOffsetSize == 0 || this.mLengthSize == 0) {
                ...
                for (Object next : list) {
                    int i6 = AnonymousClass1.$SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[this.mType.ordinal()];
                    if (i6 == 1) {
            ...
            if (dataOutput != null) {
                ...
                for (Object next2 : list) {
                    ...
                    int i8 = AnonymousClass1.$SwitchMap$miuix$core$util$DirectIndexedFile$DataItemDescriptor$Type[this.mType.ordinal()];
                    if (i8 == 1) {
                        b = this.mLengthSize;
            ...
            try {
                ...
                for (int i = 0; i < this.mHeader.mDescriptionOffsets.length; i++) {
                    ...
                    for (int i3 = 0; i3 < readInt2; i3++) {
                        ...
                        indexData.mSizeOfItems = indexData.mSizeOfItems + this.mIndexData[i].mDataItemDescriptions[i3].mIndexSize;
                    }
