...
public final class ViewParentCompat {
    ...
    public static void onNestedScroll(ViewParent viewParent, View view, int i, int i2, int i3, int i4, int i5, @NonNull int[] iArr) {
        ...
        } else if (viewParent2 instanceof androidx.core.view.NestedScrollingParent3) {
            ((androidx.core.view.NestedScrollingParent3) viewParent2).onNestedScroll(view, i, i2, i3, i4, i5, iArr);
        } else {
            iArr[0] = iArr[0] + i3;
            iArr[1] = iArr[1] + i4;
            if (viewParent2 instanceof NestedScrollingParent2) {
                ((NestedScrollingParent2) viewParent2).onNestedScroll(view, i, i2, i3, i4, i5);
            } else if (viewParent2 instanceof androidx.core.view.NestedScrollingParent2) {
                ((androidx.core.view.NestedScrollingParent2) viewParent2).onNestedScroll(view, i, i2, i3, i4, i5);
            } else if (i5 != 0) {
            } else {
                if (VERSION.SDK_INT >= 21) {
                    try {
                ...
                } else if (viewParent2 instanceof miui.core.view.NestedScrollingParent) {
                    ((miui.core.view.NestedScrollingParent) viewParent2).onNestedScroll(view, i, i2, i3, i4);
                }
            }
        }
    }
