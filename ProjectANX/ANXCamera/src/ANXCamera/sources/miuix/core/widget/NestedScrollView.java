...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public void computeScroll() {
        ...
        if (!this.mScroller.isFinished()) {
            ...
            while (parent != null && ((!(parent instanceof NestedCurrentFling) || !((NestedCurrentFling) parent).onNestedCurrentFling(this.mScroller.getCurrVelocityX(), this.mScroller.getCurrVelocityY())) && (!(parent instanceof ViewGroup) || parent != findViewById))) {
            ...
            if (i2 != 0) {
                ...
                iArr[1] = 0;
                dispatchNestedScroll(0, scrollY2, 0, i3, this.mScrollOffset, 1, iArr);
            ...
            if (!this.mScroller.isFinished()) {
                ...
                stopNestedScroll(1);
                if (!this.mHasReachEdgeBeforeFling) {
                    HapticCompat.performHapticFeedback(this, HapticFeedbackConstants.MIUI_SCROLL_EDGE);
                }
            }
        }
    }
    ...
    public void fling(int i) {
        if (getChildCount() > 0) {
            this.mHasReachEdgeBeforeFling = !canScrollVertically(i > 0 ? 1 : -1);
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        View findFocus = findFocus();
        if (findFocus != null && this != findFocus && isViewDescendantOf(findFocus, this) && isWithinDeltaOfScreen(findFocus, 0, i4)) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0076, code lost:
        if (r10.mScroller.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L_0x0078;
     */
            ...
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        int[] iArr = this.mScrollConsumed;
                        iArr[1] = 0;
                        dispatchNestedScroll(0, scrollY2, 0, i7, this.mScrollOffset, 0, iArr);
                        int i8 = this.mLastMotionY;
                        int[] iArr2 = this.mScrollOffset;
                        this.mLastMotionY = i8 - iArr2[1];
                        this.mNestedYOffset += iArr2[1];
                        if (z) {
                            int i9 = i5 - this.mScrollConsumed[1];
                            ensureGlows();
                            int i10 = scrollY + i9;
                            if (i10 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float) i9) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    edgeEffect = this.mEdgeGlowBottom;
                                }
                                ...
                                if (i10 > i6) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) i9) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
                                    if (!this.mEdgeGlowTop.isFinished()) {
                                        edgeEffect = this.mEdgeGlowTop;
                                    }
                                }
                                EdgeEffect edgeEffect22 = this.mEdgeGlowTop;
                                ViewCompat.postInvalidateOnAnimation(this);
                            }
                            edgeEffect.onRelease();
                            EdgeEffect edgeEffect222 = this.mEdgeGlowTop;
                            ViewCompat.postInvalidateOnAnimation(this);
                        }
                    }
                }
    ...
    public final void smoothScrollTo(int i, int i2) {
        smoothScrollTo(i, i2, false);
    }

    /* access modifiers changed from: 0000 */
    public void smoothScrollTo(int i, int i2, boolean z) {
        smoothScrollBy(i - getScrollX(), i2 - getScrollY(), z);
    }
