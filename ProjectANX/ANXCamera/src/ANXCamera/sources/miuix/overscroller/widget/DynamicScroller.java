...
class DynamicScroller extends SplineOverScroller implements FinalValueListener {
    ...
    class OverScrollHandler {
        ...
        class Monitor implements OnAnimationUpdateListener {
            private Monitor() {
            }
    ...
    DynamicScroller(Context context) {
        ...
        this.mFlingAnimation = new FlingAnimation(this.mValue, (FinalValueListener) this);
    ...
    public boolean springback(int i, int i2, int i3) {
        ...
        dynamicScroller.doSpring(i4, i6, f, i7, i5);
        if (isFinished()) {
        }
    }
    ...
    public void updateStiffness(double d) {
        this.mSpringAnimation.getSpring().setStiffness(Math.abs(d) <= 5000.0d ? 246.7f : 130.5f);
    }
}
