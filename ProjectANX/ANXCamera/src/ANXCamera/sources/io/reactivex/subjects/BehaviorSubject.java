...
public final class BehaviorSubject extends Subject {
    ...
    final class BehaviorDisposable implements Disposable, NonThrowingPredicate {
    ...
    public BehaviorDisposable[] terminate(Object obj) {
        ...
        BehaviorDisposable[] behaviorDisposableArr2 = TERMINATED;
        if (behaviorDisposableArr != behaviorDisposableArr2) {
            behaviorDisposableArr = (BehaviorDisposable[]) this.subscribers.getAndSet(behaviorDisposableArr2);
            if (behaviorDisposableArr != TERMINATED) {
                setCurrent(obj);
            }
        }
