...
public final class SingleSubject extends Single implements SingleObserver {
    ...
    final class SingleDisposable extends AtomicReference implements Disposable {
    ...
    public boolean add(@NonNull SingleDisposable singleDisposable) {
    ...
    /* access modifiers changed from: 0000 */
    public void remove(@NonNull SingleDisposable singleDisposable) {
        SingleDisposable[] singleDisposableArr;
        SingleDisposable[] singleDisposableArr2;
        do {
            singleDisposableArr = (SingleDisposable[]) this.observers.get();
    ...
    public void subscribeActual(@NonNull SingleObserver singleObserver) {
