...
public abstract class Scheduler {
    ...
    final class DisposeTask implements Disposable, Runnable, SchedulerRunnableIntrospection {
    ...
    class PeriodicDirectTask implements Disposable, Runnable, SchedulerRunnableIntrospection {
        @NonNull
