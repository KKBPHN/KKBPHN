...
public abstract class Completable implements CompletableSource {
    ...
    public static Completable mergeArray(CompletableSource... completableSourceArr) {
        ObjectHelper.requireNonNull(completableSourceArr, "sources is null");
        return completableSourceArr.length == 0 ? complete() : completableSourceArr.length == 1 ? wrap(completableSourceArr[0]) : RxJavaPlugins.onAssembly((Completable) new CompletableMergeArray(completableSourceArr));
    }
    ...
    public final Flowable andThen(Publisher publisher) {
        ...
        return RxJavaPlugins.onAssembly((Flowable) new FlowableDelaySubscriptionOther(publisher, toFlowable()));
    }
    ...
    public final Maybe andThen(MaybeSource maybeSource) {
        ...
        return RxJavaPlugins.onAssembly((Maybe) new MaybeDelayWithCompletable(maybeSource, this));
    }
    ...
    public final Observable andThen(ObservableSource observableSource) {
        ...
        return RxJavaPlugins.onAssembly((Observable) new ObservableDelaySubscriptionOther(observableSource, toObservable()));
    }
    ...
    public final Single andThen(SingleSource singleSource) {
        ...
        return RxJavaPlugins.onAssembly((Single) new SingleDelayWithCompletable(singleSource, this));
    }

    @CheckReturnValue
    @Experimental
    @SchedulerSupport("none")
    public final Object as(@NonNull CompletableConverter completableConverter) {
    ...
    public final Single toSingle(Callable callable) {
        ...
        return RxJavaPlugins.onAssembly((Single) new CompletableToSingle(this, callable, null));
    }
    ...
    public final Single toSingleDefault(Object obj) {
        ...
        return RxJavaPlugins.onAssembly((Single) new CompletableToSingle(this, null, obj));
    }
