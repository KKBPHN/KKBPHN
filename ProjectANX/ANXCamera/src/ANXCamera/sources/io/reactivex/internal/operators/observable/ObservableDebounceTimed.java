...
public final class ObservableDebounceTimed extends AbstractObservableWithUpstream {
    ...
    final class DebounceTimedObserver implements Observer, Disposable {
        ...
        DebounceTimedObserver(Observer observer, long j, TimeUnit timeUnit, Worker worker2) {
    ...
    public ObservableDebounceTimed(ObservableSource observableSource, long j, TimeUnit timeUnit, Scheduler scheduler2) {
