...
public final class ObservableObserveOn extends AbstractObservableWithUpstream {
    ...
    final class ObserveOnObserver extends BasicIntQueueDisposable implements Observer, Runnable {
        ...
        ObserveOnObserver(Observer observer, Worker worker2, boolean z, int i) {
    ...
    public ObservableObserveOn(ObservableSource observableSource, Scheduler scheduler2, boolean z, int i) {
