...
public final class FlowableDelay extends AbstractFlowableWithUpstream {
    ...
    final class DelaySubscriber implements FlowableSubscriber, Subscription {
        ...
        DelaySubscriber(Subscriber subscriber, long j, TimeUnit timeUnit, Worker worker, boolean z) {
    ...
    public FlowableDelay(Flowable flowable, long j, TimeUnit timeUnit, Scheduler scheduler2, boolean z) {
        super(flowable);
        this.delay = j;
        this.unit = timeUnit;
    ...
    public void subscribeActual(Subscriber subscriber) {
        Subscriber serializedSubscriber = this.delayError ? subscriber : new SerializedSubscriber(subscriber);
        ...
        flowable.subscribe((FlowableSubscriber) delaySubscriber);
    }
}
