...
public final class ObservableCreate extends Observable {
    ...
    final class CreateEmitter extends AtomicReference implements ObservableEmitter, Disposable {
        private static final long serialVersionUID = -3434801548987643227L;
        final Observer observer;

        CreateEmitter(Observer observer2) {
    ...
    final class SerializedEmitter extends AtomicInteger implements ObservableEmitter {
        private static final long serialVersionUID = 4883307006032401862L;
        volatile boolean done;
        final ObservableEmitter emitter;
        final AtomicThrowable error = new AtomicThrowable();
        final SpscLinkedArrayQueue queue = new SpscLinkedArrayQueue(16);

        SerializedEmitter(ObservableEmitter observableEmitter) {
