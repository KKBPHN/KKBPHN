...
public class SchedulerWhen extends Scheduler implements Disposable {
    ...
    private final FlowableProcessor workerProcessor = UnicastProcessor.create().toSerialized();

    final class CreateWorkerFunction implements Function {
    ...
    class OnCompletedAction implements Runnable {
    ...
    final class QueueWorker extends Worker {
        private final FlowableProcessor actionProcessor;
        private final Worker actualWorker;
        private final AtomicBoolean unsubscribed = new AtomicBoolean();

        QueueWorker(FlowableProcessor flowableProcessor, Worker worker) {
    ...
    abstract class ScheduledAction extends AtomicReference implements Disposable {
        ScheduledAction() {
    ...
    final class SubscribedDisposable implements Disposable {
