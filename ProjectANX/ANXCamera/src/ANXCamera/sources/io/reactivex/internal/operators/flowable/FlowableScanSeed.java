...
public final class FlowableScanSeed extends AbstractFlowableWithUpstream {
    ...
    final class ScanSeedSubscriber extends AtomicInteger implements FlowableSubscriber, Subscription {
    ...
    public void subscribeActual(Subscriber subscriber) {
        try {
            ...
            this.source.subscribe((FlowableSubscriber) new ScanSeedSubscriber(subscriber, this.accumulator, call, Flowable.bufferSize()));
        } catch (Throwable th) {
            Exceptions.throwIfFatal(th);
