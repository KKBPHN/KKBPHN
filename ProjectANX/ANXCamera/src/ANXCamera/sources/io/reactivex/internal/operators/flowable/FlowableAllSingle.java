...
public final class FlowableAllSingle extends Single implements FuseToFlowable {
    ...
    final class AllSubscriber implements FlowableSubscriber, Disposable {
        final SingleObserver actual;
        boolean done;
        final Predicate predicate;
        Subscription s;

        AllSubscriber(SingleObserver singleObserver, Predicate predicate2) {
    ...
    public FlowableAllSingle(Flowable flowable, Predicate predicate2) {
