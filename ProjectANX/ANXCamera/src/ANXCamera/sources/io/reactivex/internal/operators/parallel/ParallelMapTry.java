...
public final class ParallelMapTry extends ParallelFlowable {
    ...
    final class ParallelMapTryConditionalSubscriber implements ConditionalSubscriber, Subscription {
    ...
    final class ParallelMapTrySubscriber implements ConditionalSubscriber, Subscription {
    ...
    public ParallelMapTry(ParallelFlowable parallelFlowable, Function function, BiFunction biFunction) {
