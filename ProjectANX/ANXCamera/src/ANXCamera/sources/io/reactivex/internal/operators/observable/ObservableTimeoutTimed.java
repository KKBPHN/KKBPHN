...
public final class ObservableTimeoutTimed extends AbstractObservableWithUpstream {
    ...
    final class TimeoutTimedObserver extends AtomicReference implements Observer, Disposable {
        ...
        TimeoutTimedObserver(Observer observer, long j, TimeUnit timeUnit, Worker worker2) {
    ...
    final class TimeoutTimedOtherObserver extends AtomicReference implements Observer, Disposable {
        ...
        TimeoutTimedOtherObserver(Observer observer, long j, TimeUnit timeUnit, Worker worker2, ObservableSource observableSource) {
            this.actual = observer;
            this.timeout = j;
            this.unit = timeUnit;
            this.worker = worker2;
    ...
    public ObservableTimeoutTimed(ObservableSource observableSource, long j, TimeUnit timeUnit, Scheduler scheduler2, ObservableSource observableSource2) {
