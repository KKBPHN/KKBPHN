...
public final class FlowableRange extends Flowable {
    ...
    public void subscribeActual(Subscriber subscriber) {
        subscriber.onSubscribe(subscriber instanceof ConditionalSubscriber ? new RangeConditionalSubscription((ConditionalSubscriber) subscriber, this.start, this.end) : new RangeSubscription(subscriber, this.start, this.end));
    }
}
