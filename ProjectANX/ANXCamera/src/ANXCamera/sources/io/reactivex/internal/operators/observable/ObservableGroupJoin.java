...
public final class ObservableGroupJoin extends AbstractObservableWithUpstream {
    ...
    final class GroupJoinDisposable extends AtomicInteger implements Disposable, JoinSupport {
    ...
    final class LeftRightEndObserver extends AtomicReference implements Observer, Disposable {
    ...
    final class LeftRightObserver extends AtomicReference implements Observer, Disposable {
        private static final long serialVersionUID = 1883890389173668373L;
        final boolean isLeft;
        final JoinSupport parent;
