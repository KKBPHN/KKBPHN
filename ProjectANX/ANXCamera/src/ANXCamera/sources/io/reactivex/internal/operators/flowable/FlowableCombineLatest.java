...
public final class FlowableCombineLatest extends Flowable {
    ...
    final class CombineLatestCoordinator extends BasicIntQueueSubscription {
    ...
    final class CombineLatestInnerSubscriber extends AtomicReference implements FlowableSubscriber {
