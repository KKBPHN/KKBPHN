...
public final class ObservableConcatMap extends AbstractObservableWithUpstream {
    ...
    final class ConcatMapDelayErrorObserver extends AtomicInteger implements Observer, Disposable {
        ...
        final Function mapper;
        final DelayErrorInnerObserver observer;
        SimpleQueue queue;
        int sourceMode;
        final boolean tillTheEnd;

        final class DelayErrorInnerObserver extends AtomicReference implements Observer {
            private static final long serialVersionUID = 2620149119579502636L;
            final Observer actual;
            final ConcatMapDelayErrorObserver parent;
        ...
        ConcatMapDelayErrorObserver(Observer observer2, Function function, int i, boolean z) {
    ...
    public void subscribeActual(Observer observer) {
        if (!ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.mapper)) {
            ...
            if (errorMode == ErrorMode.IMMEDIATE) {
                ...
                this.source.subscribe(new ConcatMapDelayErrorObserver(observer, this.mapper, this.bufferSize, errorMode == ErrorMode.END));
            }
        }
    }
}
