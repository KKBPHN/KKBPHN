...
public final class FlowableSkipLastTimed extends AbstractFlowableWithUpstream {
    ...
    final class SkipLastTimedSubscriber extends AtomicInteger implements FlowableSubscriber, Subscription {
        ...
        SkipLastTimedSubscriber(Subscriber subscriber, long j, TimeUnit timeUnit, Scheduler scheduler2, int i, boolean z) {
    ...
    public FlowableSkipLastTimed(Flowable flowable, long j, TimeUnit timeUnit, Scheduler scheduler2, int i, boolean z) {
        super(flowable);
        this.time = j;
        this.unit = timeUnit;
        this.scheduler = scheduler2;
    ...
    public void subscribeActual(Subscriber subscriber) {
        ...
        flowable.subscribe((FlowableSubscriber) skipLastTimedSubscriber);
    }
}
