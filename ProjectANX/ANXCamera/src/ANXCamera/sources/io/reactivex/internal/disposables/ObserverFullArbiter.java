...
public final class ObserverFullArbiter extends FullArbiterPad1 implements Disposable {
    ...
    public boolean onNext(Object obj, Disposable disposable) {
        if (this.cancelled) {
            return false;
        }
        SpscLinkedArrayQueue spscLinkedArrayQueue = this.queue;
        NotificationLite.next(obj);
        spscLinkedArrayQueue.offer(disposable, obj);
        drain();
        return true;
    }
