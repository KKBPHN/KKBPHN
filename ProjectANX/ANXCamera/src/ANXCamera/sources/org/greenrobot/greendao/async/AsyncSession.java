...
public class AsyncSession {
    ...
    private AsyncOperation enqueEntityOperation(OperationType operationType, Class cls, Object obj, int i) {
    ...
    public AsyncOperation deleteAll(Class cls) {
        return deleteAll(cls, 0);
    }

    public AsyncOperation deleteAll(Class cls, int i) {
    ...
    public AsyncOperation deleteInTx(Class cls, int i, Object... objArr) {
        return enqueEntityOperation(OperationType.DeleteInTxArray, cls, objArr, i);
    }

    public AsyncOperation deleteInTx(Class cls, Iterable iterable) {
        return deleteInTx(cls, iterable, 0);
    }

    public AsyncOperation deleteInTx(Class cls, Iterable iterable, int i) {
        return enqueEntityOperation(OperationType.DeleteInTxIterable, cls, iterable, i);
    }

    public AsyncOperation deleteInTx(Class cls, Object... objArr) {
        return deleteInTx(cls, 0, objArr);
    }
    ...
    public AsyncOperation insertInTx(Class cls, int i, Object... objArr) {
        return enqueEntityOperation(OperationType.InsertInTxArray, cls, objArr, i);
    }

    public AsyncOperation insertInTx(Class cls, Iterable iterable) {
        return insertInTx(cls, iterable, 0);
    }

    public AsyncOperation insertInTx(Class cls, Iterable iterable, int i) {
        return enqueEntityOperation(OperationType.InsertInTxIterable, cls, iterable, i);
    }

    public AsyncOperation insertInTx(Class cls, Object... objArr) {
        return insertInTx(cls, 0, objArr);
    }
    ...
    public AsyncOperation insertOrReplaceInTx(Class cls, int i, Object... objArr) {
        return enqueEntityOperation(OperationType.InsertOrReplaceInTxArray, cls, objArr, i);
    }

    public AsyncOperation insertOrReplaceInTx(Class cls, Iterable iterable) {
        return insertOrReplaceInTx(cls, iterable, 0);
    }

    public AsyncOperation insertOrReplaceInTx(Class cls, Iterable iterable, int i) {
        return enqueEntityOperation(OperationType.InsertOrReplaceInTxIterable, cls, iterable, i);
    }

    public AsyncOperation insertOrReplaceInTx(Class cls, Object... objArr) {
        return insertOrReplaceInTx(cls, 0, objArr);
    }
    ...
    public AsyncOperation updateInTx(Class cls, int i, Object... objArr) {
        return enqueEntityOperation(OperationType.UpdateInTxArray, cls, objArr, i);
    }

    public AsyncOperation updateInTx(Class cls, Iterable iterable) {
        return updateInTx(cls, iterable, 0);
    }

    public AsyncOperation updateInTx(Class cls, Iterable iterable, int i) {
        return enqueEntityOperation(OperationType.UpdateInTxIterable, cls, iterable, i);
    }

    public AsyncOperation updateInTx(Class cls, Object... objArr) {
        return updateInTx(cls, 0, objArr);
    }
