...
public final class DaoConfig implements Cloneable {
    ...
    private static Property[] reflectProperties(Class cls) {
    ...
    public void initIdentityScope(IdentityScopeType identityScopeType) {
        IdentityScope identityScopeObject;
        if (identityScopeType == IdentityScopeType.None) {
            identityScopeObject = null;
        } else if (identityScopeType == IdentityScopeType.Session) {
            identityScopeObject = this.keyIsNumeric ? new IdentityScopeLong() : new IdentityScopeObject();
        } else {
            StringBuilder sb = new StringBuilder();
        ...
        this.identityScope = identityScopeObject;
    }
