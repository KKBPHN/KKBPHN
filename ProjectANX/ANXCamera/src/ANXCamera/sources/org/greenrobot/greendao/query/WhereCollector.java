...
class WhereCollector {
    ...
    WhereCollector(AbstractDao abstractDao, String str) {
    ...
    /* access modifiers changed from: 0000 */
    public void addCondition(StringBuilder sb, List list, WhereCondition whereCondition) {
        checkCondition(whereCondition);
    ...
    /* access modifiers changed from: 0000 */
    public void appendWhereClause(StringBuilder sb, String str, List list) {
