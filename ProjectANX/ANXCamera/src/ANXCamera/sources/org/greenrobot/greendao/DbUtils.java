...
public class DbUtils {
    ...
    public static int executeSqlScript(Context context, Database database, String str) {
        return executeSqlScript(context, database, str, true);
    }

    public static int executeSqlScript(Context context, Database database, String str, boolean z) {
