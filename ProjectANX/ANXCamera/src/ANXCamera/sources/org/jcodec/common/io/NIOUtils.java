...
public class NIOUtils {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.lang.Iterable, code=java.lang.Iterable<java.nio.ByteBuffer>, for r3v0, types: [java.lang.Iterable<java.nio.ByteBuffer>, java.lang.Iterable] */
    ...
    public static void copy(ReadableByteChannel readableByteChannel, WritableByteChannel writableByteChannel, long j) {
    ...
    public static ByteBuffer fetchFromFileL(File file, int i) {
    ...
    public static String readPascalString(ByteBuffer byteBuffer) {
        return readString(byteBuffer, byteBuffer.get() & -1);
    }

    public static String readPascalStringL(ByteBuffer byteBuffer, int i) {
        ByteBuffer read = read(byteBuffer, i + 1);
        return Platform.stringFromBytes(toArray(read(read, Math.min(read.get() & -1, i))));
    }
