...
public class ReplaceMP4Editor {
    public void copy(File file, File file2, MP4Edit mP4Edit) {
    ...
    public void modifyOrReplace(File file, MP4Edit mP4Edit) {
        if (!new InplaceMP4Editor().modify(file, mP4Edit)) {
            replace(file, mP4Edit);
        }
    }

    public void replace(File file, MP4Edit mP4Edit) {
