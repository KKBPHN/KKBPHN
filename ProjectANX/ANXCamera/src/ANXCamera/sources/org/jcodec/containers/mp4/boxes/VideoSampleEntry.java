...
public class VideoSampleEntry extends SampleEntry {
    ...
    public static VideoSampleEntry videoSampleEntry(String str, Size size, String str2) {
        return createVideoSampleEntry(new Header(str), 0, 0, "jcod", 0, 768, (short) size.getWidth(), (short) size.getHeight(), 72, 72, 1, str2 != null ? str2 : "org/jcodec", 24, 1, -1);
    }
    ...
    public void doWrite(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(JCodecUtil2.asciiString(this.f4vendor), 0, 4);
    ...
    public void parse(ByteBuffer byteBuffer) {
        ...
        this.f4vendor = NIOUtils.readString(byteBuffer, 4);
