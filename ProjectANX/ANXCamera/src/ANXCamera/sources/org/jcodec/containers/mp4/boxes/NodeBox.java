...
public class NodeBox extends Box {
    ...
    public static Box[] findAll(Box box, Class cls, String str) {
        return findAllPath(box, cls, new String[]{str});
    }

    public static Box[] findAllPath(Box box, Class cls, String[] strArr) {
    ...
    public static void findBox(Box box, List list, Collection collection) {
        if (list.size() > 0) {
    ...
    public static Box[] findDeep(Box box, Class cls, String str) {
        ArrayList arrayList = new ArrayList();
        findDeepInner(box, cls, str, arrayList);
        return (Box[]) arrayList.toArray((Box[]) Array.newInstance(cls, 0));
    }

    public static void findDeepInner(Box box, Class cls, String str, List list) {
        if (box != null) {
    ...
    public static Box findFirst(NodeBox nodeBox, Class cls, String str) {
        return findFirstPath(nodeBox, cls, new String[]{str});
    }

    public static Box findFirstPath(NodeBox nodeBox, Class cls, String[] strArr) {
