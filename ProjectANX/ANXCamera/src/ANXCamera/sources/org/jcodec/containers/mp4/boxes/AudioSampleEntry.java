...
public class AudioSampleEntry extends SampleEntry {
    ...
    private static final List MATRIX_STEREO = Arrays.asList(new Label[]{Label.LeftTotal, Label.RightTotal});
    private static final List MONO = Arrays.asList(new Label[]{Label.Mono});
    private static final List STEREO = Arrays.asList(new Label[]{Label.Left, Label.Right});
    ...
    public static Set pcms = new HashSet();
    private static Map translationStereo = new HashMap();
    private static Map translationSurround = new HashMap();
    ...
    private ChannelLabel[] translate(Map map, Label[] labelArr) {
    ...
    public void doWrite(ByteBuffer byteBuffer) {
        ...
        byteBuffer.putInt(this.f3vendor);
    ...
    public AudioFormat getFormat() {
        AudioFormat audioFormat = new AudioFormat((int) this.sampleRate, calcSampleSize() << 3, this.channelCount, true, getEndian() == ByteOrder.BIG_ENDIAN);
        return audioFormat;
    }
    ...
    public void parse(ByteBuffer byteBuffer) {
        ...
        this.f3vendor = byteBuffer.getInt();
