...
public class MP4Util {
    ...
    public static Atom findFirstAtom(String str, SeekableByteChannel seekableByteChannel, long j, long j2) {
        ...
        while (j3 < seekableByteChannel.size() && j3 < j + j2) {
            ...
            if (read == null) {
                break;
            } else if (str.equals(read.getFourcc())) {
    ...
    public static List getRootAtoms(SeekableByteChannel seekableByteChannel) {
        long j = 0;
    ...
    public static MetaBox parseMetaChannel(SeekableByteChannel seekableByteChannel) {
    ...
    public static List parseMovieFragments(SeekableByteChannel seekableByteChannel) {
