...
public class SegmentTypeBox extends Box {
    private Collection compBrands = new LinkedList();
    ...
    public static SegmentTypeBox createSegmentTypeBox(String str, int i, Collection collection) {
    ...
    public Collection getCompBrands() {
