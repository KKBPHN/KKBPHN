...
public class MetaBox extends NodeBox {
    ...
    private void dropChildBox(List list, String str) {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<org.jcodec.containers.mp4.boxes.Box>, for r2v0, types: [java.util.List, java.util.List<org.jcodec.containers.mp4.boxes.Box>] */
    ...
    public void setItunesMeta(Map map) {
        Map map2;
        if (!map.isEmpty()) {
            LinkedHashMap linkedHashMap = new LinkedHashMap();
    ...
    public void setKeyedMeta(Map map) {
        if (!map.isEmpty()) {
