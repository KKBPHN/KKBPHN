...
public final class ChannelLayout {
    ...
    static {
        ...
        kCAFChannelLayoutTag_TMH_10_2_std = new ChannelLayout(9502736, new Label[]{Label.Left, Label.Right, Label.Center, label, label, label, Label.LeftSurround, Label.RightSurround, label2, label2, label2, label2, label2, Label.CenterSurround, Label.LFEScreen, Label.LFE2});
        Label label3 = Label.Mono;
        kCAFChannelLayoutTag_TMH_10_2_full = new ChannelLayout(9568277, new Label[]{Label.LeftCenter, Label.RightCenter, label3, label3, label3});
    }
