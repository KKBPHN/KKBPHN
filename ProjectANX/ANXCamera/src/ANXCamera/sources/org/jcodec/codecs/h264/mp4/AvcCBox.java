...
public class AvcCBox extends Box {
    ...
    private List ppsList = new ArrayList();
    private int profile;
    private int profileCompat;
    private List spsList = new ArrayList();
    ...
    public void parse(ByteBuffer byteBuffer) {
        ...
        this.profile = byteBuffer.get() & -1;
        this.profileCompat = byteBuffer.get() & -1;
        this.level = byteBuffer.get() & -1;
        this.nalLengthSize = (byteBuffer.get() & -1 & 3) + 1;
