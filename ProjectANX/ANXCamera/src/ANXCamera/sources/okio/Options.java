...
public final class Options extends AbstractList implements RandomAccess {
    ...
    private static void buildTrieRecursive(long j, Buffer buffer, int i, List list, int i2, int i3, List list2) {
        int i4;
        int i5;
        Buffer buffer2;
        int i6;
        ...
        if (i8 < i9) {
            ...
            if (i7 == byteString.size()) {
                ...
                i8++;
                byteString = (ByteString) list3.get(i8);
            }
            int i12 = i8;
            if (byteString.getByte(i7) != byteString2.getByte(i7)) {
                int i13 = 1;
                for (int i14 = i12 + 1; i14 < i9; i14++) {
                    if (((ByteString) list3.get(i14 - 1)).getByte(i7) != ((ByteString) list3.get(i14)).getByte(i7)) {
                        i13++;
                    }
                }
                ...
                int i15 = i12;
                while (i15 < i9) {
                    byte b = ((ByteString) list3.get(i15)).getByte(i7);
                    if (i15 == i12 || b != ((ByteString) list3.get(i15 - 1)).getByte(i7)) {
                        buffer3.writeInt((int) b & -1);
                    }
                    i15++;
                }
                ...
                int i16 = i12;
                while (i16 < i9) {
                    byte b2 = ((ByteString) list3.get(i16)).getByte(i7);
                    int i17 = i16 + 1;
                    int i18 = i17;
                    while (true) {
                        if (i18 >= i9) {
                            i5 = i9;
                            break;
                        } else if (b2 != ((ByteString) list3.get(i18)).getByte(i7)) {
                            i5 = i18;
                            break;
                        } else {
                            i18++;
                    ...
                    if (i17 == i5 && i7 + 1 == ((ByteString) list3.get(i16)).size()) {
                        buffer3.writeInt(((Integer) list4.get(i16)).intValue());
                        i6 = i5;
                        buffer2 = buffer4;
                    } else {
            ...
            long intCount2 = 1 + j + ((long) intCount(buffer)) + 2 + ((long) i19);
            ...
            while (true) {
                ...
                buffer3.writeInt((int) byteString.getByte(i21) & -1);
                i21++;
            }
            if (i12 + 1 != i9) {
            ...
            } else if (i4 == ((ByteString) list3.get(i12)).size()) {
                buffer3.writeInt(((Integer) list4.get(i12)).intValue());
            } else {
                throw new AssertionError();
            }
        } else {
