...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
        ...
        public final int seek(long j) {
            ...
            if (i >= 0) {
                ...
                if (j <= j3) {
                    ...
                    if (segment4 != null) {
                        long j5 = this.offset - ((long) (this.start - segment4.pos));
                        if (j5 > j) {
                            j3 = j5;
    ...
    public int readInt() {
        ...
        if (j >= 4) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 4) {
                return (readByte() & -1) | ((readByte() & -1) << 24) | ((readByte() & -1) << 16) | ((readByte() & -1) << 8);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & -1) << 24) | ((bArr[i3] & -1) << 16);
            int i5 = i4 + 1;
            byte b2 = b | ((bArr[i4] & -1) << 8);
            int i6 = i5 + 1;
            byte b3 = b2 | (bArr[i5] & -1);
            this.size = j - 4;
            if (i6 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    public short readShort() {
        ...
        if (j >= 2) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 2) {
                return (short) ((readByte() & -1) | ((readByte() & -1) << 8));
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & -1) << 8) | (bArr[i3] & -1);
            this.size = j - 2;
            if (i4 == i2) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        if (j >= 100000000) {
            i2 = j < 1000000000000L ? j < 10000000000L ? j < ExtraTextUtils.GB ? 9 : 10 : j < 100000000000L ? 11 : 12 : j < 1000000000000000L ? j < 10000000000000L ? 13 : j < 100000000000000L ? 14 : 15 : j < 100000000000000000L ? j < 10000000000000000L ? 16 : 17 : j < 1000000000000000000L ? 18 : 19;
        } else if (j >= FunctionParseBeautyBodySlimCount.TIP_INTERVAL_TIME) {
            i2 = j < ExtraTextUtils.MB ? j < 100000 ? 5 : 6 : j < 10000000 ? 7 : 8;
        } else if (j >= 100) {
            i2 = j < 1000 ? 3 : 4;
        } else if (j >= 10) {
            i2 = 2;
