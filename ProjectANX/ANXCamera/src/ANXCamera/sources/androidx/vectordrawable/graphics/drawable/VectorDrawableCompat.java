...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (vPath.isClipPath()) {
                    this.mRenderPath.setFillType(vPath.mFillRule == 0 ? FillType.WINDING : FillType.EVEN_ODD);
    ...
    class VectorDrawableCompatState extends ConstantState {
    ...
    @RequiresApi(24)
    class VectorDrawableDelegateState extends ConstantState {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0023, code lost:
        if (r1.isStateful() != false) goto L_0x0028;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean isStateful() {
        boolean z;
