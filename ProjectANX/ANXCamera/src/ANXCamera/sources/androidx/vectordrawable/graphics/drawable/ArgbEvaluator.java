...
public class ArgbEvaluator implements TypeEvaluator {
    ...
    public Object evaluate(float f, Object obj, Object obj2) {
        ...
        return Integer.valueOf(Math.round(((float) Math.pow((double) pow5, 0.45454545454545453d)) * 255.0f) | (Math.round(((float) Math.pow((double) (pow + ((((float) Math.pow((double) f7, 2.2d)) - pow) * f)), 0.45454545454545453d)) * 255.0f) << 16) | round | (Math.round(((float) Math.pow((double) pow4, 0.45454545454545453d)) * 255.0f) << 8));
    }
}
