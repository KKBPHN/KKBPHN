...
class LoaderManagerImpl extends LoaderManager {
    ...
    public class LoaderInfo extends MutableLiveData implements OnLoadCompleteListener {
        ...
        @MainThread
        @NonNull
        public Loader setCallback(@NonNull LifecycleOwner lifecycleOwner, @NonNull LoaderCallbacks loaderCallbacks) {
    ...
    class LoaderObserver implements Observer {
        ...
        LoaderObserver(@NonNull Loader loader, @NonNull LoaderCallbacks loaderCallbacks) {
            this.mLoader = loader;
        ...
        public void onChanged(@Nullable Object obj) {
            if (LoaderManagerImpl.DEBUG) {
                ...
                sb.append(": ");
                sb.append(this.mLoader.dataToString(obj));
                Log.v(LoaderManagerImpl.TAG, sb.toString());
            }
    ...
    @MainThread
    @NonNull
    private Loader createAndInstallLoader(int i, @Nullable Bundle bundle, @NonNull LoaderCallbacks loaderCallbacks, @Nullable Loader loader) {
        try {
    ...
    @MainThread
    @NonNull
    public Loader initLoader(int i, @Nullable Bundle bundle, @NonNull LoaderCallbacks loaderCallbacks) {
        if (this.mLoaderViewModel.isCreatingLoader()) {
            throw new IllegalStateException("Called while creating a loader");
        } else if (Looper.getMainLooper() == Looper.myLooper()) {
            LoaderInfo loader = this.mLoaderViewModel.getLoader(i);
    ...
    @MainThread
    @NonNull
    public Loader restartLoader(int i, @Nullable Bundle bundle, @NonNull LoaderCallbacks loaderCallbacks) {
        if (this.mLoaderViewModel.isCreatingLoader()) {
            throw new IllegalStateException("Called while creating a loader");
        } else if (Looper.getMainLooper() == Looper.myLooper()) {
            if (DEBUG) {
