...
public class NotificationCompat {
    ...
    public class Action {
        ...
        public final class Builder {
            ...
            public Action build() {
                ...
                Action action = new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, remoteInputArr, remoteInputArr2, this.mAllowGeneratedReplies, this.mSemanticAction, this.mShowsUserInterface, this.mIsContextual);
                return action;
            }
    ...
    public final class BubbleMetadata {
        ...
        public final class Builder {
            ...
            public BubbleMetadata build() {
                ...
                if (pendingIntent != null) {
                    ...
                    if (iconCompat != null) {
                        BubbleMetadata bubbleMetadata = new BubbleMetadata(pendingIntent, this.mDeleteIntent, iconCompat, this.mDesiredHeight, this.mDesiredHeightResId, this.mFlags);
        ...
        @RequiresApi(29)
        @Nullable
        public static BubbleMetadata fromPlatform(@Nullable android.app.Notification.BubbleMetadata bubbleMetadata) {
        ...
        @RequiresApi(29)
        @Nullable
        public static android.app.Notification.BubbleMetadata toPlatform(@Nullable BubbleMetadata bubbleMetadata) {
            if (bubbleMetadata == null) {
                return null;
            }
            android.app.Notification.BubbleMetadata.Builder suppressNotification = new android.app.Notification.BubbleMetadata.Builder().setAutoExpandBubble(bubbleMetadata.getAutoExpandBubble()).setDeleteIntent(bubbleMetadata.getDeleteIntent()).setIcon(bubbleMetadata.getIcon().toIcon()).setIntent(bubbleMetadata.getIntent()).setSuppressNotification(bubbleMetadata.isNotificationSuppressed());
            if (bubbleMetadata.getDesiredHeight() != 0) {
                suppressNotification.setDesiredHeight(bubbleMetadata.getDesiredHeight());
            }
            if (bubbleMetadata.getDesiredHeightResId() != 0) {
    ...
    public final class CarExtender implements Extender {
        ...
        /* JADX WARNING: type inference failed for: r1v1, types: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r1v2 */
        /* JADX WARNING: type inference failed for: r8v0, types: [androidx.core.app.RemoteInput] */
        /* JADX WARNING: type inference failed for: r6v0, types: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r12v1, types: [androidx.core.app.RemoteInput] */
        /* JADX WARNING: type inference failed for: r6v4, types: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation] */
        /* JADX WARNING: type inference failed for: r12v2, types: [androidx.core.app.RemoteInput] */
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r6v4, types: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation]
  assigns: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation, ?[int, float, boolean, short, byte, char, OBJECT, ARRAY], androidx.core.app.RemoteInput]
  uses: [androidx.core.app.NotificationCompat$CarExtender$UnreadConversation, ?[OBJECT, ARRAY], androidx.core.app.RemoteInput]
  mth insns count: 65
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            if (stringArray != null && stringArray.length == 1) {
                if (remoteInput != null) {
                    ...
                    r1 = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i, remoteInput.getExtras(), null);
                    r12 = r1;
                }
                ? unreadConversation = new UnreadConversation(strArr, r12, pendingIntent2, pendingIntent, stringArray, bundle2.getLong(KEY_TIMESTAMP));
                r1 = unreadConversation;
            }
            return r1;
        }
    ...
    public class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            if (z && nonContextualActions != null) {
        ...
        /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<androidx.core.app.NotificationCompat$Action>, for r3v0, types: [java.util.List, java.util.List<androidx.core.app.NotificationCompat$Action>] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private static List getNonContextualActions(List<Action> list) {
            if (list == null) {
                return null;
            }
            ArrayList arrayList = new ArrayList();
    ...
    public class MessagingStyle extends Style {
                ...
                try {
                    if (bundle.containsKey(str8)) {
                        if (bundle.containsKey(str7)) {
                            Person person = bundle.containsKey(str6) ? Person.fromBundle(bundle.getBundle(str6)) : (!bundle.containsKey(str5) || VERSION.SDK_INT < 28) ? bundle.containsKey(str4) ? new androidx.core.app.Person.Builder().setName(bundle.getCharSequence(str4)).build() : null : Person.fromAndroidPerson((Person) bundle.getParcelable(str5));
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            this.mUser = bundle.containsKey(str) ? Person.fromBundle(bundle.getBundle(str)) : new androidx.core.app.Person.Builder().setName(bundle.getString(NotificationCompat.EXTRA_SELF_DISPLAY_NAME)).build();
            ...
            if (bundle.containsKey(str2)) {
                this.mIsGroupConversation = Boolean.valueOf(bundle.getBoolean(str2));
            }
        }
    ...
    public abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (i5 >= 16 && i5 < 21) {
                ...
                if (z5) {
                    remoteViews.setInt(R.id.notification_background, str, R.drawable.notification_bg_low);
                    i2 = R.id.icon;
                    i3 = R.drawable.notification_template_icon_low_bg;
                } else {
                    remoteViews.setInt(R.id.notification_background, str, R.drawable.notification_bg);
                    i2 = R.id.icon;
            ...
            boolean z6 = VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            ...
            if (charSequence5 != null) {
                ...
                remoteViews.setViewVisibility(i62, i4);
                return remoteViews;
            }
            ...
            if (!this.mActions.isEmpty()) {
                ...
                if (i >= 16) {
                    ...
                    while (it.hasNext()) {
                        ...
                        int i2 = VERSION.SDK_INT;
                        if (i2 >= 20) {
                            bundleForAction = getActionFromActionCompat(action);
                        } else if (i2 >= 16) {
                            bundleForAction = NotificationCompatJellybean.getBundleForAction(action);
                        }
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i = 0; i < remoteInputs.length; i++) {
                ...
                RemoteInput remoteInput2 = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), VERSION.SDK_INT >= 29 ? remoteInput.getEditChoicesBeforeSending() : 0, remoteInput.getExtras(), null);
                remoteInputArr2[i] = remoteInput2;
            }
            remoteInputArr = remoteInputArr2;
        }
        String str = "android.support.allowGeneratedReplies";
        boolean z2 = VERSION.SDK_INT >= 24 ? action.getExtras().getBoolean(str) || action.getAllowGeneratedReplies() : action.getExtras().getBoolean(str);
        boolean z3 = z2;
        boolean z4 = action.getExtras().getBoolean("android.support.action.showsUserInterface", true);
        int semanticAction = VERSION.SDK_INT >= 28 ? action.getSemanticAction() : action.getExtras().getInt("android.support.action.semanticAction", 0);
        if (VERSION.SDK_INT >= 29) {
            z = action.isContextual();
        }
        Action action3 = new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, null, z3, semanticAction, z4, z);
        return action3;
    }
