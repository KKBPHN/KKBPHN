    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            if (builder.mInvisibleActions.size() > 0) {
                ...
                Bundle bundle4 = builder.getExtras().getBundle(str4);
                if (bundle4 == null) {
                    bundle4 = new Bundle();
                }
                Bundle bundle5 = new Bundle();
                for (int i = 0; i < builder.mInvisibleActions.size(); i++) {
                    bundle5.putBundle(Integer.toString(i), NotificationCompatJellybean.getBundleForAction((Action) builder.mInvisibleActions.get(i)));
                }
                bundle4.putBundle("invisible_actions", bundle5);
                builder.getExtras().putBundle(str4, bundle4);
                this.mExtras.putBundle(str4, bundle4);
            }
        }
