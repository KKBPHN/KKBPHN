...
public final class LocaleListCompat {
    ...
    public static LocaleListCompat create(@NonNull Locale... localeArr) {
        return VERSION.SDK_INT >= 24 ? wrap(new LocaleList(localeArr)) : new LocaleListCompat(new LocaleListCompatWrapper(localeArr));
    }
    ...
    public static LocaleListCompat forLanguageTags(@Nullable String str) {
        ...
        for (int i = 0; i < localeArr.length; i++) {
            localeArr[i] = VERSION.SDK_INT >= 21 ? Locale.forLanguageTag(split[i]) : forLanguageTagCompat(split[i]);
        }
