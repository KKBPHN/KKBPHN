            ...
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        int[] iArr = this.mScrollConsumed;
                        iArr[1] = 0;
                        dispatchNestedScroll(0, scrollY2, 0, i6, this.mScrollOffset, 0, iArr);
                        int i7 = this.mLastMotionY;
                        int[] iArr2 = this.mScrollOffset;
                        this.mLastMotionY = i7 - iArr2[1];
                        ...
                        if (z) {
                            ...
                            int i9 = scrollY + i8;
                            if (i9 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float) i8) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    edgeEffect = this.mEdgeGlowBottom;
                                }
                                ...
                                if (i9 > i5) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) i8) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
                                    if (!this.mEdgeGlowTop.isFinished()) {
                                        edgeEffect = this.mEdgeGlowTop;
                                    }
                                }
