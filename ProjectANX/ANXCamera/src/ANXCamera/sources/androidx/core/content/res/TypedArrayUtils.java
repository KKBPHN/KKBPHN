...
public class TypedArrayUtils {
    ...
    @Nullable
    public static ColorStateList getNamedColorStateList(@NonNull TypedArray typedArray, @NonNull XmlPullParser xmlPullParser, @Nullable Theme theme, @NonNull String str, @StyleableRes int i) {
