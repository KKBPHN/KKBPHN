...
public class ShortcutManagerCompat {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<androidx.core.content.pm.ShortcutInfoCompat>, for r4v0, types: [java.util.List, java.util.List<androidx.core.content.pm.ShortcutInfoCompat>] */
    ...
    @NonNull
    public static List getDynamicShortcuts(@NonNull Context context) {
        if (VERSION.SDK_INT >= 25) {
    ...
    public void removeDynamicShortcuts(@NonNull Context context, @NonNull List list) {
        if (VERSION.SDK_INT >= 25) {
