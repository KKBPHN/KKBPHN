...
public class ContextCompat {
    ...
    final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (VERSION.SDK_INT >= 16) {
                SERVICES.put(InputManager.class, EventInjector.INPUT_COMMAND_STRING);
    ...
    public static Executor getMainExecutor(Context context) {
        return VERSION.SDK_INT >= 28 ? context.getMainExecutor() : new MainHandlerExecutor(new Handler(context.getMainLooper()));
    }
    ...
    @Nullable
    public static Object getSystemService(@NonNull Context context, @NonNull Class cls) {
