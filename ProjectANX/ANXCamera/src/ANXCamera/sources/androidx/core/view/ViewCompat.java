...
public class ViewCompat {
    ...
    class AccessibilityPaneVisibilityManager implements OnGlobalLayoutListener, OnAttachStateChangeListener {
    ...
    public static int addAccessibilityAction(@NonNull View view, @NonNull CharSequence charSequence, @NonNull AccessibilityViewCommand accessibilityViewCommand) {
        ...
        if (availableActionIdFromResources != -1) {
            addAccessibilityAction(view, new AccessibilityActionCompat(availableActionIdFromResources, charSequence, accessibilityViewCommand));
        }
        return availableActionIdFromResources;
    }

    private static void addAccessibilityAction(@NonNull View view, @NonNull AccessibilityActionCompat accessibilityActionCompat) {
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (VERSION.SDK_INT >= 28) {
            ...
            AnonymousClass2 r1 = new OnUnhandledKeyEventListener() {
    ...
    public static AccessibilityDelegateCompat getAccessibilityDelegate(@NonNull View view) {
        ...
        return accessibilityDelegateInternal instanceof AccessibilityDelegateAdapter ? ((AccessibilityDelegateAdapter) accessibilityDelegateInternal).mCompat : new AccessibilityDelegateCompat(accessibilityDelegateInternal);
    }

    @Nullable
    private static AccessibilityDelegate getAccessibilityDelegateInternal(@NonNull View view) {
        return VERSION.SDK_INT >= 29 ? view.getAccessibilityDelegate() : getAccessibilityDelegateThroughReflection(view);
    }

    @Nullable
    private static AccessibilityDelegate getAccessibilityDelegateThroughReflection(@NonNull View view) {
    ...
    private static int getAvailableActionIdFromResources(View view) {
        ...
        while (true) {
            ...
            for (int i4 = 0; i4 < actionList.size(); i4++) {
                z &= ((AccessibilityActionCompat) actionList.get(i4)).getId() != i3;
            }
            if (z) {
                i = i3;
            }
    ...
    public static List getSystemGestureExclusionRects(@NonNull View view) {
        return VERSION.SDK_INT >= 29 ? view.getSystemGestureExclusionRects() : Collections.emptyList();
    }
    ...
    public static void replaceAccessibilityAction(@NonNull View view, @NonNull AccessibilityActionCompat accessibilityActionCompat, @Nullable CharSequence charSequence, @Nullable AccessibilityViewCommand accessibilityViewCommand) {
