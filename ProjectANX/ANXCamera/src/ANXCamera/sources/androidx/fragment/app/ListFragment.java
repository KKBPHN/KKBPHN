            ...
            if (view != null) {
                if (view instanceof ListView) {
                    ...
                    if (findViewById instanceof ListView) {
                        ...
                        runtimeException = new RuntimeException("Your content must have a ListView whose id attribute is 'android.R.id.list'");
                        throw runtimeException;
                    } else {
                        runtimeException = new RuntimeException("Content has view with id attribute 'android.R.id.list' that is not a ListView class");
                        throw runtimeException;
                    }
                }
