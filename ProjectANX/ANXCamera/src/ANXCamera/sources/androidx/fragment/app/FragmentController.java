...
public class FragmentController {
    ...
    @NonNull
    public List getActiveFragments(@SuppressLint({"UnknownNullness"}) List list) {
    ...
    @Deprecated
    public void restoreAllState(@Nullable Parcelable parcelable, @Nullable List list) {
        this.mHost.mFragmentManager.restoreAllState(parcelable, new FragmentManagerNonConfig(list, null, null));
    }

    @Deprecated
    public void restoreLoaderNonConfig(@SuppressLint({"UnknownNullness"}) SimpleArrayMap simpleArrayMap) {
    }
