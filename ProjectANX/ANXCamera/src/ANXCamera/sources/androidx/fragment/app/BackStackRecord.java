...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
            ...
            if (i3 != 1) {
                if (i3 == 2) {
                        ...
                        if (fragment5.mContainerId == i4) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i5, new Op(9, fragment5));
                                    i5++;
                                    fragment4 = null;
                                }
                    ...
                    if (fragment6 == fragment2) {
                        this.mOps.add(i2, new Op(9, fragment6));
                        i2++;
                        fragment2 = null;
                    }
                } else if (i3 != 7) {
    ...
    public boolean interactsWith(int i) {
        int size = this.mOps.size();
        for (int i2 = 0; i2 < size; i2++) {
            Fragment fragment = ((Op) this.mOps.get(i2)).mFragment;
    ...
    public boolean interactsWith(ArrayList arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            Fragment fragment = ((Op) this.mOps.get(i4)).mFragment;
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        Fragment fragment2 = ((Op) backStackRecord.mOps.get(i7)).mFragment;
