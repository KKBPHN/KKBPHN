...
class FragmentTransition {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x0092, code lost:
        r1 = true;
     */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x00a1  */
    ...
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, Op op, SparseArray sparseArray, boolean z, boolean z2) {
        ...
        if (fragment != null) {
            ...
            if (i != 0) {
                int i2 = z7 ? INVERSE_OPS[op2.mCmd] : op2.mCmd;
                boolean z8 = false;
                if (i2 != 1) {
                    if (i2 != 3) {
                        if (i2 != 4) {
                            if (i2 != 5) {
                                ...
                                fragmentManagerImpl2.makeActive(fragment);
                                fragmentManagerImpl2.moveToState(fragment, 1, 0, 0, false);
                                fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                                fragmentContainerTransition.firstOut = fragment;
                                fragmentContainerTransition.firstOutIsPop = z7;
                                fragmentContainerTransition.firstOutTransaction = backStackRecord2;
                                ...
                                z8 = z6;
                                z5 = true;
                                FragmentContainerTransition fragmentContainerTransition222 = (FragmentContainerTransition) sparseArray2.get(i);
                                if (z8) {
                                }
                                fragmentContainerTransition = fragmentContainerTransition222;
                                fragmentContainerTransition.firstOut = null;
                                FragmentManagerImpl fragmentManagerImpl22 = backStackRecord2.mManager;
                                fragmentManagerImpl22.makeActive(fragment);
                                fragmentManagerImpl22.moveToState(fragment, 1, 0, 0, false);
                                fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                                fragmentContainerTransition.firstOut = fragment;
                                fragmentContainerTransition.firstOutIsPop = z7;
                                fragmentContainerTransition.firstOutTransaction = backStackRecord2;
                            ...
                            z5 = false;
                            z4 = true;
                            FragmentContainerTransition fragmentContainerTransition2222 = (FragmentContainerTransition) sparseArray2.get(i);
                            if (z8) {
                            }
                            fragmentContainerTransition = fragmentContainerTransition2222;
                            fragmentContainerTransition.firstOut = null;
                            FragmentManagerImpl fragmentManagerImpl222 = backStackRecord2.mManager;
                            fragmentManagerImpl222.makeActive(fragment);
                            fragmentManagerImpl222.moveToState(fragment, 1, 0, 0, false);
                            fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                            fragmentContainerTransition.firstOut = fragment;
                            fragmentContainerTransition.firstOutIsPop = z7;
                            fragmentContainerTransition.firstOutTransaction = backStackRecord2;
                            ...
                            z5 = false;
                            z4 = true;
                            FragmentContainerTransition fragmentContainerTransition22222 = (FragmentContainerTransition) sparseArray2.get(i);
                            if (z8) {
                            }
                            fragmentContainerTransition = fragmentContainerTransition22222;
                            fragmentContainerTransition.firstOut = null;
                            FragmentManagerImpl fragmentManagerImpl2222 = backStackRecord2.mManager;
                            fragmentManagerImpl2222.makeActive(fragment);
                            fragmentManagerImpl2222.moveToState(fragment, 1, 0, 0, false);
                            fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                            fragmentContainerTransition.firstOut = fragment;
                            fragmentContainerTransition.firstOutIsPop = z7;
                            fragmentContainerTransition.firstOutTransaction = backStackRecord2;
                    ...
                    if (z2) {
                        ...
                        z5 = false;
                        z4 = true;
                        FragmentContainerTransition fragmentContainerTransition222222 = (FragmentContainerTransition) sparseArray2.get(i);
                        if (z8) {
                        }
                        fragmentContainerTransition = fragmentContainerTransition222222;
                        fragmentContainerTransition.firstOut = null;
                        FragmentManagerImpl fragmentManagerImpl22222 = backStackRecord2.mManager;
                        fragmentManagerImpl22222.makeActive(fragment);
                        fragmentManagerImpl22222.moveToState(fragment, 1, 0, 0, false);
                        fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                        fragmentContainerTransition.firstOut = fragment;
                        fragmentContainerTransition.firstOutIsPop = z7;
                        fragmentContainerTransition.firstOutTransaction = backStackRecord2;
                    ...
                    z5 = false;
                    z4 = true;
                    FragmentContainerTransition fragmentContainerTransition2222222 = (FragmentContainerTransition) sparseArray2.get(i);
                    if (z8) {
                    }
                    fragmentContainerTransition = fragmentContainerTransition2222222;
                    fragmentContainerTransition.firstOut = null;
                    FragmentManagerImpl fragmentManagerImpl222222 = backStackRecord2.mManager;
                    fragmentManagerImpl222222.makeActive(fragment);
                    fragmentManagerImpl222222.moveToState(fragment, 1, 0, 0, false);
                    fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                    fragmentContainerTransition.firstOut = fragment;
                    fragmentContainerTransition.firstOutIsPop = z7;
                    fragmentContainerTransition.firstOutTransaction = backStackRecord2;
                ...
                if (z2) {
                    ...
                    z8 = z6;
                    z5 = true;
                    FragmentContainerTransition fragmentContainerTransition22222222 = (FragmentContainerTransition) sparseArray2.get(i);
                    if (z8) {
                    }
                    fragmentContainerTransition = fragmentContainerTransition22222222;
                    fragmentContainerTransition.firstOut = null;
                    FragmentManagerImpl fragmentManagerImpl2222222 = backStackRecord2.mManager;
                    fragmentManagerImpl2222222.makeActive(fragment);
                    fragmentManagerImpl2222222.moveToState(fragment, 1, 0, 0, false);
                    fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                    fragmentContainerTransition.firstOut = fragment;
                    fragmentContainerTransition.firstOutIsPop = z7;
                    fragmentContainerTransition.firstOutTransaction = backStackRecord2;
                ...
                z8 = z6;
                z5 = true;
                FragmentContainerTransition fragmentContainerTransition222222222 = (FragmentContainerTransition) sparseArray2.get(i);
                if (z8) {
                }
                fragmentContainerTransition = fragmentContainerTransition222222222;
                fragmentContainerTransition.firstOut = null;
                FragmentManagerImpl fragmentManagerImpl22222222 = backStackRecord2.mManager;
                fragmentManagerImpl22222222.makeActive(fragment);
                fragmentManagerImpl22222222.moveToState(fragment, 1, 0, 0, false);
                fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray2, i);
                fragmentContainerTransition.firstOut = fragment;
                fragmentContainerTransition.firstOutIsPop = z7;
                fragmentContainerTransition.firstOutTransaction = backStackRecord2;
    ...
    private static Object configureSharedElementsOrdered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList arrayList, ArrayList arrayList2, Object obj, Object obj2) {
        ArrayMap arrayMap2;
        Object obj3;
        Object obj4;
        Rect rect;
        ...
        final ArrayMap arrayMap3 = arrayMap;
        ...
        AnonymousClass4 r0 = new Runnable() {
            public void run() {
                ArrayMap captureInSharedElements = FragmentTransition.captureInSharedElements(FragmentTransitionImpl.this, arrayMap3, obj6, fragmentContainerTransition3);
    ...
    private static Object configureSharedElementsReordered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList arrayList, ArrayList arrayList2, Object obj, Object obj2) {
        Object obj3;
        final Rect rect;
        final View view2;
        FragmentTransitionImpl fragmentTransitionImpl2 = fragmentTransitionImpl;
        ...
        ArrayMap captureOutSharedElements = captureOutSharedElements(fragmentTransitionImpl, arrayMap2, sharedElementTransition, fragmentContainerTransition2);
        ArrayMap captureInSharedElements = captureInSharedElements(fragmentTransitionImpl, arrayMap2, sharedElementTransition, fragmentContainerTransition2);
        if (arrayMap.isEmpty()) {
