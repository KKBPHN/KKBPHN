...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private static final Pool sRectPool = new SynchronizedPool(12);
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        if (VERSION.SDK_INT >= 29) {
            ...
            if (i == 0) {
                i3 = 0;
                i2 = R.style.Widget_Support_CoordinatorLayout;
            ...
            coordinatorLayout.saveAttributeDataForStyleable(context2, iArr2, attributeSet2, typedArray, i3, i2);
        }
            ...
            if ((absoluteGravity & 48) == 48) {
                ...
                if (i2 < i3) {
                    ...
                    if ((absoluteGravity & 3) == 3) {
                        int i5 = (acquireTempRect.left - layoutParams.leftMargin) - layoutParams.mInsetOffsetX;
                        int i6 = rect.left;
                        if (i5 < i6) {
                            setInsetOffsetX(view, i6 - i5);
                            z2 = true;
                            if ((absoluteGravity & 5) == 5) {
                                int width = ((getWidth() - acquireTempRect.right) - layoutParams.rightMargin) + layoutParams.mInsetOffsetX;
                                int i7 = rect.right;
                                if (width < i7) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i17 = 0;
        while (i17 < size3) {
            View view = (View) this.mDependencySortedChildren.get(i17);
            if (view.getVisibility() == 8) {
                i4 = i17;
                i3 = size3;
            } else {
                ...
                if (i18 < 0 || mode == 0) {
                    ...
                    if ((absoluteGravity == 3 && !z) || (absoluteGravity == 5 && z)) {
                        ...
                        int max = Math.max(i9, i12 + view.getMeasuredWidth() + layoutParams3.leftMargin + layoutParams3.rightMargin);
                        int max2 = Math.max(i11, i13 + view.getMeasuredHeight() + layoutParams3.topMargin + layoutParams3.bottomMargin);
                        i14 = max;
                        ...
                        if (z2 || ViewCompat.getFitsSystemWindows(view)) {
                            ...
                            i8 = MeasureSpec.makeMeasureSpec(size - (this.mLastInsets.getSystemWindowInsetLeft() + this.mLastInsets.getSystemWindowInsetRight()), mode);
                            i7 = MeasureSpec.makeMeasureSpec(size2 - systemWindowInsetTop, mode2);
                        }
                        behavior = layoutParams2.getBehavior();
                        if (behavior != null) {
                        ...
                        int max3 = Math.max(i9, i12 + view.getMeasuredWidth() + layoutParams32.leftMargin + layoutParams32.rightMargin);
                        int max22 = Math.max(i11, i13 + view.getMeasuredHeight() + layoutParams32.topMargin + layoutParams32.bottomMargin);
                        i14 = max3;
                        i16 = View.combineMeasuredStates(i10, view.getMeasuredState());
                        i15 = max22;
                    }
                ...
                int max32 = Math.max(i9, i12 + view.getMeasuredWidth() + layoutParams322.leftMargin + layoutParams322.rightMargin);
                int max222 = Math.max(i11, i13 + view.getMeasuredHeight() + layoutParams322.topMargin + layoutParams322.bottomMargin);
                i14 = max32;
                i16 = View.combineMeasuredStates(i10, view.getMeasuredState());
                i15 = max222;
            }
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i5)) {
                    ...
                    if (behavior != null) {
                        ...
                        int[] iArr3 = this.mBehaviorConsumed;
                        int max = i3 > 0 ? Math.max(i7, iArr3[0]) : Math.min(i7, iArr3[0]);
                        if (i4 > 0) {
                            z = true;
                            i6 = Math.max(i8, this.mBehaviorConsumed[1]);
                        } else {
                            z = true;
                            i6 = Math.min(i8, this.mBehaviorConsumed[1]);
                        }
                        i7 = max;
                        i8 = i6;
                        z2 = z;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int actionMasked = motionEvent.getActionMasked();
        boolean z2 = this.mBehaviorTouchView == null ? performIntercept(motionEvent3, 1) : false;
