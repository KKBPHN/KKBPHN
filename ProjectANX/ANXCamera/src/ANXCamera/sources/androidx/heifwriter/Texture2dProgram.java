...
public class Texture2dProgram {
    ...
    public Texture2dProgram(int i) {
        ...
        this.mProgramHandle = createProgram(str2, str);
        int i2 = this.mProgramHandle;
        if (i2 != 0) {
            String str3 = "aPosition";
            this.maPositionLoc = GLES20.glGetAttribLocation(i2, str3);
            checkLocation(this.maPositionLoc, str3);
            String str4 = "aTextureCoord";
            this.maTextureCoordLoc = GLES20.glGetAttribLocation(this.mProgramHandle, str4);
            checkLocation(this.maTextureCoordLoc, str4);
            String str5 = "uMVPMatrix";
            this.muMVPMatrixLoc = GLES20.glGetUniformLocation(this.mProgramHandle, str5);
            checkLocation(this.muMVPMatrixLoc, str5);
            String str6 = "uTexMatrix";
            this.muTexMatrixLoc = GLES20.glGetUniformLocation(this.mProgramHandle, str6);
            checkLocation(this.muTexMatrixLoc, str6);
            return;
        }
