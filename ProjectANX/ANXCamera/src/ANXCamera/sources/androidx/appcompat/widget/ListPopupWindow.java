...
public class ListPopupWindow implements ShowableListMenu {
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            if (view3 != null) {
                ...
                view3.measure(MeasureSpec.makeMeasureSpec(i6, i3), 0);
        ...
        makeMeasureSpec = MeasureSpec.makeMeasureSpec(i9 - (rect2.left + rect2.right), i4);
        measureHeightOfChildrenCompat = this.mDropDownList.measureHeightOfChildrenCompat(makeMeasureSpec, 0, -1, maxAvailableHeight - i, -1);
        if (measureHeightOfChildrenCompat > 0) {
        }
        return measureHeightOfChildrenCompat + i;
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [androidx.appcompat.widget.ListPopupWindow] */
    /* JADX WARNING: type inference failed for: r5v3, types: [androidx.appcompat.widget.ListPopupWindow] */
  ...
  mth insns count: 31
    ...
    private int getMaxAvailableHeight(View view, int i, boolean z) {
        ...
        if (method != null) {
            try {
                this = this;
                this = ((Integer) method.invoke(this.mPopup, new Object[]{view, Integer.valueOf(i), Boolean.valueOf(z)})).intValue();
                r5 = this;
                return this;
        ...
        return r5.mPopup.getMaxAvailableHeight(view, i);
    }
    ...
    public void show() {
        ...
        if (!this.mPopup.isShowing()) {
            ...
            boolean z2 = !this.mForceIgnoreOutsideTouch && !this.mDropDownAlwaysVisible;
