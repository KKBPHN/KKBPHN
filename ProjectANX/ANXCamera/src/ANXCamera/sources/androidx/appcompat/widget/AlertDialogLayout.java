...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i10 = i8 != 16 ? i8 != 80 ? getPaddingTop() : ((getPaddingTop() + i4) - i2) - measuredHeight : getPaddingTop() + (((i4 - i2) - measuredHeight) / 2);
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8)) {
                ...
                if (absoluteGravity == 1) {
                    ...
                    int i14 = i13 + measuredHeight2 + layoutParams.bottomMargin;
                } else {
                ...
                int i132 = i10 + layoutParams.topMargin;
                setChildFrame(childAt, i5, i132, measuredWidth, measuredHeight2);
                int i142 = i132 + measuredHeight2 + layoutParams.bottomMargin;
            }
        }
    }
