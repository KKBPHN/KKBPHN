...
public class Toolbar extends ViewGroup {
    ...
    private void addSystemView(View view, boolean z) {
        ...
        LayoutParams layoutParams2 = layoutParams == null ? generateDefaultLayoutParams() : !checkLayoutParams(layoutParams) ? generateLayoutParams(layoutParams) : (LayoutParams) layoutParams;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ImageButton imageButton = this.mNavButtonView;
            if (z4) {
                i5 = layoutChildRight(imageButton, i27, iArr, min);
                i6 = paddingLeft;
                if (shouldLayout(this.mCollapseButtonView)) {
                    ImageButton imageButton2 = this.mCollapseButtonView;
                    if (z4) {
                        i5 = layoutChildRight(imageButton2, i5, iArr, min);
                    } else {
                        i6 = layoutChildLeft(imageButton2, i6, iArr, min);
                    }
                }
                if (shouldLayout(this.mMenuView)) {
                    ActionMenuView actionMenuView = this.mMenuView;
                    if (z4) {
                        i6 = layoutChildLeft(actionMenuView, i6, iArr, min);
                    } else {
                        i5 = layoutChildRight(actionMenuView, i5, iArr, min);
                    }
                }
                ...
                int min2 = Math.min(i5, i27 - currentContentInsetRight);
                ...
                if (!shouldLayout || shouldLayout2) {
                    ...
                    if (i18 != 48) {
                        ...
                        int i28 = (((height - paddingTop) - paddingBottom) - i9) / 2;
                        ...
                        if (i28 < i29 + i30) {
                            ...
                            int i31 = (((height - paddingBottom) - i9) - i28) - paddingTop;
                    ...
                    if (!z4) {
                        ...
                        if (shouldLayout) {
                            ...
                            i20 = measuredHeight + layoutParams5.bottomMargin;
                        } else {
                            i25 = i7;
                        }
                        if (z3) {
                            LayoutParams layoutParams6 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                            int i35 = i20 + layoutParams6.topMargin;
                            this.mSubtitleTextView.layout(i7 - this.mSubtitleTextView.getMeasuredWidth(), i35, i7, this.mSubtitleTextView.getMeasuredHeight() + i35);
                            i26 = i7 - this.mTitleMarginEnd;
                        ...
                        for (i15 = i13; i15 < size; i15++) {
                            i14 = layoutChildLeft((View) this.mTempViews.get(i15), i14, iArr, i11);
                        }
                        int i40 = i11;
                        addCustomViewsWithGravity(this.mTempViews, 5);
                        size2 = this.mTempViews.size();
                        for (i16 = i13; i16 < size2; i16++) {
                            i7 = layoutChildRight((View) this.mTempViews.get(i16), i7, iArr, i40);
                        }
                        addCustomViewsWithGravity(this.mTempViews, 1);
                        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
                        i17 = (i12 + (((i10 - i12) - i8) / 2)) - (viewListMeasuredWidth / 2);
                        int i41 = viewListMeasuredWidth + i17;
                        if (i17 >= i14) {
                            i14 = i41 > i7 ? i17 - (i41 - i7) : i17;
                        }
                        size3 = this.mTempViews.size();
                        while (i13 < size3) {
                            i14 = layoutChildLeft((View) this.mTempViews.get(i13), i14, iArr, i40);
                            i13++;
                        }
                ...
                int i412 = viewListMeasuredWidth2 + i17;
                if (i17 >= i14) {
                }
                size3 = this.mTempViews.size();
                while (i13 < size3) {
            ...
            i6 = layoutChildLeft(imageButton, paddingLeft, iArr, min);
        } else {
            i6 = paddingLeft;
        }
        i5 = i27;
        ...
        int min22 = Math.min(i5, i27 - currentContentInsetRight2);
        if (shouldLayout(this.mExpandedActionView)) {
        }
        if (shouldLayout(this.mLogoView)) {
        }
        ...
        LayoutParams layoutParams32 = (LayoutParams) (!shouldLayout ? this.mTitleTextView : this.mSubtitleTextView).getLayoutParams();
        LayoutParams layoutParams42 = (LayoutParams) (!shouldLayout2 ? this.mSubtitleTextView : this.mTitleTextView).getLayoutParams();
        if (shouldLayout) {
        }
        i12 = paddingLeft;
        z2 = false;
