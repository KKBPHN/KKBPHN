...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    public class LayoutParams extends androidx.appcompat.widget.LinearLayoutCompat.LayoutParams {
        @ExportedProperty
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        if (i3 <= 0 || j == 0 || (i3 >= i19 - 1 && !z10 && i20 <= 1)) {
            ...
            if (!z10) {
                ...
                if ((j & ((long) (1 << i37))) != 0 && !((LayoutParams) getChildAt(i37).getLayoutParams()).preventEdgeOffset) {
                    bitCount -= 0.5f;
                }
            } else {
                i8 = 0;
            }
            int i38 = bitCount > 0.0f ? (int) (((float) (i3 * i15)) / bitCount) : i8;
            for (int i39 = i8; i39 < childCount; i39++) {
                if ((j & ((long) (1 << i39))) != 0) {
        ...
        setMeasuredDimension(i5, i7 != 1073741824 ? i6 : i26);
    }
