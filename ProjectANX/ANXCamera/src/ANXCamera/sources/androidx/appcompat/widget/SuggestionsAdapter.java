...
import com.xiaomi.stat.MiStat.Event;
...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private Drawable getActivityIconWithCache(ComponentName componentName) {
        ...
        if (this.mOutsideDrawablesCache.containsKey(flattenToShortString)) {
            ...
            if (constantState != null) {
                r2 = constantState.newDrawable(this.mProviderContext.getResources());
            }
            return r2;
        }
        Drawable activityIcon = getActivityIcon(componentName);
        if (activityIcon != null) {
            drawable = activityIcon.getConstantState();
        }
        this.mOutsideDrawablesCache.put(flattenToShortString, drawable);
        return activityIcon;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:?, code lost:
        ...
        r0.append("Resource does not exist: ");
        r0.append(r6);
     */
    ...
    /* JADX WARNING: type inference failed for: r1v1, types: [androidx.cursoradapter.widget.CursorAdapter, androidx.cursoradapter.widget.ResourceCursorAdapter] */
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            this = this;
            this = super.getDropDownView(i, view, viewGroup);
            r1 = this;
            return this;
        } catch (RuntimeException e) {
            Log.w(LOG_TAG, "Search suggestions cursor threw exception.", e);
            View newDropDownView = r1.newDropDownView(r1.mContext, r1.mCursor, viewGroup);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            this = this;
            this = super.getView(i, view, viewGroup);
            r1 = this;
            return this;
        } catch (RuntimeException e) {
            Log.w(LOG_TAG, "Search suggestions cursor threw exception.", e);
            View newView = r1.newView(r1.mContext, r1.mCursor, viewGroup);
            if (newView != null) {
