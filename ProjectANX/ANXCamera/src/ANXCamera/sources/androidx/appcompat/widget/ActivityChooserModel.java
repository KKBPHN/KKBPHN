...
class ActivityChooserModel extends DataSetObservable {
    ...
    final class PersistHistoryAsyncTask extends AsyncTask {
        ...
        public Void doInBackground(Object... objArr) {
            String str;
            String str2 = ActivityChooserModel.TAG_HISTORICAL_RECORD;
            String str3 = ActivityChooserModel.TAG_HISTORICAL_RECORDS;
            String str4 = "Error writing historical record file: ";
            List list = objArr[0];
            String str5 = (String) objArr[1];
            try {
                str = str5;
                FileOutputStream openFileOutput = ActivityChooserModel.this.mContext.openFileOutput(str5, 0);
                str = openFileOutput;
                ...
                String str9 = ActivityChooserModel.LOG_TAG;
                StringBuilder sb4 = new StringBuilder();
                sb4.append(str4);
                sb4.append(str);
                Log.e(str9, sb4.toString(), e4);
                return null;
            }
        }
    }
