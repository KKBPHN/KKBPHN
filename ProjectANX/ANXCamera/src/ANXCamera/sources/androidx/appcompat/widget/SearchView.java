...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Intent createIntent(String str, Uri uri, String str2, String str3, int i, String str4) {
        ...
        if (str3 != null) {
            intent.putExtra(BaseEvent.QUERY, str3);
        }
        if (str2 != null) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            return createIntent(str2, columnString2 == null ? null : Uri.parse(columnString2), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i, str);
    ...
    private void updateSubmitArea() {
        int i = (!isSubmitAreaEnabled() || !(this.mGoButton.getVisibility() == 0 || this.mVoiceButton.getVisibility() == 0)) ? 8 : 0;
        this.mSubmitArea.setVisibility(i);
    }

    private void updateSubmitButton(boolean z) {
        int i = (!this.mSubmitButtonEnabled || !isSubmitAreaEnabled() || !hasFocus() || (!z && this.mVoiceButtonEnabled)) ? 8 : 0;
    ...
    public void onMeasure(int i, int i2) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(size, 1073741824), MeasureSpec.makeMeasureSpec(size22, 1073741824));
    }
