...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    class OnMenuItemClickListenerWrapper implements OnMenuItemClickListener {
    ...
    public MenuItem setActionProvider(android.view.ActionProvider actionProvider) {
        ActionProvider actionProviderWrapperJB = VERSION.SDK_INT >= 16 ? new ActionProviderWrapperJB(this.mContext, actionProvider) : new ActionProviderWrapper(this.mContext, actionProvider);
