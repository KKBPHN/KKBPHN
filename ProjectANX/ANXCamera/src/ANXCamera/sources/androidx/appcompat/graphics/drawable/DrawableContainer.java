...
class DrawableContainer extends Drawable implements Callback {
    ...
    class BlockInvalidateCallback implements Callback {
    ...
    abstract class DrawableContainerState extends ConstantState {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:21:0x0065 A[ADDED_TO_REGION] */
