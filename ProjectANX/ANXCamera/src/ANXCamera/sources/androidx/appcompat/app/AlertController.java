    ...
    private final OnClickListener mButtonHandler = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view == alertController.mButtonPositive) {
                message2 = alertController.mButtonPositiveMessage;
            }
            AlertController alertController2 = AlertController.this;
            if (view == alertController2.mButtonNegative) {
                message2 = alertController2.mButtonNegativeMessage;
            }
            AlertController alertController3 = AlertController.this;
            if (view == alertController3.mButtonNeutral) {
                Message message3 = alertController3.mButtonNeutralMessage;
                if (message3 != null) {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    ? r12 = new ArrayAdapter(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
                    ...
                    ? r13 = new CursorAdapter(this.mContext, cursor, false) {
                ...
                if (cursor2 != null) {
                    ? simpleCursorAdapter = new SimpleCursorAdapter(this.mContext, i, cursor2, new String[]{this.mLabelColumn}, new int[]{16908308});
                    r9 = simpleCursorAdapter;
                } else {
                    r9 = this.mAdapter;
                    if (r9 == 0) {
                        r9 = new CheckedItemAdapter(this.mContext, i, 16908308, this.mItems);
                    }
                }
            }
