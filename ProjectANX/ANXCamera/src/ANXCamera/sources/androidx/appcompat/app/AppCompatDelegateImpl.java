...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
    ...
    class AutoBatteryNightModeManager extends AutoNightModeManager {
        ...
        public int getApplyableNightMode() {
            return (VERSION.SDK_INT < 21 || !this.mPowerManager.isPowerSaveMode()) ? 1 : 2;
        }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                viewGroup = (ViewGroup) from.inflate(this.mOverlayActionMode ? R.layout.abc_screen_simple_overlay_action_mode : R.layout.abc_screen_simple, null);
                if (VERSION.SDK_INT >= 21) {
                ...
                int i = typedValue.resourceId;
                viewGroup = (ViewGroup) LayoutInflater.from(i != 0 ? new ContextThemeWrapper(this.mContext, i) : this.mContext).inflate(R.layout.abc_screen_toolbar, null);
    ...
    private void initWindowDecorActionBar() {
        ...
        if (this.mHasActionBar && this.mActionBar == null) {
            Object obj = this.mHost;
            if (obj instanceof Activity) {
                windowDecorActionBar = new WindowDecorActionBar((Activity) obj, this.mOverlayActionBar);
            } else {
                if (obj instanceof Dialog) {
                    windowDecorActionBar = new WindowDecorActionBar((Dialog) obj);
                }
    ...
    private boolean updateForNightMode(int i, boolean z) {
        ...
        boolean z2 = false;
        if (i3 != i2 && !isActivityManifestHandlingUiMode && VERSION.SDK_INT >= 17 && !this.mBaseContextAttached && (this.mHost instanceof android.view.ContextThemeWrapper)) {
        ...
        if (!z2 && !isActivityManifestHandlingUiMode && (this.mContext.getResources().getConfiguration().uiMode & 48) != i3) {
            if (z && this.mBaseContextAttached && (VERSION.SDK_INT >= 17 || this.mCreated)) {
                Object obj = this.mHost;
                if (obj instanceof Activity) {
            ...
            if (!z2) {
                updateResourcesConfigurationForNightMode(i3);
                z2 = true;
            }
        }
        if (z2 || isActivityManifestHandlingUiMode) {
    ...
    private void updateResourcesConfigurationForNightMode(int i) {
    ...
    public int mapNightMode(int i) {
        ...
        if (i != -1) {
            if (i != 0) {
                if (!(i == 1 || i == 2)) {
                    if (i == 3) {
                        autoTimeNightModeManager = getAutoBatteryNightModeManager();
                    } else {
                ...
                autoTimeNightModeManager = getAutoTimeNightModeManager();
            }
