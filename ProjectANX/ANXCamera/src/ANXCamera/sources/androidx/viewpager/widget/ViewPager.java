...
public class ViewPager extends ViewGroup {
            ...
            if (i4 < i5) {
                ...
                while (true) {
                    ...
                    while (i7 > itemInfo3.position) {
                        f3 -= this.mAdapter.getPageWidth(i7) + f;
                        i7--;
                    }
                ...
                if (!layoutParams2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ...
                        if (layoutParams2.needsMeasure) {
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), 1073741824), MeasureSpec.makeMeasureSpec((i8 - i11) - i9, 1073741824));
                        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams != null && layoutParams.isDecor) {
                    ...
                    childAt.measure(MeasureSpec.makeMeasureSpec(i12, i11), MeasureSpec.makeMeasureSpec(i13, i7));
                    if (z2) {
        ...
        MeasureSpec.makeMeasureSpec(i5, 1073741824);
        ...
        for (int i14 = 0; i14 < childCount2; i14++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (((float) i5) * layoutParams2.widthFactor), 1073741824), makeMeasureSpec);
                }
            }
        }
    }
                ...
                if (!this.mIsBeingDragged) {
                    ...
                    if (findPointerIndex != -1) {
                        ...
                        if (abs > ((float) this.mTouchSlop) && abs > abs2) {
                            ...
                            requestParentDisallowInterceptTouchEvent(true);
                            float f2 = this.mInitialMotionX;
                            this.mLastMotionX = x - f2 > 0.0f ? f2 + ((float) this.mTouchSlop) : f2 - ((float) this.mTouchSlop);
                            this.mLastMotionY = y;
                            setScrollState(1);
                            setScrollingCacheEnabled(true);
                            ViewParent parent = getParent();
                    ...
                    while (i9 >= 0) {
                        if (f < paddingLeft || i9 >= max) {
                            if (itemInfo3 == null || i9 != itemInfo3.position) {
                                f += addNewItem(i9, i10 + 1).widthFactor;
                                i11++;
                            } else {
    ...
    public void smoothScrollTo(int i, int i2, int i3) {
        ...
        Scroller scroller = this.mScroller;
        boolean z = scroller != null && !scroller.isFinished();
        if (z) {
        ...
        int abs = Math.abs(i3);
        int min = Math.min(abs > 0 ? Math.round(Math.abs(distanceInfluenceForSnapDuration / ((float) abs)) * 1000.0f) * 4 : (int) (((((float) Math.abs(i6)) / ((f * this.mAdapter.getPageWidth(this.mCurItem)) + ((float) this.mPageMargin))) + 1.0f) * 100.0f), 600);
