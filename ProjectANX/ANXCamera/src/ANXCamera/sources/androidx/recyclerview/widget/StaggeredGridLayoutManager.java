...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
  ...
  mth insns count: 224
    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        int i7 = this.mLayoutState.mInfinite ? layoutState2.mLayoutDirection == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : layoutState2.mLayoutDirection == 1 ? layoutState2.mEndLine + layoutState2.mAvailable : layoutState2.mStartLine - layoutState2.mAvailable;
        int i8 = i7;
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState2.mLayoutDirection == 1) {
                ...
                i2 = minStart - this.mPrimaryOrientation.getDecoratedMeasurement(next);
                if (r32 != 0 && layoutParams.mFullSpan) {
            ...
            staggeredGridLayoutManager.layoutDecoratedWithMargins(view, i6, i4, i5, i);
            if (layoutParams.mFullSpan) {
        ...
        return startAfterPadding2 > 0 ? Math.min(layoutState2.mAvailable, startAfterPadding2) : r34;
    }
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z) {
        ...
        if (layoutParams.mFullSpan) {
            ...
            i2 = LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getWidthMode(), 0, layoutParams.width, false);
        } else {
            i2 = LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight(), layoutParams.width, true);
            i = LayoutManager.getChildMeasureSpec(this.mSizePerSpan, getHeightMode(), 0, layoutParams.height, false);
            measureChildWithDecorationsAndMargin(view, i2, i, z);
        }
        i = LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom(), layoutParams.height, true);
        measureChildWithDecorationsAndMargin(view, i2, i, z);
    }
    ...
    private void onLayoutChildren(Recycler recycler, State state, boolean z) {
        ...
        if (z && !state.isPreLayout()) {
            boolean z4 = this.mGapStrategy != 0 && getChildCount() > 0 && (this.mLaidOutInvalidFullSpan || hasGapsToFix() != null);
            if (z4) {
                ...
                for (int i3 = 0; i3 < childCount; i3++) {
                    ...
                    if (!layoutParams.mFullSpan) {
                        if (!isLayoutRTL() || this.mOrientation != 1) {
                            ...
                            int i5 = (this.mSizePerSpan * i4) - (i4 * i2);
                            if (this.mOrientation == 1) {
                            ...
                            childAt2.offsetLeftAndRight(((-(i7 - i8)) * this.mSizePerSpan) - ((-((i6 - 1) - i8)) * i2));
                        }
                    }
                }
            }
    ...
    private void resolveShouldLayoutReverse() {
        boolean z = (this.mOrientation == 1 || !isLayoutRTL()) ? this.mReverseLayout : !this.mReverseLayout;
    ...
    public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        accessibilityNodeInfoCompat.setCollectionItemInfo(CollectionItemInfoCompat.obtain(i4, i3, i2, i, false, false));
    }
                    ...
                    if (savedState == null || savedState.mAnchorPosition == -1 || savedState.mSpanOffsetsSize < 1) {
                        ...
                        if (findViewByPosition != null) {
                            ...
                            if (this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
                                if (anchorInfo.mLayoutFromEnd) {
                                    i2 = this.mPrimaryOrientation.getEndAfterPadding() - this.mPendingScrollPositionOffset;
                                    i = this.mPrimaryOrientation.getDecoratedEnd(findViewByPosition);
                                } else {
                                    i2 = this.mPrimaryOrientation.getStartAfterPadding() + this.mPendingScrollPositionOffset;
                                    i = this.mPrimaryOrientation.getDecoratedStart(findViewByPosition);
                                }
                                anchorInfo.mOffset = i2 - i;
                                return true;
                                ...
                                OrientationHelper orientationHelper = this.mPrimaryOrientation;
                                anchorInfo.mOffset = z2 ? orientationHelper.getEndAfterPadding() : orientationHelper.getStartAfterPadding();
                                return true;
                            } else {
