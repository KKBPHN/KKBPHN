...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler, ScrollVectorProvider {
    ...
    class LayoutState {
        ...
        public void assignPositionFromScrapList(View view) {
            ...
            this.mCurrentPosition = nextViewInLimitedList == null ? -1 : ((LayoutParams) nextViewInLimitedList.getLayoutParams()).getViewLayoutPosition();
        }
        ...
        public View nextViewInLimitedList(View view) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (view4 != view && !layoutParams.isItemRemoved()) {
        ...
        if (focusedChild != null && anchorInfo.isViewValidAsAnchor(focusedChild, state)) {
            ...
            if (!state.isPreLayout() && supportsPredictiveItemAnimations()) {
                ...
                if (z) {
                    ...
                    OrientationHelper orientationHelper = this.mOrientationHelper;
                    anchorInfo.mCoordinate = z2 ? orientationHelper.getEndAfterPadding() : orientationHelper.getStartAfterPadding();
                }
            }
            return true;
        }
            ...
            if (i != -1) {
                if (i < 0 || i >= state.getItemCount()) {
                    ...
                    if (savedState != null && savedState.hasValidAnchor()) {
                        ...
                        anchorInfo.mCoordinate = z2 ? this.mOrientationHelper.getEndAfterPadding() - this.mPendingScrollPositionOffset : this.mOrientationHelper.getStartAfterPadding() + this.mPendingScrollPositionOffset;
                        return true;
                    }
                }
            }
    ...
    public void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (this.mOrientation == 1) {
            ...
            int i6 = layoutState.mLayoutDirection;
    ...
    public void prepareForDrop(@NonNull View view, @NonNull View view2, int i, int i2) {
        ...
        if (this.mShouldReverseLayout) {
            ...
            i3 = this.mOrientationHelper.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd(view2);
        } else if (z) {
            i3 = this.mOrientationHelper.getDecoratedStart(view2);
        } else {
