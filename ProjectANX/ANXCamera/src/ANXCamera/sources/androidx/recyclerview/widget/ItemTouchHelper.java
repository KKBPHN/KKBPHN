...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    final Runnable mScrollRunnable = new Runnable() {
        public void run() {
            ...
            if (itemTouchHelper.mSelected != null && itemTouchHelper.scrollIfNecessary()) {
                ItemTouchHelper itemTouchHelper2 = ItemTouchHelper.this;
                ViewHolder viewHolder = itemTouchHelper2.mSelected;
                if (viewHolder != null) {
    ...
    public abstract class Callback {
        ...
        public ViewHolder chooseDropTarget(@NonNull ViewHolder viewHolder, @NonNull List list, int i, int i2) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (left < 0) {
                    ...
                    if (left2 > 0 && viewHolder3.itemView.getLeft() < viewHolder.itemView.getLeft()) {
                ...
                if (top < 0) {
                    ...
                    if (top2 > 0 && viewHolder3.itemView.getTop() < viewHolder.itemView.getTop()) {
                ...
                if (top > 0) {
                    ...
                    if (bottom < 0 && viewHolder3.itemView.getBottom() > viewHolder.itemView.getBottom()) {
        ...
        /* access modifiers changed from: 0000 */
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List list, int i, float f, float f2) {
        ...
        /* access modifiers changed from: 0000 */
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List list, int i, float f, float f2) {
            Canvas canvas2 = canvas;
            List list2 = list;
            int size = list.size();
            boolean z = false;
