...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public abstract class Adapter {
        ...
        public final void bindViewHolder(@NonNull ViewHolder viewHolder, int i) {
            ...
            android.view.ViewGroup.LayoutParams layoutParams = viewHolder.itemView.getLayoutParams();
        ...
        @NonNull
        public final ViewHolder createViewHolder(@NonNull ViewGroup viewGroup, int i) {
            try {
    ...
    public abstract class LayoutManager {
        ...
        public boolean onAddFocusables(@NonNull RecyclerView recyclerView, @NonNull ArrayList arrayList, int i, int i2) {
            return false;
        }
        ...
        public boolean performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state, int i, @Nullable Bundle bundle) {
            ...
            if (i == 4096) {
                i6 = recyclerView.canScrollVertically(1) ? (getHeight() - getPaddingTop()) - getPaddingBottom() : 0;
                    ...
                    if (viewHolder == null) {
                        ...
                        if (viewHolder == null) {
                            ...
                            if (viewCacheExtension != null) {
                                View viewForPositionAndType = viewCacheExtension.getViewForPositionAndType(this, i2, itemViewType);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                boolean z2 = smoothScroller2 != null && smoothScroller2.isPendingInitialRun();
                if (z2 || !z) {
                    postOnAnimation();
    ...
    private void addAnimatingView(ViewHolder viewHolder) {
        ...
        ChildHelper childHelper = this.mChildHelper;
        if (isTmpDetached) {
            childHelper.attachViewToParent(view, -1, view.getLayoutParams(), true);
        } else if (!z) {
    ...
    private void dispatchLayoutStep2() {
        ...
        boolean z = state2.mRunSimpleAnimations && this.mItemAnimator != null;
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        State state2 = this.mState;
        if (state2.mRunSimpleAnimations && z2 && !this.mDataSetHasChangedAfterLayout && predictiveItemAnimationsEnabled()) {
            z = true;
        }
    ...
    private void pullGlows(float f, float f2, float f3, float f4) {
        ...
        if (f2 < 0.0f) {
            ...
            height = 1.0f - (f3 / ((float) getHeight()));
        } else if (f2 > 0.0f) {
            ensureRightGlow();
            edgeEffect = this.mRightGlow;
            width = f2 / ((float) getWidth());
            height = f3 / ((float) getHeight());
        } else {
            z = false;
            if (f4 >= 0.0f) {
                ensureTopGlow();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00ab, code lost:
        if (r6.isFocusable() != false) goto L_0x00af;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public void draw(Canvas canvas) {
        ...
        if (edgeEffect3 != null && !edgeEffect3.isFinished()) {
            ...
            boolean z4 = edgeEffect4 != null && edgeEffect4.draw(canvas);
            z |= z4;
        ...
        if (edgeEffect5 != null && !edgeEffect5.isFinished()) {
            ...
            boolean z5 = edgeEffect6 != null && edgeEffect6.draw(canvas);
            z |= z5;
    ...
    public void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (this.mGapWorker == null) {
                ...
                gapWorker.mFrameIntervalNs = (long) (1.0E9f / f);
                GapWorker.sGapWorker.set(gapWorker);
            }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            iArr3[0] = 0;
            iArr3[1] = 0;
            if (dispatchNestedPreScroll(i4, i5, iArr3, this.mScrollOffset, 0)) {
    ...
    public void smoothScrollBy(@Px int i, @Px int i2) {
        smoothScrollBy(i, i2, null, Integer.MIN_VALUE, false);
    }

    public void smoothScrollBy(@Px int i, @Px int i2, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i2, interpolator, Integer.MIN_VALUE, false);
    }
