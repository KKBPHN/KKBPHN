...
class MessageThreadUtil implements ThreadUtil {
    ...
    public BackgroundCallback getBackgroundProxy(final BackgroundCallback backgroundCallback) {
    ...
    public MainThreadCallback getMainThreadProxy(final MainThreadCallback mainThreadCallback) {
