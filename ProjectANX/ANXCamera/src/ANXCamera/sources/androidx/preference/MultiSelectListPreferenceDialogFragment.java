...
public class MultiSelectListPreferenceDialogFragment extends PreferenceDialogFragment {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            charSequenceArr = bundle.getCharSequenceArray(SAVE_STATE_ENTRY_VALUES);
        }
    ...
    public void onPrepareDialogBuilder(Builder builder) {
        ...
        builder.setMultiChoiceItems(this.mEntries, zArr, new OnMultiChoiceClickListener() {
            public void onClick(DialogInterface dialogInterface, int i, boolean z) {
                ...
                multiSelectListPreferenceDialogFragment.mPreferenceChanged |= z ? multiSelectListPreferenceDialogFragment.mNewValues.add(multiSelectListPreferenceDialogFragment.mEntryValues[i].toString()) : multiSelectListPreferenceDialogFragment.mNewValues.remove(multiSelectListPreferenceDialogFragment.mEntryValues[i].toString());
            }
        });
    }
