...
final class ExpandButton extends Preference {
    ...
    private void initLayout() {
        ...
        setOrder(ErrorCode.UNKNOWN);
    }

    /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<androidx.preference.Preference>, for r8v0, types: [java.util.List, java.util.List<androidx.preference.Preference>] */
