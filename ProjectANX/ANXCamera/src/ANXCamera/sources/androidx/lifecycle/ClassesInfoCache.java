...
class ClassesInfoCache {
    ...
    class CallbackInfo {
        ...
        private static void invokeMethodsForEvent(List list, LifecycleOwner lifecycleOwner, Event event, Object obj) {
            if (list != null) {
    ...
    private void verifyAndPutHandler(Map map, MethodReference methodReference, Event event, Class cls) {
