...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        class MediaBrowserServiceApi21 extends MediaBrowserService {
            ...
            public void onLoadChildren(String str, android.service.media.MediaBrowserService.Result result) {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:16:0x0075 A[RETURN] */
        ...
        public BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            ...
            if (bundle != null) {
                ...
                if (bundle.getInt(str2, 0) != 0) {
                    ...
                    String str3 = MediaBrowserProtocol.EXTRA_CALLING_PID;
                    ...
                    onGetRoot = mediaBrowserServiceCompat.onGetRoot(str, i, bundle);
            ...
            i2 = -1;
            bundle2 = null;
            ConnectionRecord connectionRecord2 = new ConnectionRecord(str, i2, i, bundle, null);
            ...
            onGetRoot = mediaBrowserServiceCompat3.onGetRoot(str, i, bundle);
            MediaBrowserServiceCompat mediaBrowserServiceCompat22 = MediaBrowserServiceCompat.this;
            mediaBrowserServiceCompat22.mCurConnection = null;
            if (onGetRoot != null) {
            }
        }
        ...
        public void onLoadChildren(String str, final ResultWrapper resultWrapper) {
            AnonymousClass2 r0 = new Result(str) {
                ...
                /* access modifiers changed from: 0000 */
                /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<android.support.v4.media.MediaBrowserCompat$MediaItem>, for r5v0, types: [java.util.List, java.util.List<android.support.v4.media.MediaBrowserCompat$MediaItem>] */
                /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 {
        ...
        class MediaBrowserServiceApi23 extends MediaBrowserServiceApi21 {
            ...
            public void onLoadItem(String str, android.service.media.MediaBrowserService.Result result) {
    ...
    class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 {
        ...
        class MediaBrowserServiceApi26 extends MediaBrowserServiceApi23 {
            ...
            public void onLoadChildren(String str, android.service.media.MediaBrowserService.Result result, Bundle bundle) {
                MediaSessionCompat.ensureClassLoader(bundle);
        ...
        public void onLoadChildren(String str, final ResultWrapper resultWrapper, final Bundle bundle) {
            AnonymousClass1 r0 = new Result(str) {
                ...
                /* access modifiers changed from: 0000 */
                /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<android.support.v4.media.MediaBrowserCompat$MediaItem>, for r5v0, types: [java.util.List] */
                /* Code decompiled incorrectly, please refer to instructions dump. */
                public void onResultSent(List<MediaItem> list) {
                    if (list == null) {
                        resultWrapper.sendResult(null);
    ...
    class MediaBrowserServiceImplApi28 extends MediaBrowserServiceImplApi26 {
        ...
        public RemoteUserInfo getCurrentBrowserInfo() {
            ...
            ConnectionRecord connectionRecord = mediaBrowserServiceCompat.mCurConnection;
            if (connectionRecord != null) {
                return connectionRecord == mediaBrowserServiceCompat.mConnectionFromFwk ? new RemoteUserInfo(this.mServiceFwk.getCurrentBrowserInfo()) : connectionRecord.browserInfo;
            }
            throw new IllegalStateException("This should be called inside of onGetRoot, onLoadChildren, onLoadItem, onSearch, or onCustomAction methods");
        }
    }
    ...
    class ResultWrapper {
        ...
        /* access modifiers changed from: 0000 */
        /* JADX WARNING: Incorrect type for immutable var: ssa=java.util.List, code=java.util.List<android.os.Parcel>, for r3v0, types: [java.util.List, java.util.List<android.os.Parcel>] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public List parcelListToItemList(List<Parcel> list) {
            if (list == null) {
                return null;
            }
            ArrayList arrayList = new ArrayList();
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i2)) {
                ...
                AnonymousClass1 r1 = new Runnable() {
                    public void run() {
                        ...
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
                        connectionRecord.root = mediaBrowserServiceCompat.onGetRoot(str2, i4, bundle2);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat2 = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat2.mCurConnection = null;
                        ...
                        if (browserRoot == null) {
                            ...
                            sb.append(AnonymousClass1.class.getName());
        ...
        public void registerCallbacks(ServiceCallbacks serviceCallbacks, String str, int i, int i2, Bundle bundle) {
            ...
            AnonymousClass6 r1 = new Runnable() {
                public void run() {
                    ...
                    ConnectionRecord connectionRecord3 = connectionRecord == null ? new ConnectionRecord(str2, i4, i3, bundle2, serviceCallbacks2) : connectionRecord;
                    MediaBrowserServiceCompat.this.mConnections.put(asBinder, connectionRecord3);
                    try {
                        asBinder.linkToDeath(connectionRecord3, 0);
                    } catch (RemoteException unused) {
    ...
    final class ServiceHandler extends Handler {
        ...
        public boolean sendMessageAtTime(Message message, long j) {
            ...
            String str = MediaBrowserProtocol.DATA_CALLING_PID;
            if (callingPid <= 0) {
    ...
    public MediaBrowserServiceCompat() {
        ConnectionRecord connectionRecord = new ConnectionRecord(RemoteUserInfo.LEGACY_CONTROLLER, -1, -1, null, null);
        this.mConnectionFromFwk = connectionRecord;
    }
    ...
    public void onCreate() {
        ...
        MediaBrowserServiceImpl mediaBrowserServiceImplBase = i >= 28 ? new MediaBrowserServiceImplApi28() : i >= 26 ? new MediaBrowserServiceImplApi26() : i >= 23 ? new MediaBrowserServiceImplApi23() : i >= 21 ? new MediaBrowserServiceImplApi21() : new MediaBrowserServiceImplBase();
