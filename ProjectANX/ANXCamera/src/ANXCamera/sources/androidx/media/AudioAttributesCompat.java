...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public class Builder {
        ...
        public Builder() {
            androidx.media.AudioAttributesImpl.Builder builder;
            if (AudioAttributesCompat.sForceLegacyBehavior) {
                builder = new Builder();
            } else {
                int i = VERSION.SDK_INT;
                builder = i >= 26 ? new Builder() : i >= 21 ? new Builder() : new Builder();
            }
        ...
        public Builder(AudioAttributesCompat audioAttributesCompat) {
            androidx.media.AudioAttributesImpl.Builder builder;
            if (AudioAttributesCompat.sForceLegacyBehavior) {
                builder = new Builder(audioAttributesCompat);
            } else {
                int i = VERSION.SDK_INT;
                builder = i >= 26 ? new Builder(audioAttributesCompat.unwrap()) : i >= 21 ? new Builder(audioAttributesCompat.unwrap()) : new Builder(audioAttributesCompat);
            }
            this.mBuilderImpl = builder;
        }
