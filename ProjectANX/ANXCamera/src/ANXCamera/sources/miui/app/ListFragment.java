...
public class ListFragment extends android.app.ListFragment implements IFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (onCreateView instanceof ActionBarOverlayLayout) {
            boolean equals = ActionBarDelegateImpl.UI_OPTION_SPLIT_ACTION_BAR_WHEN_NARROW.equals(this.mDelegate.getUiOptionsFromMetadata());
            Activity activity = getActivity();
            if (equals) {
                z = activity.getResources().getBoolean(R.bool.abc_split_action_bar_is_narrow);
            } else {
