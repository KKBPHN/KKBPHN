...
public class SpinnerCheckableArrayAdapter extends ArrayAdapter {
    private static final int TAG_VIEW = R.id.tag_spinner_dropdown_view;
    ...
    public SpinnerCheckableArrayAdapter(@NonNull Context context, ArrayAdapter arrayAdapter, CheckedStateProvider checkedStateProvider) {
        this(context, R.layout.miuix_compat_simple_spinner_layout_integrated, arrayAdapter, checkedStateProvider);
    }
    ...
    public View getDropDownView(int i, @Nullable View view, @NonNull ViewGroup viewGroup) {
        ...
        if (view == null || view.getTag(TAG_VIEW) == null) {
            view = this.mInflater.inflate(R.layout.miuix_compat_spinner_dropdown_checkable_item, viewGroup, false);
