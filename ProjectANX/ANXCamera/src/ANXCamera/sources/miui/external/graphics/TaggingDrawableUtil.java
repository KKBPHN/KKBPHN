    ...
    public static void updateBackgroundState(View view, int i, int i2) {
        if (view != null && i2 != 0) {
            ...
            if (background instanceof TaggingDrawable) {
                ...
                int[] iArr = i2 == 1 ? STATE_SET_SINGLE : i == 0 ? STATE_SET_FIRST : i == i2 - 1 ? STATE_SET_LAST : STATE_SET_MIDDLE;
        ...
        if (view != null && i2 != 0) {
            ...
            if (i2 != 1) {
                if (i == 0) {
                    ...
                    i4 = miuix.compat.R.dimen.miuix_compat_drop_down_menu_padding_large;
                    dimensionPixelSize = resources2.getDimensionPixelSize(i4);
                    resources = applicationContext.getResources();
                    i3 = miuix.compat.R.dimen.miuix_compat_drop_down_menu_padding_small;
                    view.setPaddingRelative(paddingStart, dimensionPixelSize, paddingEnd, resources.getDimensionPixelSize(i3));
                } else if (i == i2 - 1) {
                    dimensionPixelSize = applicationContext.getResources().getDimensionPixelSize(miuix.compat.R.dimen.miuix_compat_drop_down_menu_padding_small);
                    resources = applicationContext.getResources();
                    i3 = miuix.compat.R.dimen.miuix_compat_drop_down_menu_padding_large;
                    view.setPaddingRelative(paddingStart, dimensionPixelSize, paddingEnd, resources.getDimensionPixelSize(i3));
                }
            }
            resources2 = applicationContext.getResources();
            i4 = miuix.compat.R.dimen.miuix_compat_drop_down_menu_padding_small;
            dimensionPixelSize = resources2.getDimensionPixelSize(i4);
            resources = applicationContext.getResources();
            i3 = miuix.compat.R.dimen.miuix_compat_drop_down_menu_padding_small;
            view.setPaddingRelative(paddingStart, dimensionPixelSize, paddingEnd, resources.getDimensionPixelSize(i3));
