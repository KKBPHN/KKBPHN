...
public class SdkErrorActivity extends Activity implements SdkConstants {
    ...
    private boolean supportUpdateSdk() {
        boolean z = false;
        try {
            z = ((Boolean) SdkEntranceHelper.getSdkEntrance().getMethod("supportUpdate", new Class[]{Map.class}).invoke(null, new Object[]{null})).booleanValue();
            return z;
        } catch (Exception e) {
            e.printStackTrace();
            return z;
    ...
    public boolean updateSdk() {
        ...
        try {
            ...
            z = ((Boolean) SdkEntranceHelper.getSdkEntrance().getMethod("update", new Class[]{Map.class}).invoke(null, new Object[]{hashMap})).booleanValue();
            return z;
        } catch (Exception e) {
            e.printStackTrace();
            return z;
