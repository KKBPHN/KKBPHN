...
.method private debug()V
    ...
    iget-object v4, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mDecoderName:Ljava/lang/String;

    invoke-virtual {v9, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v4, " failed to decode the NALs"
    ...
    const-string v4, " can\'t be used with "

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v4, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mDecoderColorFormat:I
    ...
    const-string v9, "Some padding is needed: "
    ...
    iget-object v9, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mEncoderName:Ljava/lang/String;
    ...
    iget v9, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mWidth:I

    invoke-virtual {v0, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v9, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mHeight:I
    ...
    const-string v9, "Failed to decode NALs from the encoder."
    ...
    iget-object v14, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mEncoderName:Ljava/lang/String;

    invoke-virtual {v12, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v14, " cannot be used with color format "

    invoke-virtual {v12, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v14, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mEncoderColorFormat:I
    ...
    iget-object v15, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mErrorLog:Ljava/lang/String;
    ...
    iput-object v9, v1, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mErrorLog:Ljava/lang/String;
    ...
    invoke-direct {v1, v9}, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->saveTestResult(Z)V
...
.method private decode(Z)J
    ...
    invoke-direct {v0, v10}, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->convertToNV21(I)V
...
.method private encode()J
    ...
    iget-object v7, v0, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mEncoder:Landroid/media/MediaCodec;
    ...
    invoke-virtual {v11, v5, v6, v12}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget-object v5, v0, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mEncoder:Landroid/media/MediaCodec;

    invoke-virtual {v5, v10, v6}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V
...
.method private searchSPSandPPS()J
    ...
    iget-object v9, v0, Lnet/majorkernelpanic/streaming/hw/EncoderDebugger;->mPPS:[B
