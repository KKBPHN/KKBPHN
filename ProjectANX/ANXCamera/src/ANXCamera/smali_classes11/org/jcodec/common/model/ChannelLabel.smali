...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v3, v2}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v4, "STEREO_RIGHT"

    invoke-direct {v0, v4, v3}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "LEFT_TOTAL"

    invoke-direct {v0, v5, v4}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v6, "RIGHT_TOTAL"

    invoke-direct {v0, v6, v5}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v7, v6}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v8, "FRONT_RIGHT"

    invoke-direct {v0, v8, v7}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v9, v8}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v10, "LFE"

    invoke-direct {v0, v10, v9}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v11, "REAR_LEFT"

    invoke-direct {v0, v11, v10}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v12, v11}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v13, "FRONT_CENTER_LEFT"

    invoke-direct {v0, v13, v12}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v14, "FRONT_CENTER_RIGHT"

    invoke-direct {v0, v14, v13}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    const-string v15, "REAR_CENTER"

    invoke-direct {v0, v15, v14}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v14, v15}, Lorg/jcodec/common/model/ChannelLabel;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lorg/jcodec/common/model/ChannelLabel;->SIDE_LEFT:Lorg/jcodec/common/model/ChannelLabel;

    new-instance v0, Lorg/jcodec/common/model/ChannelLabel;

    const-string v14, "SIDE_RIGHT"
    ...
    sget-object v14, Lorg/jcodec/common/model/ChannelLabel;->MONO:Lorg/jcodec/common/model/ChannelLabel;
