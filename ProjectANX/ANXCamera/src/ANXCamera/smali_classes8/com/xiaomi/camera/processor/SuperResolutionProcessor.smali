...
.method public doProcess(Lcom/xiaomi/camera/core/CaptureData;Lcom/xiaomi/camera/processor/ProcessResultListener;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-direct {v7, v0, v8, v9}, Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;-><init>(IZZ)V
    ...
    invoke-virtual {v4, v11, v2, v10}, Lcom/xiaomi/engine/TaskSession;->processFrameWithSync(Ljava/util/List;Landroid/media/Image;I)I
    ...
    invoke-static {v9, v11}, Lcom/xiaomi/camera/base/PerformanceTracker;->trackAlgorithmProcess(Ljava/lang/String;I)V

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "doProcess: SR done. baseIndex = "
    ...
    invoke-virtual {v4, v8, v0, v1}, Lcom/xiaomi/engine/TaskSession;->processFrameWithSync(Ljava/util/List;Landroid/media/Image;I)I
    ...
    :goto_b
    invoke-static {v9, v1}, Lcom/xiaomi/camera/base/PerformanceTracker;->trackAlgorithmProcess(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v12, v13}, Landroid/media/Image;->setTimestamp(J)V
    ...
    invoke-virtual {v7, v0, v1, v1}, Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;->setImage(Landroid/media/Image;IZ)V
    ...
    :goto_c
    invoke-virtual {v7, v10, v1}, Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;->setCaptureResult(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {v7, v0, v1, v3}, Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;->setImage(Landroid/media/Image;IZ)V

    :cond_d
    invoke-virtual {v2, v12, v13}, Landroid/media/Image;->setTimestamp(J)V
    ...
    invoke-virtual {v7, v0, v2, v1}, Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;->setImage(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v2, v8, v9}, Lcom/xiaomi/camera/imagecodec/ImagePool;->getImage(J)Landroid/media/Image;

    move-result-object v2

    const/4 v4, 0x1

    invoke-virtual {v7, v2, v4, v4}, Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;->setImage(Landroid/media/Image;IZ)V
    ...
    :cond_14
    :goto_f
    invoke-virtual {v7}, Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;->isDataReady()Z
    ...
    invoke-direct {v1, v2, v3, v4}, Lcom/xiaomi/camera/processor/SuperResolutionProcessor;->onImageAvailable(Lcom/xiaomi/camera/core/CaptureData;Ljava/util/List;Lcom/xiaomi/camera/processor/ProcessResultListener;)V
    ...
    invoke-direct {v1, v2, v7, v4}, Lcom/xiaomi/camera/processor/SuperResolutionProcessor;->onImageAvailable(Lcom/xiaomi/camera/core/CaptureData;Lcom/xiaomi/camera/core/CaptureData$CaptureDataBean;Lcom/xiaomi/camera/processor/ProcessResultListener;)V
