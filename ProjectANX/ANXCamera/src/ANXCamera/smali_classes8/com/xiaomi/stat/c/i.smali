...
.method private a([Lcom/xiaomi/stat/a/b;Ljava/lang/String;)V
    ...
    iget-object v4, v0, Lcom/xiaomi/stat/a/k;->b:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v4}, Lcom/xiaomi/stat/a/c;->a(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, p1}, Lcom/xiaomi/stat/a/c;->a([Lcom/xiaomi/stat/a/b;)Lcom/xiaomi/stat/a/k;

    move-result-object v4

    if-eqz v4, :cond_6

    iget-boolean v6, v4, Lcom/xiaomi/stat/a/k;->c:Z
    ...
    invoke-virtual {p0, v0}, Lcom/xiaomi/stat/c/g;->b(Z)V
...
.method private i()Z
    ...
    :try_start_1
    iget-object v4, p0, Lcom/xiaomi/stat/c/i;->p:Ljava/nio/channels/FileChannel;

    invoke-virtual {v4}, Ljava/nio/channels/FileChannel;->tryLock()Ljava/nio/channels/FileLock;

    move-result-object v4

    iput-object v4, p0, Lcom/xiaomi/stat/c/i;->o:Ljava/nio/channels/FileLock;

    iget-object v4, p0, Lcom/xiaomi/stat/c/i;->o:Ljava/nio/channels/FileLock;

    if-eqz v4, :cond_2

    const-string v4, " acquire lock for uploader"

    invoke-static {v1, v4}, Lcom/xiaomi/stat/d/k;->c(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_2
    :try_start_3
    const-string v4, " acquire lock for uploader failed"
