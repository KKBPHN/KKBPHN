...
.method public constructor <init>(Ljava/io/File;Landroid/view/Surface;Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;JZ)V
    ...
    iget-object p3, p0, Lcom/xiaomi/mediacodec/MoviePlayer;->mFrameCallback:Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;

    iget-object p4, p0, Lcom/xiaomi/mediacodec/MoviePlayer;->mAudioFromate:Landroid/media/MediaFormat;

    invoke-interface {p3, p4}, Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;->onAudioFormat(Landroid/media/MediaFormat;)V
    ...
    iget p3, p0, Lcom/xiaomi/mediacodec/MoviePlayer;->mVideoWidth:I

    sput p3, Lcom/xiaomi/mediacodec/GlUtil;->mWidht:I

    iget p3, p0, Lcom/xiaomi/mediacodec/MoviePlayer;->mVideoHeight:I
...
.method private doExtract(Landroid/media/MediaExtractor;ILandroid/media/MediaCodec;Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;)V
    ...
    iget-object v7, v6, Lcom/xiaomi/mediacodec/MoviePlayer$MediaFrame;->buffer:Ljava/nio/ByteBuffer;
    ...
    iget-object v0, v6, Lcom/xiaomi/mediacodec/MoviePlayer$MediaFrame;->info:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v4, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mBufferInfo:Landroid/media/MediaCodec$BufferInfo;

    invoke-virtual {v11, v4, v13, v14}, Landroid/media/MediaCodec;->dequeueOutputBuffer(Landroid/media/MediaCodec$BufferInfo;J)I
    ...
    const-string v5, "== AMEDIACODEC_INFO_OUTPUT_FORMAT_CHANGED "
    ...
    :cond_13
    iget-object v5, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mBufferInfo:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-boolean v5, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mLoop:Z

    if-nez v5, :cond_14

    iget-object v5, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mFrameCallback:Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;

    invoke-interface {v5}, Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;->onDecoderFinished()V

    const-string v5, "output EOS onDecoderFinished!"
    ...
    iget-wide v4, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mOutputFrames:J

    const-wide/16 v13, 0x1

    add-long/2addr v4, v13

    iput-wide v4, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mOutputFrames:J

    iget-object v0, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mFrameCallback:Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;

    iget-wide v4, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mDurationUs:J
    ...
    invoke-interface {v0, v4}, Lcom/xiaomi/mediacodec/MoviePlayer$FrameCallback;->onVideoFrame(I)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "onVideoFrame mDurationUs: "
    ...
    const-string v4, " mWrittenPresentationTimeUs: "

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v4, v1, Lcom/xiaomi/mediacodec/MoviePlayer;->mWrittenPresentationTimeUs:J
...
.method private getMetadata()V
    ...
    sget-object v1, Lcom/xiaomi/mediacodec/GlUtil;->location:[F
