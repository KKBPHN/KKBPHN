...
.method public static getFontSync(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    invoke-static/range {v0 .. v7}, Landroidx/core/provider/FontsContractCompat;->getFontSync(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZIIZ)Landroid/graphics/Typeface;
...
.method public static getFontSync(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZIIZ)Landroid/graphics/Typeface;
    .locals 3
    .param p2    # Landroidx/core/content/res/ResourcesCompat$FontCallback;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    sget-object p7, Landroidx/core/provider/FontsContractCompat;->sExecutor:Ljava/util/concurrent/Executor;
    ...
    :try_start_0
    sget-object v2, Landroidx/core/provider/FontsContractCompat;->sExecutor:Ljava/util/concurrent/Executor;
    ...
    sput-object v2, Landroidx/core/provider/FontsContractCompat;->sExecutor:Ljava/util/concurrent/Executor;
    ...
    :goto_2
    new-instance v2, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;

    invoke-direct {v2, p0, p1, p6, v0}, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;-><init>(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, v2, p5}, Landroidx/core/provider/SelfDestructiveThread;->postAndWait(Ljava/util/concurrent/Callable;I)Ljava/lang/Object;
    ...
    :cond_8
    new-instance p0, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;

    invoke-direct {p0, v2}, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;-><init>(Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;)V

    invoke-interface {p7, p0}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V
    ...
    new-instance p0, Landroidx/core/provider/FontsContractCompat$1;

    invoke-direct {p0, p2, p3}, Landroidx/core/provider/FontsContractCompat$1;-><init>(Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;)V
    ...
    invoke-direct {p0, p2}, Landroidx/core/provider/FontsContractCompat$2;-><init>(Landroidx/core/content/res/ResourcesCompat$FontCallback;)V
    ...
    :goto_3
    sget-object p1, Landroidx/core/provider/FontsContractCompat;->sLock:Ljava/lang/Object;

    monitor-enter p1

    :try_start_2
    sget-object p2, Landroidx/core/provider/FontsContractCompat;->sPendingReplies:Landroidx/collection/SimpleArrayMap;
    ...
    sget-object p0, Landroidx/core/provider/FontsContractCompat;->sPendingReplies:Landroidx/collection/SimpleArrayMap;

    invoke-virtual {p0, v0, p2}, Landroidx/collection/SimpleArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v0}, Landroidx/core/provider/FontsContractCompat$3;-><init>(Ljava/lang/String;)V

    invoke-virtual {p0, v2, p1}, Landroidx/core/provider/SelfDestructiveThread;->postAndReply(Ljava/util/concurrent/Callable;Landroidx/core/provider/SelfDestructiveThread$ReplyCallback;)V
    ...
    new-instance p1, Landroidx/core/provider/FontsContractCompat$OnFetchCompletedAndFirePendingReplyCallback;

    invoke-direct {p1, v0}, Landroidx/core/provider/FontsContractCompat$OnFetchCompletedAndFirePendingReplyCallback;-><init>(Ljava/lang/String;)V

    invoke-direct {p0, v2, p1}, Landroidx/core/provider/FontsContractCompat$SyncFontFetchTask;-><init>(Landroidx/core/provider/FontsContractCompat$SyncFontFetchTaskCallable;Landroidx/core/provider/FontsContractCompat$OnCompletedCallback;)V
